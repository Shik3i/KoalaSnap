(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(r){if(r.ep)return;r.ep=!0;const o=t(r);fetch(r.href,o)}})();const Ce="modulepreload",Se=function(e){return"/"+e},ie={},pe=function(n,t,i){let r=Promise.resolve();if(t&&t.length>0){let s=function(c){return Promise.all(c.map(p=>Promise.resolve(p).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const d=document.querySelector("meta[property=csp-nonce]"),h=(d==null?void 0:d.nonce)||(d==null?void 0:d.getAttribute("nonce"));r=s(t.map(c=>{if(c=Se(c),c in ie)return;ie[c]=!0;const p=c.endsWith(".css"),m=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${m}`))return;const u=document.createElement("link");if(u.rel=p?"stylesheet":Ce,p||(u.as="script"),u.crossOrigin="",u.href=c,h&&u.setAttribute("nonce",h),document.head.appendChild(u),p)return new Promise((b,G)=>{u.addEventListener("load",b),u.addEventListener("error",()=>G(new Error(`Unable to preload CSS for ${c}`)))})}))}function o(s){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=s,window.dispatchEvent(d),!d.defaultPrevented)throw s}return r.then(s=>{for(const d of s||[])d.status==="rejected"&&o(d.reason);return n().catch(o)})},q="koalasnap_state",$="koalasnap_templates",re="koalasnap_sidebar",j=2,Me={bgGradient:"from-sky-400 to-indigo-600"},se={1:e=>(e.bgGradient===Me.bgGradient&&(e.bgGradient="from-slate-900 to-indigo-950"),e)};function Le(e){try{const n=localStorage.getItem(q);if(n){const t=JSON.parse(n),i=t._version||1;if(i<j){for(let s=i;s<j;s++)se[s]&&se[s](t);t._version=j;const{avatar:r,...o}=t;localStorage.setItem(q,JSON.stringify(o))}return{...e,...t}}}catch{}return{...e}}function B(e){try{const{avatar:n,...t}=e;localStorage.setItem(q,JSON.stringify(t))}catch{}}function Te(){try{const n=new URLSearchParams(window.location.search).get("state");if(!n)return null;const t=atob(n),i=Uint8Array.from(t,s=>s.charCodeAt(0)),r=new TextDecoder().decode(i),o=JSON.parse(r);if(o&&typeof o=="object")return o}catch{}return null}function Ie(e){const n=Te(),t=n?{...e,...n}:Le(e),i=new Set,r=[],o=[],s=50;let d=!1;function h(){d||(r.push(JSON.parse(JSON.stringify(t))),r.length>s&&r.shift(),o.length=0)}return{get(c){return t[c]},getState(){return{...t}},set(c,p){h(),t[c]=p,B(t),i.forEach(m=>m(c,p,t))},setAll(c){h(),Object.assign(t,c),B(t),i.forEach(p=>p(null,null,t))},mutate(c){h(),Object.assign(t,c),B(t),i.forEach(p=>p(null,null,t))},subscribe(c){return i.add(c),()=>i.delete(c)},reset(){h(),Object.assign(t,e),B(t),i.forEach(c=>c(null,null,t))},undo(){if(r.length===0)return;o.push(JSON.parse(JSON.stringify(t)));const c=r.pop();Object.assign(t,c),B(t),i.forEach(p=>p("_undo",null,t))},redo(){if(o.length===0)return;r.push(JSON.parse(JSON.stringify(t)));const c=o.pop();Object.assign(t,c),B(t),i.forEach(p=>p("_redo",null,t))},canUndo(){return r.length>0},canRedo(){return o.length>0},pauseHistory(){d=!0},resumeHistory(){d=!1},saveTemplate(c){try{const p=JSON.parse(localStorage.getItem($)||"{}"),{avatar:m,...u}=t;return p[c]=u,localStorage.setItem($,JSON.stringify(p)),!0}catch{return!1}},deleteTemplate(c){try{const p=JSON.parse(localStorage.getItem($)||"{}");return delete p[c],localStorage.setItem($,JSON.stringify(p)),!0}catch{return!1}},loadTemplate(c){try{const m=JSON.parse(localStorage.getItem($)||"{}")[c];return m?(this.mutate(m),!0):!1}catch{return!1}},listTemplates(){try{return Object.keys(JSON.parse(localStorage.getItem($)||"{}"))}catch{return[]}},getSidebarOpen(){return localStorage.getItem(re)!=="false"},setSidebarOpen(c){localStorage.setItem(re,String(c))},getShareUrl(){try{const{avatar:c,...p}=t,m=JSON.stringify(p),u=new TextEncoder().encode(m),b=String.fromCharCode(...u),G=btoa(b),ne=new URL(window.location.href.split("?")[0].split("#")[0]);return ne.searchParams.set("state",G),ne.toString()}catch{return null}}}}const Ae={_version:j,theme:"whatsapp",author:"Maya",handle:"@maya_99",username:"Maya",roleColor:"#e81224",timestamp:"7:18 PM",message:"Hey, are you coming online tonight?",avatar:null,bgGradient:"from-slate-900 to-indigo-950",padding:48,mockupTheme:"light",waMode:"sent",locale:"en",fontFamily:"system-ui",chatBg:null,messages:[{id:1,text:"Hey, are you coming online tonight?",type:"sent",time:"7:18 PM",status:"read"},{id:2,text:"Yeah, give me 5!",type:"received",time:"7:20 PM",status:"read"},{id:3,text:"Sure, take your time 🐨",type:"sent",time:"7:21 PM",status:"delivered"}]},l=Ie(Ae),je=window.__LOCALE__||{};function a(e){return e.split(".").reduce((t,i)=>t!=null?t[i]:void 0,je)??e}function Y(){const e=window.location.pathname.match(/^\/([a-z]{2})\//);return e?e[1]:"en"}function g(e){return typeof e!="string"?"":e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}const A=500,_e=.8;function Oe(e){return new Promise((n,t)=>{const i=new FileReader;i.onerror=()=>t(new Error("File read failed")),i.onload=r=>{const o=new Image;o.onerror=()=>t(new Error("Image decode failed")),o.onload=()=>{let{width:s,height:d}=o;if(s>A||d>A){const p=Math.min(A/s,A/d);s=Math.round(s*p),d=Math.round(d*p)}const h=document.createElement("canvas");h.width=s,h.height=d;const c=h.getContext("2d");if(!c){t(new Error("Canvas 2D not supported"));return}c.imageSmoothingEnabled=!0,c.imageSmoothingQuality="high",c.drawImage(o,0,0,s,d),h.toBlob(p=>{if(!p){t(new Error("WebP encoding failed"));return}n(URL.createObjectURL(p))},"image/webp",_e)},o.src=r.target.result},i.readAsDataURL(e)})}function Pe(e){const n=document.getElementById(e);n instanceof HTMLImageElement&&(n.src="")}const ue="koalasnap_tutorial_completed",E=[{target:"app-library",key:"tutorial.step1"},{target:"settings-panel",key:"tutorial.step2"},{target:"canvas-area",key:"tutorial.step3"},{target:"bottom-bar",key:"tutorial.step4"},{target:"btn-topbar-export",key:"tutorial.step5"}];let w=0,T=!1,y=null;function He(){return localStorage.getItem(ue)==="true"}function Ge(){return T}function ge(){T&&I(),w=0,T=!0;const e=Fe();e.classList.remove("hidden"),e.style.pointerEvents="auto",O(0),document.addEventListener("keydown",fe)}function fe(e){e.key==="Escape"&&I()}function I(){T=!1,y&&(clearTimeout(y),y=null),P(w);const e=document.getElementById("tutorial-overlay");e&&(e.classList.add("hidden"),e.style.pointerEvents=""),localStorage.setItem(ue,"true"),document.removeEventListener("keydown",fe)}function Ne(){if(P(w),w++,w>=E.length){I();return}O(w)}function Ve(){P(w),w=Math.max(0,w-1),O(w)}function Re(){T&&(P(w),O(w))}function Fe(){let e=document.getElementById("tutorial-overlay");return e||(e=document.createElement("div"),e.id="tutorial-overlay",e.className="fixed inset-0 bg-black/60 z-40 hidden",document.body.appendChild(e)),e}function O(e){y&&(clearTimeout(y),y=null);const n=E[e];if(!n)return;const t=document.getElementById(n.target);if(!t)return;t.classList.add("tutorial-highlight"),t.style.zIndex="50",getComputedStyle(t).position==="static"&&(t.style.position="relative"),t.scrollIntoView({behavior:"smooth",block:"center"});const i=t.getBoundingClientRect();y=setTimeout(()=>{De(e,i),y=null},400)}function P(e){y&&(clearTimeout(y),y=null);const n=E[e];if(!n)return;const t=document.getElementById(n.target);t&&(t.classList.remove("tutorial-highlight"),t.style.zIndex="",t.style.position="");const i=document.getElementById("tutorial-tooltip");i&&i.remove()}function De(e,n){const t=document.getElementById("tutorial-tooltip");t&&t.remove();const i=E.length,r=e===0,o=e===i-1,s=document.createElement("div");s.id="tutorial-tooltip",s.className="fixed z-50 w-[320px] rounded-2xl border border-white/[10%] bg-[#1a1714]/95 backdrop-blur-2xl p-4 shadow-2xl shadow-black/50 opacity-0 transition-opacity duration-200",s.innerHTML=`
    <p class="text-sm text-zinc-200 leading-relaxed mb-4">${a(We(e))}</p>
  ...
  `,document.body.appendChild(s),Ue(s,n),requestAnimationFrame(()=>{s.classList.remove("opacity-0")}),Ke(e)}function We(e){var n;return((n=E[e])==null?void 0:n.key)||""}function Ue(e,n){const r=e.offsetWidth||320,o=e.offsetHeight||160,s=window.innerWidth-r-16,d=window.innerHeight-o-16,h=n.left+n.width/2;let c=Math.max(16,Math.min(h-r/2,s)),p=n.bottom+12;p+o>window.innerHeight-16&&(p=n.top-o-12),p<16&&(p=16,c=Math.min(n.right+12,s),c=Math.max(16,c)),c=Math.max(16,Math.min(c,s)),p=Math.max(16,Math.min(p,d)),e.style.left=`${c}px`,e.style.top=`${p}px`}function Ke(e){const n=document.getElementById("tut-next");n&&(n.onclick=()=>e===E.length-1?I():Ne());const t=document.getElementById("tut-prev");t&&(t.onclick=()=>Ve());const i=document.getElementById("tut-skip");i&&(i.onclick=()=>I())}const he="?",X='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>',qe='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="17 1 21 5 17 9"/><path d="M3 11V9a4 4 0 0 1 4-4h14"/><polyline points="7 23 3 19 7 15"/><path d="M21 13v2a4 4 0 0 1-4 4H3"/></svg>',Z='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>',Q='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg>',Je='<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="5" r="2"/><circle cx="12" cy="12" r="2"/><circle cx="12" cy="19" r="2"/></svg>';function ee(e,n){return e?`<img id="mockup-avatar" src="${e}" class="w-full h-full rounded-full object-cover" />`:`<div id="mockup-avatar" class="w-full h-full rounded-full bg-gradient-to-br ${n?"from-zinc-600 to-zinc-800":"from-sky-400 to-indigo-500"} flex items-center justify-center text-white text-sm font-bold">${he}</div>`}function Ye(e,n){const t=n?"bg-zinc-900":"bg-white",i=n?"text-zinc-100":"text-zinc-900",r=n?"text-zinc-400":"text-zinc-500",o=n?"text-zinc-300":"text-zinc-800",s=n?"border-zinc-700":"border-zinc-200";return`
    <div id="mockup-card" class="${t} rounded-2xl shadow-2xl shadow-black/20 mx-auto overflow-hidden ring-1 ring-white/[6%] p-3" style="background:var(--chat-bg);width:400px; height:520px;font-family:${e.fontFamily};">
      ...
      <div class="flex items-center justify-between mt-2 pt-2 ${s} border-t text-sm ${r}">
        <div class="flex items-center gap-5">
          ...
          <span class="flex items-center gap-1">${qe} <span id="mockup-retweets">3</span></span>
          <span class="flex items-center gap-1">${X} <span id="mockup-likes">12</span></span>
        </div>
        <span>${Q}</span>
      </div>
    </div>
  `}function Xe(e,n){const t=n?"bg-black":"bg-white",i=n?"text-white":"text-zinc-900",r=n?"text-zinc-400":"text-zinc-500";return`
    <div id="mockup-card" class="${t} rounded-2xl shadow-2xl shadow-black/20 mx-auto overflow-hidden ring-1 ring-white/[6%]" style="background:var(--chat-bg);width:400px; height:600px;font-family:${e.fontFamily};">
  ...
  `}function Ze(e,n){const t=n?"#1a1a2e":"#f0f2f5",i=n?"#1c1c2e":"#007aff";return`
    <div id="mockup-card" class="mx-auto" style="background:var(--chat-bg);width:390px; height:844px;font-family:${e.fontFamily};">
      <div class="w-full h-full overflow-hidden rounded-[2.5rem] border-8 flex flex-col" style="border-color:${n?"#121212":"#ffffff"};background:${n?"#121212":"#ffffff"}">
        ...
        <div class="flex items-center gap-2 px-3 py-1.5 shrink-0 text-white" style="background:${i}">
          ...
          <span class="text-[15px] font-medium">${g(e.username)}</span>
        </div>
            ...
            <div class="flex items-start gap-3">
              ...
              <div class="flex flex-col items-center gap-3 shrink-0">
                ...
                <div class="flex flex-col items-center gap-4 text-white text-xs">
                  <div class="flex flex-col items-center gap-0.5">${X}<span id="mockup-likes" class="text-[10px]">12.4k</span></div>
                  <div class="flex flex-col items-center gap-0.5">${Z}<span id="mockup-replies" class="text-[10px]">241</span></div>
                  <div class="flex flex-col items-center gap-0.5">${Q}<span class="text-[10px]">Share</span></div>
                </div>
              </div>
            </div>
          </div>
  ...
  `}function C(e){const n=e.mockupTheme==="dark";switch(e.theme||"twitter"){case"instagram":return Xe(e,n);case"messenger":return Ze(e,n);case"tiktok":return Qe(e,n);case"twitter":default:return Ye(e,n)}}function S(e){const n=e.theme||"twitter";k("mockup-author",t=>{t&&(t.textContent=e.author)}),k("mockup-message",t=>{t&&(t.textContent=e.message)}),k("mockup-likes",t=>{t&&(t.textContent="142")}),k("mockup-replies",t=>{t&&(t.textContent="1")}),k("mockup-retweets",t=>{t&&(t.textContent="3")}),n==="messenger"?k("mockup-avatar",t=>{t&&oe(t,e,!1)}):k("mockup-avatar",t=>{t&&oe(t,e,e.mockupTheme==="dark")})}function oe(e,n,t){if(n.avatar){const i=document.createElement("img");i.id="mockup-avatar",i.src=n.avatar,i.className="w-full h-full rounded-full object-cover",i.alt="",e.replaceWith(i)}else{const i=document.createElement("div");i.id="mockup-avatar";const r=t?"from-zinc-600 to-zinc-800":"from-sky-400 to-indigo-500";i.className=`w-full h-full rounded-full bg-gradient-to-br ${r} flex items-center justify-center text-white text-sm font-bold`,i.textContent=he,e.replaceWith(i)}}function k(e,n){const t=document.getElementById(e);t&&n(t)}const et='<svg width="20" height="20" viewBox="0 0 24 24" fill="#949ba4"><path d="M5 9h14M5 15h14M11 3L9 21M15 3l-2 18"/></svg>',tt='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#949ba4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2z"/></svg>',nt='<svg width="16" height="16" viewBox="0 0 24 24" fill="#949ba4"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>',it='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#b5bac1" stroke-width="2" stroke-linecap="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>',rt='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#b5bac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 12 20 22 4 22 4 12"/><rect x="2" y="7" width="20" height="5"/><line x1="12" y1="22" x2="12" y2="7"/><path d="M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7z"/><path d="M12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7z"/></svg>',st=`url("data:image/svg+xml,%3Csvg width='200' height='200' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='30' cy='30' r='2' fill='white' opacity='0.02'/%3E%3Ccircle cx='100' cy='60' r='1.5' fill='white' opacity='0.015'/%3E%3Ccircle cx='170' cy='30' r='1' fill='white' opacity='0.02'/%3E%3Ccircle cx='50' cy='120' r='1.5' fill='white' opacity='0.015'/%3E%3Ccircle cx='150' cy='150' r='2' fill='white' opacity='0.02'/%3E%3C/svg%3E")`,ot={sidebarBg:"#2b2d31",chatBg:"#313338",inputBg:"#383a40",inputText:"#dbdee1",placeholder:"#949ba4",divider:"#3f4147",dotPattern:"none"},at={sidebarBg:"#1e1f22",chatBg:"#313338",inputBg:"#383a40",inputText:"#dbdee1",placeholder:"#949ba4",divider:"#3f4147",dotPattern:st};function lt(e){return e.mockupTheme==="light"?ot:at}function ct(e){const n=lt(e),t=e.avatar?`<img id="discord-avatar" src="${e.avatar}" class="w-10 h-10 rounded-full object-cover" />`:'<div id="discord-avatar" class="w-10 h-10 rounded-full bg-[#5865F2] flex items-center justify-center text-white text-xs font-bold">?</div>';return`
  ...
  `}function dt(e){N("discord-username",t=>{t.textContent=e.username,t.style.color=e.roleColor}),N("discord-timestamp",t=>{t.textContent=e.timestamp}),N("discord-message",t=>{t.textContent=e.message});const n=document.getElementById("discord-avatar");if(n)if(e.avatar){const t=document.createElement("img");t.id="discord-avatar",t.src=e.avatar,t.className="w-10 h-10 rounded-full object-cover",t.alt="",n.replaceWith(t)}else{const t=document.createElement("div");t.id="discord-avatar",t.className="w-10 h-10 rounded-full bg-[#5865F2] flex items-center justify-center text-white text-xs font-bold",t.textContent="?",n.replaceWith(t)}}function N(e,n){const t=document.getElementById(e);t&&n(t)}const pt='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#e9edef" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>',ut='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/></svg>',gt='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',ft='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><rect x="1" y="8" width="2" height="3" rx="0.4" fill="currentColor"/><rect x="5" y="5" width="2" height="6" rx="0.4" fill="currentColor"/><rect x="9" y="2.5" width="2" height="8.5" rx="0.4" fill="currentColor"/><rect x="13" y="0.5" width="2" height="10.5" rx="0.4" fill="currentColor"/></svg>',ht='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><path d="M9 11.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm-3.3-3.3a4.5 4.5 0 0 1 6.6 0l-1.1 1.1a3 3 0 0 0-4.4 0L5.7 8.2zM2.9 5.1a8 8 0 0 1 12.2 0l-1.1 1.1a6.5 6.5 0 0 0-10 0L2.9 5.1z" fill="currentColor"/></svg>',xt='<svg width="24" height="12" viewBox="0 0 26 12" fill="none"><rect x="0.5" y="0.5" width="22" height="11" rx="2" stroke="currentColor" fill="none"/><rect x="2" y="2" width="19.5" height="8" rx="1.5" fill="currentColor"/><rect x="24" y="3.5" width="2" height="5" rx="0.75" fill="currentColor"/></svg>',mt='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8696a0" stroke-width="2.5" stroke-linecap="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>',vt='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/></svg>',bt='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/><line x1="8" y1="23" x2="16" y2="23"/></svg>',wt=`url("data:image/svg+xml,%3Csvg width='200' height='200' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='30' cy='30' r='2' fill='white' opacity='0.04'/%3E%3Ccircle cx='100' cy='60' r='1.5' fill='white' opacity='0.03'/%3E%3Ccircle cx='170' cy='30' r='1' fill='white' opacity='0.04'/%3E%3Ccircle cx='50' cy='120' r='1.5' fill='white' opacity='0.03'/%3E%3Ccircle cx='150' cy='150' r='2' fill='white' opacity='0.04'/%3E%3Ccircle cx='80' cy='180' r='1' fill='white' opacity='0.03'/%3E%3Ccircle cx='20' cy='170' r='1.5' fill='white' opacity='0.03'/%3E%3C/svg%3E")`,yt=`url("data:image/svg+xml,%3Csvg width='200' height='200' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='30' cy='30' r='2' fill='black' opacity='0.04'/%3E%3Ccircle cx='100' cy='60' r='1.5' fill='black' opacity='0.03'/%3E%3Ccircle cx='170' cy='30' r='1' fill='black' opacity='0.04'/%3E%3Ccircle cx='50' cy='120' r='1.5' fill='black' opacity='0.03'/%3E%3Ccircle cx='150' cy='150' r='2' fill='black' opacity='0.04'/%3E%3Ccircle cx='80' cy='180' r='1' fill='black' opacity='0.03'/%3E%3Ccircle cx='20' cy='170' r='1.5' fill='black' opacity='0.03'/%3E%3C/svg%3E")`,kt='<svg width="14" height="14" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#53bdeb" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 5.5L9.5 9L16 1" stroke="#53bdeb" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" opacity="0.7"/></svg>',$t='<svg width="14" height="14" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 5.5L9.5 9L16 1" stroke="#8696a0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" opacity="0.7"/></svg>',Bt='<svg width="14" height="14" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',zt='<svg width="8" height="8" viewBox="0 0 8 8" fill="#53bdeb"><circle cx="4" cy="4" r="4"/></svg>',Et={barBg:"#008069",chatBg:"#efeae2",sentBg:"#d9fdd3",recvBg:"#ffffff",sentText:"#111b21",recvText:"#111b21",timeText:"#667781",inputBg:"#f0f2f5",fieldBg:"#ffffff",fieldText:"#111b21",placeholder:"#8696a0",dotPattern:yt},Ct={barBg:"#202c33",chatBg:"#0b141a",sentBg:"#005c4b",recvBg:"#202c33",sentText:"#e9edef",recvText:"#e9edef",timeText:"#ffffffcc",inputBg:"#202c33",fieldBg:"#2a3942",fieldText:"#e9edef",placeholder:"#8696a0",dotPattern:wt};function xe(e){return e.mockupTheme==="light"?Et:Ct}function St(e){const n=xe(e),t=e.mockupTheme==="light"?"#ffffff":"#121212";return`
    <div id="mockup-card" class="mx-auto" style="width:390px; height:844px;font-family:${e.fontFamily};">
  ...
  `}function me(e,n){const t=e.type==="sent",i=t?n.sentBg:n.recvBg,r=t?n.sentText:n.recvText,o=i,s=t?"justify-end":"justify-start",d=e.status||"read",h=t?`<div class="absolute -right-[7px] bottom-[6px] w-0 h-0 border-l-[8px] border-t-[6px] border-t-transparent border-b-[6px] border-b-transparent" style="border-left-color:${o}"></div>`:`<div class="absolute -left-[7px] bottom-[6px] w-0 h-0 border-r-[8px] border-t-[6px] border-t-transparent border-b-[6px] border-b-transparent" style="border-right-color:${o}"></div>`;let c="";t&&(d==="read"?c=kt:d==="delivered"?c=$t:d==="sent"&&(c=Bt));const p=d==="unread",m=p?"font-semibold":"",u=p?`<span class="inline-flex ml-1 -mb-0.5">${zt}</span>`:"";return`
    <div class="flex ${s}">
  ...
  `}function At(e){jt("wa-contact-name",i=>{i.textContent=e.username});const n=document.getElementById("wa-avatar");if(n)if(e.avatar){const i=document.createElement("img");i.id="wa-avatar",i.src=e.avatar,i.className="w-full h-full rounded-full object-cover",i.alt="",n.replaceWith(i)}else{const i=document.createElement("div");i.id="wa-avatar",i.className="w-full h-full rounded-full bg-[#2c2c2c] flex items-center justify-center",i.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="#8696a0"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>',n.replaceWith(i)}const t=document.getElementById("wa-messages");if(t){const i=xe(e);t.innerHTML=e.messages.map(r=>me(r,i)).join("")}}function jt(e,n){const t=document.getElementById(e);t&&n(t)}const _t='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#e9edef" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>',Ot='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#e9edef" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>',Pt='<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/></svg>',Ht='<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.44 11.05l-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48"/></svg>',Gt='<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/><line x1="8" y1="23" x2="16" y2="23"/></svg>',Nt='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><rect x="1" y="8" width="2" height="3" rx="0.4" fill="currentColor"/><rect x="5" y="5" width="2" height="6" rx="0.4" fill="currentColor"/><rect x="9" y="2.5" width="2" height="8.5" rx="0.4" fill="currentColor"/><rect x="13" y="0.5" width="2" height="10.5" rx="0.4" fill="currentColor"/></svg>',Vt='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><path d="M9 11.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm-3.3-3.3a4.5 4.5 0 0 1 6.6 0l-1.1 1.1a3 3 0 0 0-4.4 0L5.7 8.2zM2.9 5.1a8 8 0 0 1 12.2 0l-1.1 1.1a6.5 6.5 0 0 0-10 0L2.9 5.1z" fill="currentColor"/></svg>',Rt='<svg width="24" height="12" viewBox="0 0 26 12" fill="none"><rect x="0.5" y="0.5" width="22" height="11" rx="2" stroke="currentColor" fill="none"/><rect x="2" y="2" width="19.5" height="8" rx="1.5" fill="currentColor"/><rect x="24" y="3.5" width="2" height="5" rx="0.75" fill="currentColor"/></svg>',Ft='<svg width="14" height="14" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#ffffffcc" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',Dt=`url("data:image/svg+xml,%3Csvg width='200' height='200' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='30' cy='30' r='2' fill='white' opacity='0.04'/%3E%3Ccircle cx='100' cy='60' r='1.5' fill='white' opacity='0.03'/%3E%3Ccircle cx='170' cy='30' r='1' fill='white' opacity='0.04'/%3E%3Ccircle cx='50' cy='120' r='1.5' fill='white' opacity='0.03'/%3E%3Ccircle cx='150' cy='150' r='2' fill='white' opacity='0.04'/%3E%3Ccircle cx='80' cy='180' r='1' fill='white' opacity='0.03'/%3E%3Ccircle cx='20' cy='170' r='1.5' fill='white' opacity='0.03'/%3E%3C/svg%3E")`,Wt=`url("data:image/svg+xml,%3Csvg width='200' height='200' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='30' cy='30' r='2' fill='black' opacity='0.04'/%3E%3Ccircle cx='100' cy='60' r='1.5' fill='black' opacity='0.03'/%3E%3Ccircle cx='170' cy='30' r='1' fill='black' opacity='0.04'/%3E%3Ccircle cx='50' cy='120' r='1.5' fill='black' opacity='0.03'/%3E%3Ccircle cx='150' cy='150' r='2' fill='black' opacity='0.04'/%3E%3Ccircle cx='80' cy='180' r='1' fill='black' opacity='0.03'/%3E%3Ccircle cx='20' cy='170' r='1.5' fill='black' opacity='0.03'/%3E%3C/svg%3E")`,Ut={barBg:"#4e8ad4",chatBg:"#eef2f6",sentBg:"#8774e1",timeText:"#00000080",inputBg:"#ffffff",fieldBg:"#eef2f6",dotPattern:Wt},Kt={barBg:"#2f6ea5",chatBg:"#0f0f0f",sentBg:"#8774e1",timeText:"#ffffffcc",inputBg:"#1c1c1e",fieldBg:"#2a2a2e",dotPattern:Dt};function qt(e){return e.mockupTheme==="light"?Ut:Kt}function Jt(e){return`
        ...
        <div class="relative max-w-[80%]">
          <div class="rounded-2xl px-3.5 py-2" style="background:${n.sentBg}">
            ...
            <div class="flex items-center justify-end gap-1 mt-0.5">
              ...
              <span class="inline-flex -mb-0.5">${Ft}</span>
            </div>
          </div>
  ...
  `}function Qt(e){const n=qt(e),t=e.mockupTheme==="light"?"#ffffff":"#121212";return`
    <div id="mockup-card" class="mx-auto" style="width:390px; height:844px;font-family:${e.fontFamily};">
      <div class="w-full h-full overflow-hidden rounded-[2.5rem] border-8 flex flex-col" style="border-color:${t};background:${t}">
        ${Jt(n)}
        ${Yt(e,n)}
  ...
  `}function en(e){V("tg-contact-name",t=>{t.textContent=e.username}),V("tg-message",t=>{t.textContent=e.message}),V("tg-time",t=>{t.textContent=e.timestamp});const n=document.getElementById("tg-avatar");if(n)if(e.avatar){const t=document.createElement("img");t.id="tg-avatar",t.src=e.avatar,t.className="w-full h-full rounded-full object-cover",t.alt="",n.replaceWith(t)}else{const t=document.createElement("div");t.id="tg-avatar",t.className="w-full h-full rounded-full bg-[#527da3] flex items-center justify-center",t.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="#e9edef"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>',n.replaceWith(t)}}function V(e,n){const t=document.getElementById(e);t&&n(t)}const tn='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#e9edef" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>',nn='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/></svg>',rn='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',sn='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><rect x="1" y="8" width="2" height="3" rx="0.4" fill="currentColor"/><rect x="5" y="5" width="2" height="6" rx="0.4" fill="currentColor"/><rect x="9" y="2.5" width="2" height="8.5" rx="0.4" fill="currentColor"/><rect x="13" y="0.5" width="2" height="10.5" rx="0.4" fill="currentColor"/></svg>',on='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><path d="M9 11.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm-3.3-3.3a4.5 4.5 0 0 1 6.6 0l-1.1 1.1a3 3 0 0 0-4.4 0L5.7 8.2zM2.9 5.1a8 8 0 0 1 12.2 0l-1.1 1.1a6.5 6.5 0 0 0-10 0L2.9 5.1z" fill="currentColor"/></svg>',an='<svg width="24" height="12" viewBox="0 0 26 12" fill="none"><rect x="0.5" y="0.5" width="22" height="11" rx="2" stroke="currentColor" fill="none"/><rect x="2" y="2" width="19.5" height="8" rx="1.5" fill="currentColor"/><rect x="24" y="3.5" width="2" height="5" rx="0.75" fill="currentColor"/></svg>',ln='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/></svg>',cn='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.44 11.05l-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48"/></svg>',dn='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/><line x1="8" y1="23" x2="16" y2="23"/></svg>',pn='<svg width="14" height="14" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#ffffffcc" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',un={barBg:"#3b82f6",chatBg:"#f0f2f5",sentBg:"#3b82f6",sentText:"#ffffff",timeText:"#00000080",inputBg:"#f0f2f5",fieldBg:"#ffffff",fieldText:"#111b21",placeholder:"#8696a0"},gn={barBg:"#1e1f22",chatBg:"#101214",sentBg:"#3b82f6",sentText:"#ffffff",timeText:"#ffffffcc",inputBg:"#1e1f22",fieldBg:"#2b2d30",fieldText:"#e9edef",placeholder:"#8696a0"};function fn(e){return e.mockupTheme==="light"?un:gn}function hn(e){const n=fn(e),t=e.mockupTheme==="light"?"#ffffff":"#121212";return`
    <div id="mockup-card" class="mx-auto" style="width:390px; height:844px;font-family:${e.fontFamily};">
      <div class="w-full h-full overflow-hidden rounded-[2.5rem] border-8 flex flex-col" style="border-color:${t};background:${t}">
        ${xn(n)}
        ${mn(e,n)}
          ...
          <div class="relative max-w-[80%]">
            <div class="rounded-2xl px-3.5 py-2" style="background:${n.sentBg}">
              ...
              <div class="flex items-center justify-end gap-1 mt-0.5">
                ...
                <span class="inline-flex -mb-0.5">${pn}</span>
              </div>
            </div>
          </div>
        </div>
  ...
  `}function wn(e){R("sg-contact-name",t=>{t.textContent=e.username}),R("sg-message",t=>{t.textContent=e.message}),R("sg-time",t=>{t.textContent=e.timestamp});const n=document.getElementById("sg-avatar");if(n)if(e.avatar){const t=document.createElement("img");t.id="sg-avatar",t.src=e.avatar,t.className="w-full h-full rounded-full object-cover",t.alt="",n.replaceWith(t)}else{const t=document.createElement("div");t.id="sg-avatar",t.className="w-full h-full rounded-full bg-[#2c2c2c] flex items-center justify-center",t.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="#8696a0"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>',n.replaceWith(t)}}function R(e,n){const t=document.getElementById(e);t&&n(t)}const yn='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>',kn='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>',$n='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><rect x="1" y="8" width="2" height="3" rx="0.4" fill="currentColor"/><rect x="5" y="5" width="2" height="6" rx="0.4" fill="currentColor"/><rect x="9" y="2.5" width="2" height="8.5" rx="0.4" fill="currentColor"/><rect x="13" y="0.5" width="2" height="10.5" rx="0.4" fill="currentColor"/></svg>',Bn='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><path d="M9 11.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm-3.3-3.3a4.5 4.5 0 0 1 6.6 0l-1.1 1.1a3 3 0 0 0-4.4 0L5.7 8.2zM2.9 5.1a8 8 0 0 1 12.2 0l-1.1 1.1a6.5 6.5 0 0 0-10 0L2.9 5.1z" fill="currentColor"/></svg>',zn='<svg width="24" height="12" viewBox="0 0 26 12" fill="none"><rect x="0.5" y="0.5" width="22" height="11" rx="2" stroke="currentColor" fill="none"/><rect x="2" y="2" width="19.5" height="8" rx="1.5" fill="currentColor"/><rect x="24" y="3.5" width="2" height="5" rx="0.75" fill="currentColor"/></svg>',En={barBg:"#f8f8f8",chatBg:"#ffffff",sentBg:"#34c759",timeText:"#8e8e93",inputBg:"#f8f8f8",fieldBg:"#e5e5ea",fieldText:"#000000",statusColor:"#000000",navColor:"#007aff"},Cn={barBg:"#1c1c1e",chatBg:"#000000",sentBg:"#34c759",timeText:"#8e8e93",inputBg:"#1c1c1e",fieldBg:"#2c2c2e",fieldText:"#ffffff",statusColor:"#ffffff",navColor:"#ffffff"};function Sn(e){return e.mockupTheme==="light"?En:Cn}function Mn(e){const n=Sn(e),t=e.mockupTheme==="light"?"#e5e5ea":"#1c1c1e";return`
    <div id="mockup-card" class="mx-auto" style="width:390px; height:844px;font-family:${e.fontFamily};">
      <div class="w-full h-full overflow-hidden rounded-[2.5rem] border-8 flex flex-col" style="border-color:${t};background:${t}">
        ${Ln(n)}
        ${Tn(e,n)}
  ...
  `}function Tn(e,n){return`
    <div class="flex items-center gap-1 px-2 py-1.5 shrink-0" style="background:${n.barBg};color:${n.navColor}">
      <span class="shrink-0 px-1">${yn}</span>
      ...
      <div class="flex items-center gap-2 shrink-0 px-1">
        <span style="color:${n.navColor}">${kn}</span>
      </div>
    </div>
      ...
      <div class="flex items-center gap-1.5">
        ...
        <div class="relative flex" id="export-dropdown-container">
          ...
          <div id="export-dropdown" class="absolute right-0 top-full mt-1 z-50 hidden min-w-[200px] rounded-xl border border-white/10 bg-[#1a1714]/95 backdrop-blur-2xl py-1 shadow-2xl shadow-black/50">
            <button data-export-action="png" class="flex items-center gap-2.5 w-full px-3 py-2 text-xs text-zinc-300 hover:bg-white/5 hover:text-white transition-all text-left">
              ${x.download} <span>${a("topbar.exportPng")}</span>
            </button>
            <button data-export-action="clipboard" class="flex items-center gap-2.5 w-full px-3 py-2 text-xs text-zinc-300 hover:bg-white/5 hover:text-white transition-all text-left">
              ${x.clipboard} <span>${a("topbar.exportClipboard")}</span>
            </button>
            <button data-export-action="share" class="flex items-center gap-2.5 w-full px-3 py-2 text-xs text-zinc-300 hover:bg-white/5 hover:text-white transition-all text-left">
              ${x.link} <span>${a("topbar.exportShare")}</span>
            </button>
          </div>
        </div>
        ...
        <div class="relative flex" id="lang-switcher">
          <button id="lang-btn"
            ...
            <span class="w-4 h-3 shrink-0 rounded-[2px] overflow-hidden">${le(ae)}</span>
            <span class="text-[10px] font-semibold leading-none">${ae.toUpperCase()}</span>
            <span class="text-zinc-500">${x.chevronDown}</span>
          </button>
          <div id="lang-dropdown" class="hidden absolute right-0 top-full mt-1.5 z-50 min-w-[130px] rounded-xl border border-white/10 bg-[#1a1714]/95 backdrop-blur-2xl py-1 shadow-2xl shadow-black/50">
            ${["de","en","es"].map(n=>`
              <button data-lang="${n}"
                ...
                <span class="w-5 h-4 shrink-0 rounded-[2px] overflow-hidden">${le(n)}</span>
                ${Pn[n]}
              </button>
            `).join("")}
          </div>
  ...
  `}function Gn(e){const n=l.getSidebarOpen(),i=Y()==="de"?"/de":"";return n?`
  ...
  `:'<aside id="sidebar" class="w-0 shrink-0 overflow-hidden transition-all duration-300 bg-[#0d0a07] relative z-10"></aside>'}function we(){const e=l.listTemplates();return`
  ...
  `}function ye(e){const n=["whatsapp","telegram","signal","imessage"].includes(v);let t="";return v==="discord"?t=`
  ...
  `}function Rn(e){const n=l.get("_zoom")||0;return`
  ...
  `}function Fn(){const e=document.getElementById("app");if(!e)return;const n=l.getState(),t=l.getSidebarOpen();e.innerHTML=`
    ${Hn()}
  ...
  `,Wn(),L();const i=document.getElementById("sidebar");i&&(i.style.width=t?"340px":"0px");const r=l.get("_zoom")||0;ze(r)}function Dn(){const e=document.getElementById("btn-undo"),n=document.getElementById("btn-redo");e&&(e.disabled=!l.canUndo()),n&&(n.disabled=!l.canRedo())}function ce(e){const n=document.getElementById("settings-panel");n&&(n.innerHTML=`
    <span class="text-xs font-semibold text-zinc-300 tracking-wide">${a("sidebar.settings")} · <span class="text-zinc-500 font-normal normal-case">${be()}</span></span>
    ${ye(e)}
  `,$e())}function Wn(){f("btn-topbar-export","click",()=>W()),f("btn-export-chevron","click",Jn),f("btn-sidebar-toggle","click",U),f("btn-sidebar-open","click",U),f("sidebar-overlay","click",U),f("btn-undo","click",()=>l.undo()),f("btn-redo","click",()=>l.redo()),f("btn-mockup-theme","click",()=>{const t=l.get("mockupTheme")==="light"?"dark":"light";l.set("mockupTheme",t)}),f("lang-btn","click",t=>{t.stopPropagation(),document.getElementById("lang-dropdown").classList.toggle("hidden")}),document.addEventListener("click",()=>{const t=document.getElementById("lang-dropdown");t&&!t.classList.contains("hidden")&&t.classList.add("hidden")}),document.querySelectorAll("[data-lang]").forEach(t=>{t.addEventListener("click",()=>{const i=t.dataset.lang;window.location.href=i==="en"?"/":`/${i}/`})}),f("btn-start-tour","click",()=>ge()),f("btn-template-save","click",Qn),f("zoom-slider","input",Zn),f("btn-zoom-in","click",()=>K(10)),f("btn-zoom-out","click",()=>K(-10)),document.querySelectorAll("[data-gradient]").forEach(t=>{t.addEventListener("click",()=>l.set("bgGradient",t.dataset.gradient))}),document.querySelectorAll("[data-app]").forEach(t=>{t.addEventListener("click",()=>{const i=_.find(r=>r.id===t.dataset.app);i&&l.set("theme",i.theme)})}),document.querySelectorAll("[data-export-action]").forEach(t=>{t.addEventListener("click",i=>{const r=t.dataset.exportAction;de(),r==="png"?W():r==="clipboard"?Yn():r==="share"&&Xn()})}),document.querySelectorAll("[data-tmpl-action]").forEach(t=>{t.addEventListener("click",i=>{var s;const r=t.dataset.tmplAction,o=(s=t.closest("[data-tmpl-name]"))==null?void 0:s.dataset.tmplName;o&&(r==="load"?l.loadTemplate(o):r==="delete"&&(l.deleteTemplate(o),te()))})});const e=document.getElementById("app-library-toggle");e&&e.addEventListener("click",()=>{const t=document.getElementById("app-library-body"),i=document.getElementById("app-library-chevron");if(!t)return;const r=t.style.display==="none";t.style.display=r?"":"none",i&&(i.style.transform=r?"rotate(0deg)":"rotate(180deg)")}),document.addEventListener("click",t=>{const i=document.getElementById("export-dropdown-container");i&&!i.contains(t.target)&&de()}),document.addEventListener("keydown",t=>{const i=t.metaKey||t.ctrlKey;i&&t.key==="z"&&!t.shiftKey&&(t.preventDefault(),l.undo()),i&&t.key==="z"&&t.shiftKey&&(t.preventDefault(),l.redo()),i&&t.key==="e"&&(t.preventDefault(),W())});const n=document.getElementById("canvas");n&&n.addEventListener("wheel",t=>{(t.ctrlKey||t.metaKey)&&(t.preventDefault(),K(t.deltaY>0?-5:5))},{passive:!1}),$e()}function $e(){f("input-padding","input",e=>{l.set("padding",Number(e.target.value));const n=document.getElementById("padding-value");n&&(n.textContent=e.target.value)}),f("input-font","change",e=>l.set("fontFamily",e.target.value)),f("input-chatbg","change",async e=>{var t;const n=(t=e.target.files)==null?void 0:t[0];if(n&&n.type.startsWith("image/")&&!(n.size>5*1024*1024))try{const i=await new Promise((r,o)=>{const s=new FileReader;s.onload=()=>r(s.result),s.onerror=o,s.readAsDataURL(n)});l.set("chatBg",i)}catch{}}),f("input-message","input",e=>l.set("message",e.target.value)),f("input-avatar","change",async e=>{var t;const n=(t=e.target.files)==null?void 0:t[0];if(n&&n.type.startsWith("image/")&&!(n.size>5*1024*1024))try{const i=l.get("avatar"),r=await Oe(n);i&&i.startsWith("blob:")&&URL.revokeObjectURL(i),l.set("avatar",r)}catch{l.set("avatar",null)}}),["messenger","instagram","twitter","tiktok","social-post"].includes(v)?(f("input-author","input",e=>l.set("author",e.target.value)),f("input-handle","input",e=>l.set("handle",e.target.value))):v==="discord"?(f("input-username","input",e=>l.set("username",e.target.value)),f("input-rolecolor","input",e=>l.set("roleColor",e.target.value)),f("input-timestamp","input",e=>l.set("timestamp",e.target.value))):["whatsapp","telegram","signal","imessage"].includes(v)&&(f("input-username","input",e=>l.set("username",e.target.value)),v==="whatsapp"?Un():f("input-timestamp","input",e=>l.set("timestamp",e.target.value)))}function Un(){const e=document.getElementById("btn-add-message");e&&(e.onclick=()=>{const i=[...l.get("messages")];i.push({id:Date.now(),text:"",type:l.get("waMode")||"sent",time:""}),l.set("messages",i),M(l.getState())});const n=document.getElementById("wa-message-list");if(!n)return;n.addEventListener("input",i=>{const r=i.target,o=parseInt(r.dataset.msgIdx);if(!isNaN(o)){if(r.tagName==="TEXTAREA"){const s=[...l.get("messages")];s[o]&&(s[o]={...s[o],text:r.value}),l.set("messages",s)}else if(r.dataset.msgField==="time"){const s=[...l.get("messages")];s[o]&&(s[o]={...s[o],time:r.value}),l.set("messages",s)}}}),n.addEventListener("click",i=>{const r=i.target.closest("[data-msg-type], [data-msg-status], [data-msg-action]");if(!r)return;const o=parseInt(r.dataset.msgIdx);if(!isNaN(o)){if(r.dataset.msgType){const s=[...l.get("messages")];s[o]&&(s[o]={...s[o],type:r.dataset.msgType}),l.set("messages",s),M(l.getState())}else if(r.dataset.msgStatus){const s=[...l.get("messages")];s[o]&&(s[o]={...s[o],status:r.dataset.msgStatus}),l.set("messages",s),M(l.getState())}else if(r.dataset.msgAction==="delete"){const s=l.get("messages").filter((d,h)=>h!==o);l.set("messages",s),M(l.getState())}}});let t=null;n.addEventListener("dragstart",i=>{const r=i.target.closest("[draggable]");r&&(t=parseInt(r.dataset.msgIdx),r.style.opacity="0.4")}),n.addEventListener("dragend",i=>{const r=i.target.closest("[draggable]");r&&(r.style.opacity=""),t=null}),n.addEventListener("dragover",i=>{i.preventDefault();const r=i.target.closest("[draggable]");r&&(r.style.borderColor="rgba(255,255,255,0.3)")}),n.addEventListener("dragleave",i=>{const r=i.target.closest("[draggable]");r&&(r.style.borderColor="")}),n.addEventListener("drop",i=>{i.preventDefault();const r=i.target.closest("[draggable]");if(!r)return;r.style.borderColor="";const o=parseInt(r.dataset.msgIdx);if(t===null||t===o)return;const s=[...l.get("messages")],[d]=s.splice(t,1);s.splice(o,0,d),l.set("messages",s),M(l.getState())})}function M(e){const n=document.getElementById("wa-message-list");n&&(n.innerHTML=e.messages.map((t,i)=>ke(t,i)).join(""))}function L(){const e=ve[v];if(!e)return;const n=l.getState(),t=document.getElementById("mockup");t&&(t.innerHTML=e.render(n)),Be(n),requestAnimationFrame(H)}function Kn(e,n,t){if(!D){D=!0;try{const i=ve[v];if(!i)return;if(e==="theme"){v=n;const r=Ee();r&&l.mutate({author:r.author||"",handle:r.handle||"",username:r.username||r.author||"",message:r.message||"",timestamp:r.time||"",roleColor:r.roleColor||"#5865F2",messages:r.messages||[{id:1,text:r.message||"",type:l.get("waMode")||"sent",time:r.time||"",status:"read"}]}),L(),ce(l.getState()),qn(n),Ge()&&requestAnimationFrame(()=>Re());return}if(e==="bgGradient"&&Be(t),e==="mockupTheme"){const r=document.getElementById("btn-mockup-theme");r&&(r.innerHTML=n==="light"?x.sun:x.moon),L();return}if(e==="fontFamily"||e==="chatBg"){L();return}if(e==="waMode")return;if(e==="_zoom"){ze(n);return}if(e==="_undo"||e==="_redo"){L(),ce(l.getState()),Dn();return}e==="avatar"&&Pe(v==="discord"?"discord-avatar":v==="whatsapp"?"wa-avatar":"mockup-avatar"),i.sync(t)}finally{D=!1}}}function qn(e){document.querySelectorAll("[data-app]").forEach(n=>{const t=_.find(r=>r.id===n.dataset.app),i=t&&t.theme===e;n.className=`flex items-center gap-3 rounded-xl border p-2.5 transition-all text-left ${i?"border-white/15 bg-white/[8%]":"border-white/[4%] bg-white/[3%] hover:bg-white/[7%] hover:border-white/[8%]"}`})}function Be(e){const n=On[e.bgGradient]||["#0f172a","#1e1b4b"];document.documentElement.style.setProperty("--chat-bg",`linear-gradient(135deg, ${n[0]}, ${n[1]})`)}function H(){if(J)return;const e=document.getElementById("canvas"),n=document.getElementById("mockup-card");if(!e||!n)return;const t=e.getBoundingClientRect(),i=Math.min(t.width/390,t.height/844)*.9,o=1+(l.get("_zoom")||0)/100,s=i*o;n.style.transform=`scale(${s})`,n.style.transformOrigin="center center"}window.addEventListener("resize",H);async function W(){const e=document.getElementById("btn-topbar-export"),n=document.getElementById("btn-export-icon"),t=document.getElementById("btn-export-label");if(!e||e.disabled)return;J=!0,e.disabled=!0,n&&(n.innerHTML=x.spinner),t&&(t.textContent=a("topbar.rendering"));const i=document.getElementById("mockup-card");if(!i){s();return}const r=i.style.transform,o=i.style.transformOrigin;i.style.transform="",i.style.transformOrigin="",await new Promise(d=>requestAnimationFrame(d));try{const{toPng:d}=await pe(async()=>{const{toPng:b}=await import("./index-CgJtiJsK.js");return{toPng:b}},[]),h=await d(i,{pixelRatio:2});i.style.transform=r,i.style.transformOrigin=o;const c=new Date,p=`${c.getFullYear()}-${String(c.getMonth()+1).padStart(2,"0")}-${String(c.getDate()).padStart(2,"0")}_${String(c.getHours()).padStart(2,"0")}-${String(c.getMinutes()).padStart(2,"0")}-${String(c.getSeconds()).padStart(2,"0")}`,m=`koalasnap-${v}-${p}.png`,u=document.createElement("a");u.download=m,u.href=h,u.click(),n&&(n.innerHTML=x.check),t&&(t.textContent=a("topbar.exported")),e.classList.remove("bg-[#f97316]","hover:bg-[#ea580c]"),e.classList.add("bg-emerald-500","hover:bg-emerald-600"),setTimeout(s,2e3)}catch(d){i.style.transform=r,i.style.transformOrigin=o,console.error("Export failed:",(d==null?void 0:d.message)||d,(d==null?void 0:d.stack)||""),n&&(n.innerHTML=x.download),t&&(t.textContent=a("topbar.exportFailed")),e.disabled=!1,setTimeout(()=>{t&&(t.textContent=a("topbar.export")),n&&(n.innerHTML=x.download)},2e3)}function s(){J=!1,e.disabled=!1,e.classList.remove("bg-emerald-500","hover:bg-emerald-600"),e.classList.add("bg-[#f97316]","hover:bg-[#ea580c]"),n&&(n.innerHTML=x.download),t&&(t.textContent=a("topbar.export"))}}function Jn(){const e=document.getElementById("export-dropdown");if(!e)return;const n=!e.classList.contains("hidden");e.classList.toggle("hidden",n)}function de(){const e=document.getElementById("export-dropdown");e&&e.classList.add("hidden")}async function Yn(){const e=document.getElementById("mockup-card");if(!e)return;const n=document.getElementById("btn-topbar-export"),t=document.getElementById("btn-export-icon"),i=document.getElementById("btn-export-label");n&&(n.disabled=!0),t&&(t.innerHTML=x.spinner),i&&(i.textContent=a("topbar.rendering"));try{const r=e.style.transform,o=e.style.transformOrigin;e.style.transform="",e.style.transformOrigin="";const s=e.querySelectorAll('[style*="background-image"]'),d=[];s.forEach((u,b)=>{d[b]=u.style.backgroundImage,u.style.backgroundImage="none"});const h=e.querySelectorAll("img"),c=[];h.forEach((u,b)=>{c[b]=u.src,u.src.startsWith("blob:")&&(u.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7")}),await new Promise(u=>requestAnimationFrame(u));const{toBlob:p}=await pe(async()=>{const{toBlob:u}=await import("./index-CgJtiJsK.js");return{toBlob:u}},[]),m=await p(e,{pixelRatio:2});e.style.transform=r,e.style.transformOrigin=o,s.forEach((u,b)=>{u.style.backgroundImage=d[b]}),h.forEach((u,b)=>{c[b]&&(u.src=c[b])}),m&&(await navigator.clipboard.write([new ClipboardItem({"image/png":m})]),z(a("topbar.copied")))}catch(r){console.error("Clipboard copy failed:",r),z(a("topbar.exportFailed"))}n&&(n.disabled=!1),t&&(t.innerHTML=x.download),i&&(i.textContent=a("topbar.export"))}function Xn(){const e=l.getShareUrl();if(!e){z(a("topbar.exportFailed"));return}try{navigator.clipboard.writeText(e),z(a("topbar.linkCopied"))}catch{z(a("topbar.exportFailed"))}}function z(e){const n=document.getElementById("toast");n&&n.remove();const t=document.createElement("div");t.id="toast",t.className="fixed bottom-28 left-1/2 -translate-x-1/2 z-50 rounded-full bg-zinc-800/90 backdrop-blur-xl border border-white/10 px-5 py-2.5 text-sm text-zinc-200 shadow-2xl shadow-black/30 animate-fade-in",t.textContent=e,document.body.appendChild(t),setTimeout(()=>{t.style.opacity="0",t.style.transition="opacity 0.3s",setTimeout(()=>t.remove(),300)},2e3)}function U(){const n=!l.getSidebarOpen();l.setSidebarOpen(n);const t=document.getElementById("sidebar");t&&(t.style.width=n?"340px":"0px");const i=document.getElementById("sidebar-overlay");i&&(n&&window.innerWidth<768?i.classList.remove("hidden"):i.classList.add("hidden")),requestAnimationFrame(H)}function K(e){const n=l.get("_zoom")||0,t=Math.max(-50,Math.min(100,n+e));l.set("_zoom",t)}function Zn(e){const n=parseInt(e.target.value);l.set("_zoom",n)}function ze(e){const n=document.getElementById("zoom-slider");n&&(n.value=e);const t=document.getElementById("zoom-label");t&&(t.textContent=e>0?`+${e}%`:`${e}%`),H()}function te(){const e=document.getElementById("templates-section");if(!e||!document.getElementById("sidebar"))return;const t=document.createElement("div");t.innerHTML=we(),e.replaceWith(t.firstElementChild),document.querySelectorAll("[data-tmpl-action]").forEach(i=>{i.addEventListener("click",r=>{var d;const o=i.dataset.tmplAction,s=(d=i.closest("[data-tmpl-name]"))==null?void 0:d.dataset.tmplName;s&&(o==="load"?l.loadTemplate(s):o==="delete"&&(l.deleteTemplate(s),te()))})})}function Qn(){const e=document.getElementById("input-template-name");if(!e||!e.value.trim())return;const n=e.value.trim();l.saveTemplate(n),e.value="",te(),z(a("templates.saved"))}function f(e,n,t){var i;(i=document.getElementById(e))==null||i.addEventListener(n,t)}function Ee(){var o,s;const e=[{author:"Maya",handle:"@maya_99",username:"Maya",message:"Hey, are you coming online tonight?",time:"7:18 PM",roleColor:"#e81224",messages:[{text:"Hey, are you coming online tonight?",type:"sent",time:"7:18 PM"},{text:"Yeah, give me 5!",type:"received",time:"7:20 PM"},{text:"Sure, take your time 🐨",type:"sent",time:"7:21 PM"}]}],n=window.__LOCALE__,t=n!=null&&n.dummySets&&n.dummySets.length>0?n.dummySets:e,i=t[Math.floor(Math.random()*t.length)],r=i.messages&&i.messages.length>0?i.messages.map((d,h)=>({id:h+1,text:d.text,type:d.type,time:d.time,status:d.status||"read"})):[{id:1,text:i.message||"",type:l.get("waMode")||"sent",time:i.time||"",status:"read"}];return{author:i.author||"",handle:i.handle||"",username:i.username||i.author||"",message:i.message||((o=r[0])==null?void 0:o.text)||"",time:i.time||((s=r[0])==null?void 0:s.time)||"",roleColor:i.roleColor||"#5865F2",messages:r}}l.subscribe(Kn);try{const e=localStorage.getItem("koalasnap_state"),n=Y();let t=!e;if(e)try{const i=JSON.parse(e);(!i.locale||i.locale!==n)&&(t=!0)}catch{t=!0}if(t){const i=Ee();i&&l.mutate({...i,locale:n})}}catch{}Fn();"serviceWorker"in navigator&&navigator.serviceWorker.register("/sw.js").catch(()=>{});He()||setTimeout(()=>ge(),800);
