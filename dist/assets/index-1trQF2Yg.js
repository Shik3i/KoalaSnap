(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(r){if(r.ep)return;r.ep=!0;const o=t(r);fetch(r.href,o)}})();const Ae="modulepreload",Le=function(e){return"/"+e},se={},ge=function(n,t,i){let r=Promise.resolve();if(t&&t.length>0){let s=function(c){return Promise.all(c.map(p=>Promise.resolve(p).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};document.getElementsByTagName("link");const d=document.querySelector("meta[property=csp-nonce]"),h=(d==null?void 0:d.nonce)||(d==null?void 0:d.getAttribute("nonce"));r=s(t.map(c=>{if(c=Le(c),c in se)return;se[c]=!0;const p=c.endsWith(".css"),g=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${g}`))return;const u=document.createElement("link");if(u.rel=p?"stylesheet":Ae,p||(u.as="script"),u.crossOrigin="",u.href=c,h&&u.setAttribute("nonce",h),document.head.appendChild(u),p)return new Promise((v,C)=>{u.addEventListener("load",v),u.addEventListener("error",()=>C(new Error(`Unable to preload CSS for ${c}`)))})}))}function o(s){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=s,window.dispatchEvent(d),!d.defaultPrevented)throw s}return r.then(s=>{for(const d of s||[])d.status==="rejected"&&o(d.reason);return n().catch(o)})},X="koalasnap_state",$="koalasnap_templates",oe="koalasnap_sidebar",H=2,Me={bgGradient:"from-sky-400 to-indigo-600"},ae={1:e=>(e.bgGradient===Me.bgGradient&&(e.bgGradient="from-slate-900 to-indigo-950"),e)};function Te(e){try{const n=localStorage.getItem(X);if(n){const t=JSON.parse(n),i=t._version||1;if(i<H){for(let s=i;s<H;s++)ae[s]&&ae[s](t);t._version=H;const{avatar:r,...o}=t;localStorage.setItem(X,JSON.stringify(o))}return{...e,...t}}}catch{}return{...e}}function B(e){try{const{avatar:n,...t}=e;localStorage.setItem(X,JSON.stringify(t))}catch{}}function Ie(){try{const n=new URLSearchParams(window.location.search).get("state");if(!n)return null;const t=atob(n),i=Uint8Array.from(t,s=>s.charCodeAt(0)),r=new TextDecoder().decode(i),o=JSON.parse(r);if(o&&typeof o=="object")return o}catch{}return null}function je(e){const n=Ie(),t=n?{...e,...n}:Te(e),i=new Set,r=[],o=[],s=50;let d=!1;function h(){d||(r.push(JSON.parse(JSON.stringify(t))),r.length>s&&r.shift(),o.length=0)}return{get(c){return t[c]},getState(){return{...t}},set(c,p){h(),t[c]=p,B(t),i.forEach(g=>g(c,p,t))},setAll(c){h(),Object.assign(t,c),B(t),i.forEach(p=>p(null,null,t))},mutate(c){h(),Object.assign(t,c),B(t),i.forEach(p=>p(null,null,t))},subscribe(c){return i.add(c),()=>i.delete(c)},reset(){h(),Object.assign(t,e),B(t),i.forEach(c=>c(null,null,t))},undo(){if(r.length===0)return;o.push(JSON.parse(JSON.stringify(t)));const c=r.pop();Object.assign(t,c),B(t),i.forEach(p=>p("_undo",null,t))},redo(){if(o.length===0)return;r.push(JSON.parse(JSON.stringify(t)));const c=o.pop();Object.assign(t,c),B(t),i.forEach(p=>p("_redo",null,t))},canUndo(){return r.length>0},canRedo(){return o.length>0},pauseHistory(){d=!0},resumeHistory(){d=!1},saveTemplate(c){try{const p=JSON.parse(localStorage.getItem($)||"{}"),{avatar:g,...u}=t;return p[c]=u,localStorage.setItem($,JSON.stringify(p)),!0}catch{return!1}},deleteTemplate(c){try{const p=JSON.parse(localStorage.getItem($)||"{}");return delete p[c],localStorage.setItem($,JSON.stringify(p)),!0}catch{return!1}},loadTemplate(c){try{const g=JSON.parse(localStorage.getItem($)||"{}")[c];return g?(this.mutate(g),!0):!1}catch{return!1}},listTemplates(){try{return Object.keys(JSON.parse(localStorage.getItem($)||"{}"))}catch{return[]}},getSidebarOpen(){return localStorage.getItem(oe)!=="false"},setSidebarOpen(c){localStorage.setItem(oe,String(c))},getShareUrl(){try{const{avatar:c,...p}=t,g=JSON.stringify(p),u=new TextEncoder().encode(g),v=String.fromCharCode(...u),C=btoa(v),_=new URL(window.location.href.split("?")[0].split("#")[0]);return _.searchParams.set("state",C),_.toString()}catch{return null}}}}const _e={_version:H,theme:"whatsapp",author:"Maya",handle:"@maya_99",username:"Maya",roleColor:"#e81224",timestamp:"7:18 PM",message:"Hey, are you coming online tonight?",avatar:null,bgGradient:"from-slate-900 to-indigo-950",padding:48,mockupTheme:"light",waMode:"sent",locale:"en",fontFamily:"system-ui",chatBg:null,messages:[{id:1,text:"Hey, are you coming online tonight?",type:"sent",time:"7:18 PM",status:"read"},{id:2,text:"Yeah, give me 5!",type:"received",time:"7:20 PM",status:"read"},{id:3,text:"Sure, take your time 🐨",type:"sent",time:"7:21 PM",status:"delivered"}]},l=je(_e),Oe=window.__LOCALE__||{};function a(e){return e.split(".").reduce((t,i)=>t!=null?t[i]:void 0,Oe)??e}function Z(){const e=window.location.pathname;return e.startsWith("/de/")||e==="/de"?"de":"en"}function f(e){return typeof e!="string"?"":e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}const P=500,Pe=.8;function He(e){return new Promise((n,t)=>{const i=new FileReader;i.onerror=()=>t(new Error("File read failed")),i.onload=r=>{const o=new Image;o.onerror=()=>t(new Error("Image decode failed")),o.onload=()=>{let{width:s,height:d}=o;if(s>P||d>P){const p=Math.min(P/s,P/d);s=Math.round(s*p),d=Math.round(d*p)}const h=document.createElement("canvas");h.width=s,h.height=d;const c=h.getContext("2d");if(!c){t(new Error("Canvas 2D not supported"));return}c.imageSmoothingEnabled=!0,c.imageSmoothingQuality="high",c.drawImage(o,0,0,s,d),h.toBlob(p=>{if(!p){t(new Error("WebP encoding failed"));return}n(URL.createObjectURL(p))},"image/webp",Pe)},o.src=r.target.result},i.readAsDataURL(e)})}function Ge(e){const n=document.getElementById(e);n instanceof HTMLImageElement&&(n.src="")}const fe="koalasnap_tutorial_completed",z=[{target:"app-library",key:"tutorial.step1"},{target:"settings-panel",key:"tutorial.step2"},{target:"canvas-area",key:"tutorial.step3"},{target:"bottom-bar",key:"tutorial.step4"},{target:"btn-topbar-export",key:"tutorial.step5"}];let w=0,I=!1,y=null;function Ne(){return localStorage.getItem(fe)==="true"}function Ve(){return I}function he(){I&&j(),w=0,I=!0;const e=We();e.classList.remove("hidden"),e.style.pointerEvents="auto",N(0),document.addEventListener("keydown",xe)}function xe(e){e.key==="Escape"&&j()}function j(){I=!1,y&&(clearTimeout(y),y=null),V(w);const e=document.getElementById("tutorial-overlay");e&&(e.classList.add("hidden"),e.style.pointerEvents=""),localStorage.setItem(fe,"true"),document.removeEventListener("keydown",xe)}function Re(){if(V(w),w++,w>=z.length){j();return}N(w)}function Fe(){V(w),w=Math.max(0,w-1),N(w)}function De(){I&&(V(w),N(w))}function We(){let e=document.getElementById("tutorial-overlay");return e||(e=document.createElement("div"),e.id="tutorial-overlay",e.className="fixed inset-0 bg-black/60 z-40 hidden",document.body.appendChild(e)),e}function N(e){y&&(clearTimeout(y),y=null);const n=z[e];if(!n)return;const t=document.getElementById(n.target);if(!t)return;t.classList.add("tutorial-highlight"),t.style.zIndex="50",getComputedStyle(t).position==="static"&&(t.style.position="relative"),t.scrollIntoView({behavior:"smooth",block:"center"});const i=t.getBoundingClientRect();y=setTimeout(()=>{Ue(e,i),y=null},400)}function V(e){y&&(clearTimeout(y),y=null);const n=z[e];if(!n)return;const t=document.getElementById(n.target);t&&(t.classList.remove("tutorial-highlight"),t.style.zIndex="",t.style.position="");const i=document.getElementById("tutorial-tooltip");i&&i.remove()}function Ue(e,n){const t=document.getElementById("tutorial-tooltip");t&&t.remove();const i=z.length,r=e===0,o=e===i-1,s=document.createElement("div");s.id="tutorial-tooltip",s.className="fixed z-50 w-[320px] rounded-2xl border border-white/[10%] bg-[#1a1714]/95 backdrop-blur-2xl p-4 shadow-2xl shadow-black/50 opacity-0 transition-opacity duration-200",s.innerHTML=`
  ...
  `,document.body.appendChild(s),qe(s,n),requestAnimationFrame(()=>{s.classList.remove("opacity-0")}),Je(e)}function Ke(e){var n;return((n=z[e])==null?void 0:n.key)||""}function qe(e,n){const r=e.offsetWidth||320,o=e.offsetHeight||160,s=window.innerWidth-r-16,d=window.innerHeight-o-16,h=n.left+n.width/2;let c=Math.max(16,Math.min(h-r/2,s)),p=n.bottom+12;p+o>window.innerHeight-16&&(p=n.top-o-12),p<16&&(p=16,c=Math.min(n.right+12,s),c=Math.max(16,c)),c=Math.max(16,Math.min(c,s)),p=Math.max(16,Math.min(p,d)),e.style.left=`${c}px`,e.style.top=`${p}px`}function Je(e){const n=document.getElementById("tut-next");n&&(n.onclick=()=>e===z.length-1?j():Re());const t=document.getElementById("tut-prev");t&&(t.onclick=()=>Fe());const i=document.getElementById("tut-skip");i&&(i.onclick=()=>j())}const me="?",ee='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>',Ye='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="17 1 21 5 17 9"/><path d="M3 11V9a4 4 0 0 1 4-4h14"/><polyline points="7 23 3 19 7 15"/><path d="M21 13v2a4 4 0 0 1-4 4H3"/></svg>',te='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>',ne='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg>',Xe='<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="5" r="2"/><circle cx="12" cy="12" r="2"/><circle cx="12" cy="19" r="2"/></svg>';function ie(e,n){return e?`<img id="mockup-avatar" src="${e}" class="w-full h-full rounded-full object-cover" />`:`<div id="mockup-avatar" class="w-full h-full rounded-full bg-gradient-to-br ${n?"from-zinc-600 to-zinc-800":"from-sky-400 to-indigo-500"} flex items-center justify-center text-white text-sm font-bold">${me}</div>`}function Qe(e,n){const t=n?"bg-zinc-900":"bg-white",i=n?"text-zinc-100":"text-zinc-900",r=n?"text-zinc-400":"text-zinc-500",o=n?"text-zinc-300":"text-zinc-800",s=n?"border-zinc-700":"border-zinc-200";return`
  ...
  `}function Ze(e,n){const t=n?"bg-black":"bg-white",i=n?"text-white":"text-zinc-900",r=n?"text-zinc-400":"text-zinc-500";return`
  ...
  `}function It(e,n){return`
    <div class="flex-1 p-4 overflow-y-auto" style="background:${n.chatBg}${e.chatBg?`;background-image:url(${e.chatBg});background-size:cover`:`;background-image:${n.dotPattern}`}">
      <div id="wa-messages" class="flex flex-col gap-3">
        ${e.messages.map(t=>be(t,n)).join("")}
      </div>
    </div>
  `}function be(e,n){const t=e.type==="sent",i=t?n.sentBg:n.recvBg,r=t?n.sentText:n.recvText,o=i,s=t?"justify-end":"justify-start",d=e.status||"read",h=t?`<div class="absolute -right-[7px] bottom-[6px] w-0 h-0 border-l-[8px] border-t-[6px] border-t-transparent border-b-[6px] border-b-transparent" style="border-left-color:${o}"></div>`:`<div class="absolute -left-[7px] bottom-[6px] w-0 h-0 border-r-[8px] border-t-[6px] border-t-transparent border-b-[6px] border-b-transparent" style="border-right-color:${o}"></div>`;let c="";t&&(d==="read"?c=Bt:d==="delivered"?c=Et:d==="sent"&&(c=zt));const p=d==="unread",g=p?"font-semibold":"",u=p?`<span class="inline-flex ml-1 -mb-0.5">${Ct}</span>`:"";return`
    <div class="flex ${s}">
  ...
  `}function kn(e){U("sg-contact-name",t=>{t.textContent=e.username}),U("sg-message",t=>{t.textContent=e.message}),U("sg-time",t=>{t.textContent=e.timestamp});const n=document.getElementById("sg-avatar");if(n)if(e.avatar){const t=document.createElement("img");t.id="sg-avatar",t.src=e.avatar,t.className="w-full h-full rounded-full object-cover",t.alt="",n.replaceWith(t)}else{const t=document.createElement("div");t.id="sg-avatar",t.className="w-full h-full rounded-full bg-[#2c2c2c] flex items-center justify-center",t.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="#8696a0"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>',n.replaceWith(t)}}function U(e,n){const t=document.getElementById(e);t&&n(t)}const $n='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>',Bn='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>',En='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><rect x="1" y="8" width="2" height="3" rx="0.4" fill="currentColor"/><rect x="5" y="5" width="2" height="6" rx="0.4" fill="currentColor"/><rect x="9" y="2.5" width="2" height="8.5" rx="0.4" fill="currentColor"/><rect x="13" y="0.5" width="2" height="10.5" rx="0.4" fill="currentColor"/></svg>',zn='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><path d="M9 11.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm-3.3-3.3a4.5 4.5 0 0 1 6.6 0l-1.1 1.1a3 3 0 0 0-4.4 0L5.7 8.2zM2.9 5.1a8 8 0 0 1 12.2 0l-1.1 1.1a6.5 6.5 0 0 0-10 0L2.9 5.1z" fill="currentColor"/></svg>',Cn='<svg width="24" height="12" viewBox="0 0 26 12" fill="none"><rect x="0.5" y="0.5" width="22" height="11" rx="2" stroke="currentColor" fill="none"/><rect x="2" y="2" width="19.5" height="8" rx="1.5" fill="currentColor"/><rect x="24" y="3.5" width="2" height="5" rx="0.75" fill="currentColor"/></svg>',Sn={barBg:"#f8f8f8",chatBg:"#ffffff",sentBg:"#34c759",timeText:"#8e8e93",inputBg:"#f8f8f8",fieldBg:"#e5e5ea",fieldText:"#000000",statusColor:"#000000",navColor:"#007aff"},An={barBg:"#1c1c1e",chatBg:"#000000",sentBg:"#34c759",timeText:"#8e8e93",inputBg:"#1c1c1e",fieldBg:"#2c2c2e",fieldText:"#ffffff",statusColor:"#ffffff",navColor:"#ffffff"};function Ln(e){return e.mockupTheme==="light"?Sn:An}function Mn(e){const n=Ln(e),t=e.mockupTheme==="light"?"#e5e5ea":"#1c1c1e";return`
    <div id="mockup-card" class="mx-auto" style="width:390px; height:844px;font-family:${e.fontFamily};">
      <div class="w-full h-full overflow-hidden rounded-[2.5rem] border-8 flex flex-col" style="border-color:${t};background:${t}">
        ${Tn(n)}
        ${In(e,n)}
      ...
      <div class="flex items-center gap-1.5">
        ...
        <div class="relative flex">
          <select id="lang-select" aria-label="Language"
            ...
            <option value="de" ${ce==="de"?"selected":""}>DE</option>
            <option value="en" ${ce==="en"?"selected":""}>EN</option>
          </select>
          <span class="absolute right-2 top-1/2 -translate-y-1/2 pointer-events-none text-zinc-500">${m.chevronDown}</span>
        </div>
      </div>
    </header>
  `}function Nn(e){const n=l.getSidebarOpen(),i=Z()==="de"?"/de":"";return n?`
    <aside id="sidebar" class="w-[340px] shrink-0 h-full overflow-y-auto p-4 flex flex-col gap-4 transition-all duration-300">
      ...
      <div id="settings-panel" class="rounded-2xl border border-white/[6%] bg-[#1a1714] p-4 flex flex-col gap-4">
        <span class="text-xs font-semibold text-zinc-300 tracking-wide">${a("sidebar.settings")} · <span class="text-zinc-500 font-normal normal-case">${ye()}</span></span>
        ${$e(e)}
      </div>
  ...
  `:'<aside id="sidebar" class="w-0 shrink-0 overflow-hidden transition-all duration-300"></aside>'}function ke(){const e=l.listTemplates();return`
  ...
  `}function $e(e){const n=["whatsapp","telegram","signal","imessage"].includes(b);let t="";return b==="discord"?t=`
      ...
      <div class="flex flex-col gap-2 mt-2">
        ...
        <div id="wa-message-list" class="flex flex-col gap-2">
          ${e.messages.map((i,r)=>Be(i,r)).join("")}
        </div>
  ...
  `}const Vn=[{id:"read",title:"Read",svg:'<svg width="13" height="13" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#53bdeb" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 5.5L9.5 9L16 1" stroke="#53bdeb" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" opacity="0.7"/></svg>'},{id:"delivered",title:"Delivered",svg:'<svg width="13" height="13" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 5.5L9.5 9L16 1" stroke="#8696a0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" opacity="0.7"/></svg>'},{id:"sent",title:"Sent",svg:'<svg width="13" height="13" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>'},{id:"unread",title:"Unread",svg:'<svg width="8" height="8" viewBox="0 0 8 8" fill="#53bdeb"><circle cx="4" cy="4" r="4"/></svg>'}];function Be(e,n){const t=e.type==="sent",i=t?"bg-white text-zinc-900":"bg-white/[4%] text-zinc-500 hover:text-zinc-300",r=t?"bg-white/[4%] text-zinc-500 hover:text-zinc-300":"bg-white text-zinc-900",o=e.status||"read";return`
  ...
  `}function Fn(e){const n=l.get("_zoom")||0;return`
  ...
  `}function Dn(){const e=document.getElementById("app");if(!e)return;const n=l.getState(),t=l.getSidebarOpen();e.innerHTML=`
    ${Gn()}
