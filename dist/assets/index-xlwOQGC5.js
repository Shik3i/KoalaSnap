(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function n(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(s){if(s.ep)return;s.ep=!0;const r=n(s);fetch(s.href,r)}})();const tt="modulepreload",nt=function(e){return"/"+e},ve={},Me=function(t,n,i){let s=Promise.resolve();if(n&&n.length>0){let a=function(c){return Promise.all(c.map(u=>Promise.resolve(u).then(x=>({status:"fulfilled",value:x}),x=>({status:"rejected",reason:x}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),p=(l==null?void 0:l.nonce)||(l==null?void 0:l.getAttribute("nonce"));s=a(n.map(c=>{if(c=nt(c),c in ve)return;ve[c]=!0;const u=c.endsWith(".css"),x=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${x}`))return;const g=document.createElement("link");if(g.rel=u?"stylesheet":tt,u||(g.as="script"),g.crossOrigin="",g.href=c,p&&g.setAttribute("nonce",p),document.head.appendChild(g),u)return new Promise((h,b)=>{g.addEventListener("load",h),g.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(a){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=a,window.dispatchEvent(l),!l.defaultPrevented)throw a}return s.then(a=>{for(const l of a||[])l.status==="rejected"&&r(l.reason);return t().catch(r)})},le="koalasnap_state",N="koalasnap_templates",be="koalasnap_sidebar",q=3,we={bgGradient:"from-sky-400 to-indigo-600"},ye={1:e=>(e.bgGradient===we.bgGradient&&(e.bgGradient="from-slate-900 to-indigo-950"),e),2:e=>(e.bgGradient===we.bgGradient&&(e.bgGradient="from-slate-900 to-indigo-950"),e)};function it(e){try{const t=localStorage.getItem(le);if(t){const n=JSON.parse(t),i=n._version||1;if(i<q){for(let a=i;a<q;a++)ye[a]&&ye[a](n);n._version=q;const{avatar:s,...r}=n;localStorage.setItem(le,JSON.stringify(r))}return{...e,...n}}}catch{}return{...e}}function P(e){try{const{avatar:t,...n}=e;localStorage.setItem(le,JSON.stringify(n))}catch{}}function st(){try{const t=new URLSearchParams(window.location.search).get("state");if(!t)return null;const n=atob(t),i=Uint8Array.from(n,a=>a.charCodeAt(0)),s=new TextDecoder().decode(i),r=JSON.parse(s);if(r&&typeof r=="object")return r}catch{}return null}function at(e){const t=st(),n=t?{...e,...t}:it(e),i=new Set,s=[],r=[],a=50;let l=!1;function p(){l||(s.push(JSON.parse(JSON.stringify(n))),s.length>a&&s.shift(),r.length=0)}return{get(c){return n[c]},getState(){return{...n}},set(c,u){p(),n[c]=u,P(n),i.forEach(x=>x(c,u,n))},setAll(c){p(),Object.assign(n,c),P(n),i.forEach(u=>u(null,null,n))},mutate(c){p(),Object.assign(n,c),P(n),i.forEach(u=>u(null,null,n))},subscribe(c){return i.add(c),()=>i.delete(c)},reset(){p(),Object.assign(n,e),P(n),i.forEach(c=>c(null,null,n))},undo(){if(s.length===0)return;r.push(JSON.parse(JSON.stringify(n)));const c=s.pop();Object.assign(n,c),P(n),i.forEach(u=>u("_undo",null,n))},redo(){if(r.length===0)return;s.push(JSON.parse(JSON.stringify(n)));const c=r.pop();Object.assign(n,c),P(n),i.forEach(u=>u("_redo",null,n))},canUndo(){return s.length>0},canRedo(){return r.length>0},pauseHistory(){l=!0},resumeHistory(){l=!1},saveTemplate(c){try{const u=JSON.parse(localStorage.getItem(N)||"{}"),{avatar:x,...g}=n;return u[c]=g,localStorage.setItem(N,JSON.stringify(u)),!0}catch{return!1}},deleteTemplate(c){try{const u=JSON.parse(localStorage.getItem(N)||"{}");return delete u[c],localStorage.setItem(N,JSON.stringify(u)),!0}catch{return!1}},loadTemplate(c){try{const x=JSON.parse(localStorage.getItem(N)||"{}")[c];return x?(this.mutate(x),!0):!1}catch{return!1}},listTemplates(){try{return Object.keys(JSON.parse(localStorage.getItem(N)||"{}"))}catch{return[]}},getSidebarOpen(){return localStorage.getItem(be)!=="false"},setSidebarOpen(c){localStorage.setItem(be,String(c))},getShareUrl(){try{const{avatar:c,...u}=n,x=JSON.stringify(u),g=new TextEncoder().encode(x),h=String.fromCharCode(...g),b=btoa(h),y=new URL(window.location.href.split("?")[0].split("#")[0]);return y.searchParams.set("state",b),y.toString()}catch{return null}}}}const rt={_version:q,theme:"whatsapp",author:"Maya",handle:"@maya_99",username:"Maya",roleColor:"#e81224",timestamp:"7:18 PM",statusBarTime:"09:41",statusText:"online",imessageMode:"imessage",statusBarBattery:100,statusBarSignal:4,statusBarWifi:!0,isGroup:!1,message:"Hey, are you coming online tonight?",avatar:null,bgGradient:"from-slate-900 to-indigo-950",padding:48,mockupTheme:"light",waMode:"sent",locale:"en",fontFamily:"system-ui",chatBg:null,chatBgGradient:"",messages:[{id:1,text:"Hey, are you coming online tonight?",type:"sent",time:"7:18 PM",status:"read"},{id:2,text:"Yeah, give me 5!",type:"received",time:"7:20 PM",status:"read"},{id:3,text:"Sure, take your time 🐨",type:"sent",time:"7:21 PM",status:"delivered"}]},o=at(rt),ot=window.__LOCALE__||{};function d(e){return e.split(".").reduce((n,i)=>n!=null?n[i]:void 0,ot)??e}function de(){const e=window.location.pathname.match(/^\/([a-z]{2})\//);return e?e[1]:"en"}function f(e){return typeof e!="string"?"":e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}const K=500,lt=.8;function ct(e){return new Promise((t,n)=>{const i=new FileReader;i.onerror=()=>n(new Error("File read failed")),i.onload=s=>{const r=new Image;r.onerror=()=>n(new Error("Image decode failed")),r.onload=()=>{let{width:a,height:l}=r;if(a>K||l>K){const u=Math.min(K/a,K/l);a=Math.round(a*u),l=Math.round(l*u)}const p=document.createElement("canvas");p.width=a,p.height=l;const c=p.getContext("2d");if(!c){n(new Error("Canvas 2D not supported"));return}c.imageSmoothingEnabled=!0,c.imageSmoothingQuality="high",c.drawImage(r,0,0,a,l),p.toBlob(u=>{if(!u){n(new Error("WebP encoding failed"));return}t(URL.createObjectURL(u))},"image/webp",lt)},r.src=s.target.result},i.readAsDataURL(e)})}function dt(e){const t=document.getElementById(e);t instanceof HTMLImageElement&&(t.src="")}const Te="koalasnap_tutorial_completed",R=[{target:"app-library",key:"tutorial.step1"},{target:"settings-panel",key:"tutorial.step2"},{target:"canvas-area",key:"tutorial.step3"},{target:"bottom-bar",key:"tutorial.step4"},{target:"btn-topbar-export",key:"tutorial.step5"}];let k=0,W=!1,$=null;function pt(){return localStorage.getItem(Te)==="true"}function ut(){return W}function Le(){W&&U(),k=0,W=!0;const e=xt();e.classList.remove("hidden"),e.style.pointerEvents="auto",Z(0),document.addEventListener("keydown",Ie)}function Ie(e){e.key==="Escape"&&U()}function U(){W=!1,$&&(clearTimeout($),$=null),Q(k);const e=document.getElementById("tutorial-overlay");e&&(e.classList.add("hidden"),e.style.pointerEvents=""),localStorage.setItem(Te,"true"),document.removeEventListener("keydown",Ie)}function gt(){if(Q(k),k++,k>=R.length){U();return}Z(k)}function ft(){Q(k),k=Math.max(0,k-1),Z(k)}function ht(){W&&(Q(k),Z(k))}function xt(){let e=document.getElementById("tutorial-overlay");return e||(e=document.createElement("div"),e.id="tutorial-overlay",e.className="fixed inset-0 bg-black/60 z-40 hidden",document.body.appendChild(e)),e}function Z(e){$&&(clearTimeout($),$=null);const t=R[e];if(!t)return;const n=document.getElementById(t.target);if(!n)return;n.classList.add("tutorial-highlight"),n.style.zIndex="50",getComputedStyle(n).position==="static"&&(n.style.position="relative"),n.scrollIntoView({behavior:"smooth",block:"center"});const i=n.getBoundingClientRect();$=setTimeout(()=>{mt(e,i),$=null},400)}function Q(e){$&&(clearTimeout($),$=null);const t=R[e];if(!t)return;const n=document.getElementById(t.target);n&&(n.classList.remove("tutorial-highlight"),n.style.zIndex="",n.style.position="");const i=document.getElementById("tutorial-tooltip");i&&i.remove()}function mt(e,t){const n=document.getElementById("tutorial-tooltip");n&&n.remove();const i=R.length,s=e===0,r=e===i-1,a=document.createElement("div");a.id="tutorial-tooltip",a.className="fixed z-50 w-[320px] rounded-2xl border border-white/[10%] bg-[#1a1714]/95 backdrop-blur-2xl p-4 shadow-2xl shadow-black/50 opacity-0 transition-opacity duration-200",a.innerHTML=`
    <p class="text-sm text-zinc-200 leading-relaxed mb-4">${d(vt(e))}</p>
  ...
  `,document.body.appendChild(a),bt(a,t),requestAnimationFrame(()=>{a.classList.remove("opacity-0")}),wt(e)}function vt(e){var t;return((t=R[e])==null?void 0:t.key)||""}function bt(e,t){const s=e.offsetWidth||320,r=e.offsetHeight||160,a=window.innerWidth-s-16,l=window.innerHeight-r-16,p=t.left+t.width/2;let c=Math.max(16,Math.min(p-s/2,a)),u=t.bottom+12;u+r>window.innerHeight-16&&(u=t.top-r-12),u<16&&(u=16,c=Math.min(t.right+12,a),c=Math.max(16,c)),c=Math.max(16,Math.min(c,a)),u=Math.max(16,Math.min(u,l)),e.style.left=`${c}px`,e.style.top=`${u}px`}function wt(e){const t=document.getElementById("tut-next");t&&(t.onclick=()=>e===R.length-1?U():gt());const n=document.getElementById("tut-prev");n&&(n.onclick=()=>ft());const i=document.getElementById("tut-skip");i&&(i.onclick=()=>U())}const je="?",pe='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>',yt='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="17 1 21 5 17 9"/><path d="M3 11V9a4 4 0 0 1 4-4h14"/><polyline points="7 23 3 19 7 15"/><path d="M21 13v2a4 4 0 0 1-4 4H3"/></svg>',ue='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>',ge='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg>',kt='<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="5" r="2"/><circle cx="12" cy="12" r="2"/><circle cx="12" cy="19" r="2"/></svg>';function fe(e,t){return e?`<img id="mockup-avatar" src="${e}" class="w-full h-full rounded-full object-cover" />`:`<div id="mockup-avatar" class="w-full h-full rounded-full bg-gradient-to-br ${t?"from-zinc-600 to-zinc-800":"from-sky-400 to-indigo-500"} flex items-center justify-center text-white text-sm font-bold">${je}</div>`}function $t(e,t){const n=t?"bg-zinc-900":"bg-white",i=t?"text-zinc-100":"text-zinc-900",s=t?"text-zinc-400":"text-zinc-500",r=t?"text-zinc-300":"text-zinc-800",a=t?"border-zinc-700":"border-zinc-200";return`
    <div id="mockup-card" class="${n} rounded-2xl shadow-2xl shadow-black/20 mx-auto overflow-hidden ring-1 ring-white/[6%] p-3" style="width:400px; height:520px;font-family:${e.fontFamily};">
      ...
      <div class="flex items-center justify-between mt-2 pt-2 ${a} border-t text-sm ${s}">
        <div class="flex items-center gap-5">
          <span class="flex items-center gap-1">${ue} <span id="mockup-replies">1</span></span>
          <span class="flex items-center gap-1">${yt} <span id="mockup-retweets">3</span></span>
          <span class="flex items-center gap-1">${pe} <span id="mockup-likes">12</span></span>
        </div>
        <span>${ge}</span>
      </div>
    </div>
  `}function Bt(e,t){const n=t?"bg-black":"bg-white",i=t?"text-white":"text-zinc-900",s=t?"text-zinc-400":"text-zinc-500";return`
  ...
  `}function zt(e,t){const n=t?"#1a1a2e":"#f0f2f5",i=t?"#1c1c2e":"#007aff";return`
  ...
  `}function Ct(e,t){const n="text-white";return`
    <div id="mockup-card" class="mx-auto" style="width:390px; height:844px;font-family:${e.fontFamily};">
            ...
            <div class="flex items-start gap-3">
              ...
              <div class="flex flex-col items-center gap-3 shrink-0">
                ...
                <div class="flex flex-col items-center gap-4 text-white text-xs">
                  <div class="flex flex-col items-center gap-0.5">${pe}<span id="mockup-likes" class="text-[10px]">12.4k</span></div>
                  <div class="flex flex-col items-center gap-0.5">${ue}<span id="mockup-replies" class="text-[10px]">241</span></div>
                  <div class="flex flex-col items-center gap-0.5">${ge}<span class="text-[10px]">Share</span></div>
                </div>
              </div>
            </div>
          </div>
  ...
  `}function V(e){const t=e.mockupTheme==="dark";switch(e.theme||"twitter"){case"instagram":return Bt(e,t);case"messenger":return zt(e,t);case"tiktok":return Ct(e,t);case"twitter":default:return $t(e,t)}}function D(e){const t=e.theme||"twitter";A("mockup-author",n=>{n&&(n.textContent=e.author)}),A("mockup-message",n=>{n&&(n.textContent=e.message)}),A("mockup-likes",n=>{n&&(n.textContent="142")}),A("mockup-replies",n=>{n&&(n.textContent="1")}),A("mockup-retweets",n=>{n&&(n.textContent="3")}),t==="messenger"?A("mockup-avatar",n=>{n&&ke(n,e,!1)}):A("mockup-avatar",n=>{n&&ke(n,e,e.mockupTheme==="dark")})}function ke(e,t,n){if(t.avatar){const i=document.createElement("img");i.id="mockup-avatar",i.src=t.avatar,i.className="w-full h-full rounded-full object-cover",i.alt="",e.replaceWith(i)}else{const i=document.createElement("div");i.id="mockup-avatar";const s=n?"from-zinc-600 to-zinc-800":"from-sky-400 to-indigo-500";i.className=`w-full h-full rounded-full bg-gradient-to-br ${s} flex items-center justify-center text-white text-sm font-bold`,i.textContent=je,e.replaceWith(i)}}function A(e,t){const n=document.getElementById(e);n&&t(n)}const Et='<svg width="20" height="20" viewBox="0 0 24 24" fill="#949ba4"><path d="M5 9h14M5 15h14M11 3L9 21M15 3l-2 18"/></svg>',St='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#949ba4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2z"/></svg>',Mt='<svg width="16" height="16" viewBox="0 0 24 24" fill="#949ba4"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>',Tt='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#b5bac1" stroke-width="2" stroke-linecap="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>',Lt='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#b5bac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 12 20 22 4 22 4 12"/><rect x="2" y="7" width="20" height="5"/><line x1="12" y1="22" x2="12" y2="7"/><path d="M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7z"/><path d="M12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7z"/></svg>',It=`url("data:image/svg+xml,%3Csvg width='200' height='200' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='30' cy='30' r='2' fill='white' opacity='0.02'/%3E%3Ccircle cx='100' cy='60' r='1.5' fill='white' opacity='0.015'/%3E%3Ccircle cx='170' cy='30' r='1' fill='white' opacity='0.02'/%3E%3Ccircle cx='50' cy='120' r='1.5' fill='white' opacity='0.015'/%3E%3Ccircle cx='150' cy='150' r='2' fill='white' opacity='0.02'/%3E%3C/svg%3E")`,jt={sidebarBg:"#2b2d31",chatBg:"#313338",inputBg:"#383a40",inputText:"#dbdee1",placeholder:"#949ba4",divider:"#3f4147",dotPattern:"none"},_t={sidebarBg:"#1e1f22",chatBg:"#313338",inputBg:"#383a40",inputText:"#dbdee1",placeholder:"#949ba4",divider:"#3f4147",dotPattern:It};function At(e){return e.mockupTheme==="light"?jt:_t}function Ht(e){const t=At(e),n=e.avatar?`<img id="discord-avatar" src="${e.avatar}" class="w-10 h-10 rounded-full object-cover" />`:'<div id="discord-avatar" class="w-10 h-10 rounded-full bg-[#5865F2] flex items-center justify-center text-white text-xs font-bold">?</div>';return`
    <div id="mockup-card" class="mx-auto" style="width:390px; height:844px;font-family:${e.fontFamily};">
  ...
  `}function Ot(e){te("discord-username",n=>{n.textContent=e.username,n.style.color=e.roleColor}),te("discord-timestamp",n=>{n.textContent=e.timestamp}),te("discord-message",n=>{n.textContent=e.message});const t=document.getElementById("discord-avatar");if(t)if(e.avatar){const n=document.createElement("img");n.id="discord-avatar",n.src=e.avatar,n.className="w-10 h-10 rounded-full object-cover",n.alt="",t.replaceWith(n)}else{const n=document.createElement("div");n.id="discord-avatar",n.className="w-10 h-10 rounded-full bg-[#5865F2] flex items-center justify-center text-white text-xs font-bold",n.textContent="?",t.replaceWith(n)}}function te(e,t){const n=document.getElementById(e);n&&t(n)}const Nt='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#e9edef" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>',Pt='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/></svg>',Gt='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',Rt='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><path d="M9 11.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm-3.3-3.3a4.5 4.5 0 0 1 6.6 0l-1.1 1.1a3 3 0 0 0-4.4 0L5.7 8.2zM2.9 5.1a8 8 0 0 1 12.2 0l-1.1 1.1a6.5 6.5 0 0 0-10 0L2.9 5.1z" fill="currentColor"/></svg>',Ft='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8696a0" stroke-width="2.5" stroke-linecap="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>',Vt='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/></svg>',Dt='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/><line x1="8" y1="23" x2="16" y2="23"/></svg>',Wt='<svg width="14" height="14" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#53bdeb" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 5.5L9.5 9L16 1" stroke="#53bdeb" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" opacity="0.7"/></svg>',Ut='<svg width="14" height="14" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 5.5L9.5 9L16 1" stroke="#8696a0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" opacity="0.7"/></svg>',Kt='<svg width="14" height="14" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',qt='<svg width="8" height="8" viewBox="0 0 8 8" fill="#53bdeb"><circle cx="4" cy="4" r="4"/></svg>',Jt={barBg:"#008069",chatBg:"#efeae2",sentBg:"#d9fdd3",recvBg:"#ffffff",sentText:"#111b21",recvText:"#111b21",timeText:"#667781",inputBg:"#f0f2f5",fieldBg:"#ffffff",fieldText:"#111b21",placeholder:"#8696a0"},Yt={barBg:"#202c33",chatBg:"#0b141a",sentBg:"#005c4b",recvBg:"#202c33",sentText:"#e9edef",recvText:"#e9edef",timeText:"#ffffff8c",inputBg:"#202c33",fieldBg:"#2a3942",fieldText:"#e9edef",placeholder:"#8696a0"};function J(e){return e.mockupTheme==="light"?Jt:Yt}function Xt(e){return`<svg width="24" height="12" viewBox="0 0 26 12" fill="none" class="opacity-90"><rect x="0.5" y="0.5" width="22" height="11" rx="2" stroke="currentColor" fill="none"/><rect x="2" y="2" width="${Math.max(1,Math.min(19.5,e/100*19.5))}" height="8" rx="1.5" fill="currentColor"/><rect x="24" y="3.5" width="2" height="5" rx="0.75" fill="currentColor"/></svg>`}function Zt(e){const t=e>=1?"1":"0.3",n=e>=2?"1":"0.3",i=e>=3?"1":"0.3",s=e>=4?"1":"0.3";return`<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><rect x="1" y="8" width="2" height="3" rx="0.4" fill="currentColor" opacity="${t}"/><rect x="5" y="5" width="2" height="6" rx="0.4" fill="currentColor" opacity="${n}"/><rect x="9" y="2.5" width="2" height="8.5" rx="0.4" fill="currentColor" opacity="${i}"/><rect x="13" y="0.5" width="2" height="10.5" rx="0.4" fill="currentColor" opacity="${s}"/></svg>`}function Qt(e){const t=J(e),n=e.mockupTheme==="light"?"#ffffff":"#121212";return`
    <div id="mockup-card" class="mx-auto" style="width:390px; height:844px;font-family:${e.fontFamily};">
  ...
  `}function _e(e,t){const n=e.statusBarWifi!==!1?`<span class="text-[11px]">${Rt}</span>`:"",i=Zt(e.statusBarSignal||4),s=Xt(e.statusBarBattery!==void 0?e.statusBarBattery:100);return`
  ...
  `}function tn(e,t){const n=e.chatBg?`url(${e.chatBg})`:e.mockupTheme==="light"?"url(/whatsapp-bg-light.png)":"url(/whatsapp-bg-dark.png)",i=e.chatBg?"cover":"360px",s=e.chatBg?"no-repeat":"repeat";return`
  ...
  `:"";(_=e.reactions)!=null&&_[0]&&(h+=" pb-[11px]");const T=e.image?`<img src="${e.image}" class="w-full max-w-[280px] rounded-lg mb-1 object-cover shadow-[inset_0_0_1px_rgba(0,0,0,0.15)]" style="max-height: 200px" />`:"";let B="";s&&(u==="read"?B=Wt:u==="delivered"?B=Ut:u==="sent"&&(B=Kt));const O=u==="unread",L=O?"font-semibold":"",C=O?`<span class="inline-flex ml-1 -mb-0.5">${qt}</span>`:"";return`
  ...
  `}function sn(e){const t=J(e),n=document.getElementById("wa-statusbar");n&&(n.outerHTML=_e(e,t)),ne("wa-contact-name",a=>{a.textContent=e.username}),ne("wa-status-text",a=>{a.textContent=e.statusText||"online"}),ne("wa-statusbar-time",a=>{a.textContent=e.statusBarTime||"09:41"});const i=document.getElementById("wa-avatar");if(i)if(e.avatar){const a=document.createElement("img");a.id="wa-avatar",a.src=e.avatar,a.className="w-full h-full rounded-full object-cover",a.alt="",i.replaceWith(a)}else{const a=document.createElement("div");a.id="wa-avatar",a.className="w-full h-full rounded-full bg-[#2c2c2c] flex items-center justify-center",a.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="#8696a0"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>',i.replaceWith(a)}const s=document.getElementById("wa-messages");if(s){const a=J(e);s.innerHTML=e.messages.map((l,p)=>Ae(l,p,e,a)).join("")}const r=document.getElementById("wa-chat-container");if(r){const a=J(e),l=e.chatBg?`url(${e.chatBg})`:e.mockupTheme==="light"?"url(/whatsapp-bg-light.png)":"url(/whatsapp-bg-dark.png)",p=e.chatBg?"cover":"360px",c=e.chatBg?"no-repeat":"repeat";r.style.background=`var(--chat-bg, ${a.chatBg})`,r.style.backgroundImage=l,r.style.backgroundSize=p,r.style.backgroundRepeat=c}}function ne(e,t){const n=document.getElementById(e);n&&t(n)}const an='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#e9edef" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>',rn='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#e9edef" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>',on='<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/></svg>',ln='<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.44 11.05l-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48"/></svg>',cn='<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/><line x1="8" y1="23" x2="16" y2="23"/></svg>',dn='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><path d="M9 11.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm-3.3-3.3a4.5 4.5 0 0 1 6.6 0l-1.1 1.1a3 3 0 0 0-4.4 0L5.7 8.2zM2.9 5.1a8 8 0 0 1 12.2 0l-1.1 1.1a6.5 6.5 0 0 0-10 0L2.9 5.1z" fill="currentColor"/></svg>',pn='<svg width="14" height="14" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#ffffffd0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 5.5L9.5 9L16 1" stroke="#ffffffd0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" opacity="0.75"/></svg>',un='<svg width="14" height="14" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#ffffffd0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',gn=`url("data:image/svg+xml,%3Csvg width='200' height='200' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='30' cy='30' r='2' fill='white' opacity='0.04'/%3E%3Ccircle cx='100' cy='60' r='1.5' fill='white' opacity='0.03'/%3E%3Ccircle cx='170' cy='30' r='1' fill='white' opacity='0.04'/%3E%3Ccircle cx='50' cy='120' r='1.5' fill='white' opacity='0.03'/%3E%3Ccircle cx='150' cy='150' r='2' fill='white' opacity='0.04'/%3E%3Ccircle cx='80' cy='180' r='1' fill='white' opacity='0.03'/%3E%3Ccircle cx='20' cy='170' r='1.5' fill='white' opacity='0.03'/%3E%3C/svg%3E")`,fn=`url("data:image/svg+xml,%3Csvg width='200' height='200' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='30' cy='30' r='2' fill='black' opacity='0.04'/%3E%3Ccircle cx='100' cy='60' r='1.5' fill='black' opacity='0.03'/%3E%3Ccircle cx='170' cy='30' r='1' fill='black' opacity='0.04'/%3E%3Ccircle cx='50' cy='120' r='1.5' fill='black' opacity='0.03'/%3E%3Ccircle cx='150' cy='150' r='2' fill='black' opacity='0.04'/%3E%3Ccircle cx='80' cy='180' r='1' fill='black' opacity='0.03'/%3E%3Ccircle cx='20' cy='170' r='1.5' fill='black' opacity='0.03'/%3E%3C/svg%3E")`,hn={barBg:"#4e8ad4",chatBg:"#eef2f6",sentBg:"#8774e1",recvBg:"#ffffff",sentText:"#ffffff",recvText:"#000000",timeText:"#00000080",sentTimeText:"#ffffffb3",inputBg:"#ffffff",fieldBg:"#eef2f6",dotPattern:fn},xn={barBg:"#2f6ea5",chatBg:"#0f0f0f",sentBg:"#8774e1",recvBg:"#181818",sentText:"#ffffff",recvText:"#ffffff",timeText:"#ffffff8c",sentTimeText:"#ffffffb3",inputBg:"#1c1c1e",fieldBg:"#2a2a2e",dotPattern:gn};function Y(e){return e.mockupTheme==="light"?hn:xn}function mn(e){return`<svg width="24" height="12" viewBox="0 0 26 12" fill="none" class="opacity-90"><rect x="0.5" y="0.5" width="22" height="11" rx="2" stroke="currentColor" fill="none"/><rect x="2" y="2" width="${Math.max(1,Math.min(19.5,e/100*19.5))}" height="8" rx="1.5" fill="currentColor"/><rect x="24" y="3.5" width="2" height="5" rx="0.75" fill="currentColor"/></svg>`}function vn(e){const t=e>=1?"1":"0.3",n=e>=2?"1":"0.3",i=e>=3?"1":"0.3",s=e>=4?"1":"0.3";return`<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><rect x="1" y="8" width="2" height="3" rx="0.4" fill="currentColor" opacity="${t}"/><rect x="5" y="5" width="2" height="6" rx="0.4" fill="currentColor" opacity="${n}"/><rect x="9" y="2.5" width="2" height="8.5" rx="0.4" fill="currentColor" opacity="${i}"/><rect x="13" y="0.5" width="2" height="10.5" rx="0.4" fill="currentColor" opacity="${s}"/></svg>`}function bn(e){const t=Y(e),n=e.mockupTheme==="light"?"#ffffff":"#121212";return`
    <div id="mockup-card" class="mx-auto" style="width:390px; height:844px;font-family:${e.fontFamily};">
      <div class="w-full h-full overflow-hidden rounded-[2.5rem] border-8 flex flex-col" style="border-color:${n};background:${n}">
        ${He(e,t)}
        ${wn(e,t)}
  ...
  `}function He(e,t){const n=e.statusBarWifi!==!1?`<span class="text-[11px]">${dn}</span>`:"",i=vn(e.statusBarSignal||4),s=mn(e.statusBarBattery!==void 0?e.statusBarBattery:100);return`
  ...
  `}function Oe(e,t,n,i){var I,_;const s=e.type==="sent",r=t<n.messages.length-1?n.messages[t+1]:null,a=t>0?n.messages[t-1]:null,l=!a||a.type!==e.type,p=!r||r.type!==e.type,c=s?i.sentBg:i.recvBg,u=s?i.sentText:i.recvText,x=s?i.sentTimeText:i.timeText,g=s?"justify-end":"justify-start",h=e.status||"read";let b="",y="rounded-[12px]",z="px-3.5 py-1.5",j=l?"mt-2.5":"mt-[2px]";const S=["#2cb3c9","#57d363","#ffa500","#f44336","#9c27b0","#4caf50"],M=(e.senderName||"").split("").reduce((F,ee)=>F+ee.charCodeAt(0),0)%S.length,T=S[M],B=n.isGroup&&!s&&l&&e.senderName?`
  ...
  `:"";(_=e.reactions)!=null&&_[0]&&(z+=" pb-[10px]");const L=e.image?`<img src="${e.image}" class="w-full max-w-[280px] rounded-lg mb-1 object-cover shadow-[inset_0_0_1px_rgba(0,0,0,0.15)]" style="max-height: 200px" />`:"";let C="";return s&&(h==="read"||h==="delivered"?C=pn:h==="sent"&&(C=un)),`
  ...
  `}function $n(e){const t=Y(e),n=document.getElementById("tg-statusbar");n&&(n.outerHTML=He(e,t)),ie("tg-contact-name",a=>{a.textContent=e.username}),ie("tg-status-text",a=>{a.textContent=e.statusText||"online"}),ie("tg-statusbar-time",a=>{a.textContent=e.statusBarTime||"09:41"});const i=document.getElementById("tg-avatar");if(i)if(e.avatar){const a=document.createElement("img");a.id="tg-avatar",a.src=e.avatar,a.className="w-full h-full rounded-full object-cover",a.alt="",i.replaceWith(a)}else{const a=document.createElement("div");a.id="tg-avatar",a.className="w-full h-full rounded-full bg-[#527da3] flex items-center justify-center",a.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="#e9edef"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>',i.replaceWith(a)}const s=document.getElementById("tg-messages");if(s){const a=Y(e);s.innerHTML=e.messages.map((l,p)=>Oe(l,p,e,a)).join("")}const r=document.getElementById("tg-chat-container");if(r){const a=Y(e);r.style.background=`var(--chat-bg, ${a.chatBg})`,e.chatBg?(r.style.backgroundImage=`url(${e.chatBg})`,r.style.backgroundSize="cover"):(r.style.backgroundImage=a.dotPattern,r.style.backgroundSize="")}}function ie(e,t){const n=document.getElementById(e);n&&t(n)}const Bn='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#e9edef" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>',zn='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/></svg>',Cn='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',En='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><path d="M9 11.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm-3.3-3.3a4.5 4.5 0 0 1 6.6 0l-1.1 1.1a3 3 0 0 0-4.4 0L5.7 8.2zM2.9 5.1a8 8 0 0 1 12.2 0l-1.1 1.1a6.5 6.5 0 0 0-10 0L2.9 5.1z" fill="currentColor"/></svg>',Sn='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/></svg>',Mn='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.44 11.05l-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48"/></svg>',Tn='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/><line x1="8" y1="23" x2="16" y2="23"/></svg>',Ln='<svg width="14" height="14" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#ffffffd0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 5.5L9.5 9L16 1" stroke="#ffffffd0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" opacity="0.75"/></svg>',In='<svg width="14" height="14" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#ffffffb3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',jn={barBg:"#3b82f6",chatBg:"#f0f2f5",sentBg:"#3b82f6",recvBg:"#ffffff",sentText:"#ffffff",recvText:"#111b21",timeText:"#00000080",sentTimeText:"#ffffffb3",inputBg:"#f0f2f5",fieldBg:"#ffffff",fieldText:"#111b21",placeholder:"#8696a0"},_n={barBg:"#1e1f22",chatBg:"#101214",sentBg:"#3b82f6",recvBg:"#2b2d30",sentText:"#ffffff",recvText:"#e9edef",timeText:"#ffffff8c",sentTimeText:"#ffffffb3",inputBg:"#1e1f22",fieldBg:"#2b2d30",fieldText:"#e9edef",placeholder:"#8696a0"};function Ne(e){return e.mockupTheme==="light"?jn:_n}function An(e){return`<svg width="24" height="12" viewBox="0 0 26 12" fill="none" class="opacity-90"><rect x="0.5" y="0.5" width="22" height="11" rx="2" stroke="currentColor" fill="none"/><rect x="2" y="2" width="${Math.max(1,Math.min(19.5,e/100*19.5))}" height="8" rx="1.5" fill="currentColor"/><rect x="24" y="3.5" width="2" height="5" rx="0.75" fill="currentColor"/></svg>`}function Hn(e){const t=e>=1?"1":"0.3",n=e>=2?"1":"0.3",i=e>=3?"1":"0.3",s=e>=4?"1":"0.3";return`<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><rect x="1" y="8" width="2" height="3" rx="0.4" fill="currentColor" opacity="${t}"/><rect x="5" y="5" width="2" height="6" rx="0.4" fill="currentColor" opacity="${n}"/><rect x="9" y="2.5" width="2" height="8.5" rx="0.4" fill="currentColor" opacity="${i}"/><rect x="13" y="0.5" width="2" height="10.5" rx="0.4" fill="currentColor" opacity="${s}"/></svg>`}function On(e){const t=Ne(e),n=e.mockupTheme==="light"?"#ffffff":"#121212";return`
    <div id="mockup-card" class="mx-auto" style="width:390px; height:844px;font-family:${e.fontFamily};">
      <div class="w-full h-full overflow-hidden rounded-[2.5rem] border-8 flex flex-col" style="border-color:${n};background:${n}">
        ${Pe(e,t)}
        ${Nn(e,t)}
  ...
  `}function Pe(e,t){const n=e.statusBarWifi!==!1?`<span class="text-[11px]">${En}</span>`:"",i=Hn(e.statusBarSignal||4),s=An(e.statusBarBattery!==void 0?e.statusBarBattery:100);return`
  ...
  `:"";let B="px-3.5 py-1.5";(I=e.reactions)!=null&&I[0]&&(B="px-3.5 pt-1.5 pb-[10px]");const O=e.image?`<img src="${e.image}" class="w-full max-w-[280px] rounded-lg mb-1 object-cover shadow-[inset_0_0_1px_rgba(0,0,0,0.15)]" style="max-height: 200px" />`:"";let L="";return s&&(h==="read"||h==="delivered"?L=Ln:h==="sent"&&(L=In)),`
  ...
  `}function Rn(e){const t=Ne(e),n=document.getElementById("sg-statusbar");n&&(n.outerHTML=Pe(e,t)),$e("sg-contact-name",a=>{a.textContent=e.username}),$e("sg-status-text",a=>{a.textContent=e.statusText||"online"});const i=document.getElementById("sg-avatar");if(i)if(e.avatar){const a=document.createElement("img");a.id="sg-avatar",a.src=e.avatar,a.className="w-full h-full rounded-full object-cover",a.alt="",i.replaceWith(a)}else{const a=document.createElement("div");a.id="sg-avatar",a.className="w-full h-full rounded-full bg-[#2c2c2c] flex items-center justify-center",a.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="#8696a0"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>',i.replaceWith(a)}const s=document.getElementById("sg-messages");s&&(s.innerHTML=e.messages.map((a,l)=>Ge(a,l,e,t)).join(""));const r=document.getElementById("sg-chat-container");r&&(r.style.background=`var(--chat-bg, ${t.chatBg})`,e.chatBg?(r.style.backgroundImage=`url(${e.chatBg})`,r.style.backgroundSize="cover"):r.style.backgroundImage="")}function $e(e,t){const n=document.getElementById(e);n&&t(n)}const Fn='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>',Vn='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>',Dn='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><path d="M9 11.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm-3.3-3.3a4.5 4.5 0 0 1 6.6 0l-1.1 1.1a3 3 0 0 0-4.4 0L5.7 8.2zM2.9 5.1a8 8 0 0 1 12.2 0l-1.1 1.1a6.5 6.5 0 0 0-10 0L2.9 5.1z" fill="currentColor"/></svg>',Wn={barBg:"#f8f8f8",chatBg:"#ffffff",sentBg:"#007aff",recvBg:"#e5e5ea",sentText:"#ffffff",recvText:"#000000",timeText:"#8e8e93",inputBg:"#f8f8f8",fieldBg:"#e5e5ea",fieldText:"#000000",statusColor:"#000000",navColor:"#007aff"},Un={barBg:"#1c1c1e",chatBg:"#000000",sentBg:"#0a84ff",recvBg:"#262629",sentText:"#ffffff",recvText:"#ffffff",timeText:"#8e8e93",inputBg:"#1c1c1e",fieldBg:"#2c2c2e",fieldText:"#ffffff",statusColor:"#ffffff",navColor:"#ffffff"};function Re(e){const t=e.imessageMode==="sms",n=e.mockupTheme==="light"?{...Wn}:{...Un};return t&&(n.sentBg=e.mockupTheme==="light"?"#34c759":"#30d158",n.navColor=e.mockupTheme==="light"?"#34c759":"#ffffff"),n}function Kn(e){return`<svg width="24" height="12" viewBox="0 0 26 12" fill="none" class="opacity-90"><rect x="0.5" y="0.5" width="22" height="11" rx="2" stroke="currentColor" fill="none"/><rect x="2" y="2" width="${Math.max(1,Math.min(19.5,e/100*19.5))}" height="8" rx="1.5" fill="currentColor"/><rect x="24" y="3.5" width="2" height="5" rx="0.75" fill="currentColor"/></svg>`}function qn(e){const t=e>=1?"1":"0.3",n=e>=2?"1":"0.3",i=e>=3?"1":"0.3",s=e>=4?"1":"0.3";return`<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><rect x="1" y="8" width="2" height="3" rx="0.4" fill="currentColor" opacity="${t}"/><rect x="5" y="5" width="2" height="6" rx="0.4" fill="currentColor" opacity="${n}"/><rect x="9" y="2.5" width="2" height="8.5" rx="0.4" fill="currentColor" opacity="${i}"/><rect x="13" y="0.5" width="2" height="10.5" rx="0.4" fill="currentColor" opacity="${s}"/></svg>`}function Jn(e){const t=Re(e),n=e.mockupTheme==="light"?"#e5e5ea":"#1c1c1e";return`
    <div id="mockup-card" class="mx-auto" style="width:390px; height:844px;font-family:${e.fontFamily};">
      <div class="w-full h-full overflow-hidden rounded-[2.5rem] border-8 flex flex-col" style="border-color:${n};background:${n}">
        ${Fe(e,t)}
        ${Ve(e,t)}
  ...
  `}function Fe(e,t){const n=e.statusBarWifi!==!1?`<span class="text-[11px]">${Dn}</span>`:"",i=qn(e.statusBarSignal||4),s=Kn(e.statusBarBattery!==void 0?e.statusBarBattery:100);return`
  ...
  `}function Ve(e,t){return`
    <div id="im-navbar" class="flex items-center gap-1 px-2 py-1.5 shrink-0 border-b border-black/[5%] relative z-10" style="background:${t.barBg};color:${t.navColor}">
      <span class="shrink-0 px-1">${Fn}</span>
      ...
      <div class="flex items-center gap-2 shrink-0 px-1">
        <span style="color:${t.navColor}">${Vn}</span>
      </div>
    </div>
  `}function Yn(e,t){return`
  ...
  `}function We(e,t){const n=e.imessageMode==="sms"?"Text Message":"iMessage";return`
      ...
      <div class="flex items-center gap-1.5">
        ...
        <div class="relative flex" id="lang-switcher">
          <button id="lang-btn"
            ...
            <span class="w-4 h-3 shrink-0 rounded-[2px] overflow-hidden">${Ce(ze)}</span>
            <span class="text-[10px] font-semibold leading-none">${ze.toUpperCase()}</span>
          ...
          <div id="lang-dropdown" class="hidden absolute right-0 top-full mt-1.5 z-50 min-w-[130px] rounded-xl border border-white/10 bg-[#1a1714]/95 backdrop-blur-2xl py-1 shadow-2xl shadow-black/50">
            ${["de","en","es"].map(t=>`
              <button data-lang="${t}"
                ...
                <span class="w-5 h-4 shrink-0 rounded-[2px] overflow-hidden">${Ce(t)}</span>
                ${ti[t]}
              </button>
            `).join("")}
          </div>
  ...
  `}function ii(e){const t=o.getSidebarOpen(),i=de()==="de"?"/de":"";return`
    <aside id="sidebar" class="w-[340px] shrink-0 h-full overflow-y-auto p-4 flex flex-col gap-4 transition-all duration-300 bg-[#0d0a07] fixed left-0 top-14 bottom-0 z-40 border-r border-white/[6%]
      ...
      <div id="app-library" class="rounded-2xl border border-white/[6%] bg-[#1a1714] p-4 flex flex-col gap-3">
        <div class="flex items-center justify-between cursor-pointer select-none" id="app-library-toggle">
          ...
          <div class="flex items-center gap-2">
            <span class="text-[10px] text-zinc-600">${X.length} ${d("sidebar.apps")}</span>
        ...
        <div id="app-library-body">
          ...
          <div class="flex flex-col gap-1.5">
            ${X.map(s=>{const r=s.theme===w;return`
      ...
      <div id="settings-panel" class="rounded-2xl border border-white/[6%] bg-[#1a1714] p-4 flex flex-col gap-4">
        <span class="text-xs font-semibold text-zinc-300 tracking-wide">${d("sidebar.settings")} · <span class="text-zinc-500 font-normal normal-case">${Ke()}</span></span>
        ${Je(e)}
      </div>
  ...
  `}function qe(){const e=o.listTemplates();return`
  ...
  `}function Je(e){const t=["whatsapp","telegram","signal","imessage"].includes(w);let n="";return w==="discord"?n=`
      ...
      <div class="flex flex-col gap-2 mt-4">
        ...
        <div id="wa-message-list" class="flex flex-col gap-2">
          ${e.messages.map((i,s)=>Ye(i,s)).join("")}
        </div>
      ...
      <div class="flex flex-wrap gap-1.5">
        ${Be.map(t=>`
          <button data-chat-bg="${t.value}" aria-label="${t.label}"
            ...
            style="background:${t.value||Be[1].value}"></button>
        `).join("")}
      </div>
    </label>
    <label class="flex flex-col gap-1.5 mt-4">
  ...
  `}function ri(e){const t=o.get("_zoom")||0;return`
  ...
  `}function he(){const e=document.getElementById("app");if(!e)return;const t=o.getState(),n=o.getSidebarOpen();e.innerHTML=`
    ${ni()}
