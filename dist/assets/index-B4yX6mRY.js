(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function n(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(a){if(a.ep)return;a.ep=!0;const r=n(a);fetch(a.href,r)}})();const J="modulepreload",Q=function(e){return"/"+e},M={},Z=function(t,n,i){let a=Promise.resolve();if(n&&n.length>0){let o=function(c){return Promise.all(c.map(p=>Promise.resolve(p).then(b=>({status:"fulfilled",value:b}),b=>({status:"rejected",reason:b}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),m=(l==null?void 0:l.nonce)||(l==null?void 0:l.getAttribute("nonce"));a=o(n.map(c=>{if(c=Q(c),c in M)return;M[c]=!0;const p=c.endsWith(".css"),b=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${b}`))return;const v=document.createElement("link");if(v.rel=p?"stylesheet":J,p||(v.as="script"),v.crossOrigin="",v.href=c,m&&v.setAttribute("nonce",m),document.head.appendChild(v),p)return new Promise((Y,X)=>{v.addEventListener("load",Y),v.addEventListener("error",()=>X(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(o){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=o,window.dispatchEvent(l),!l.defaultPrevented)throw o}return a.then(o=>{for(const l of o||[])l.status==="rejected"&&r(l.reason);return t().catch(r)})},ee="/assets/avatar-fallback-CwXzhE11.svg",P="koalasnap_state";function te(e){try{const t=localStorage.getItem(P);if(t)return{...e,...JSON.parse(t)}}catch{}return{...e}}function $(e){try{const{avatar:t,...n}=e;localStorage.setItem(P,JSON.stringify(n))}catch{}}function ne(e){const t=te(e),n=new Set;return{get(i){return t[i]},getState(){return{...t}},set(i,a){t[i]=a,$(t),n.forEach(r=>r(i,a,t))},setAll(i){Object.assign(t,i),$(t),n.forEach(a=>a(null,null,t))},mutate(i){Object.assign(t,i),$(t)},subscribe(i){return n.add(i),()=>n.delete(i)},reset(){Object.assign(t,e),$(t),n.forEach(i=>i(null,null,t))}}}const ie={theme:"whatsapp",author:"Maya",handle:"@maya_99",username:"Maya",roleColor:"#e81224",timestamp:"7:18 PM",message:"Hey! Das sieht richtig gut aus! 🔥",avatar:ee,bgGradient:"from-sky-400 to-indigo-600",padding:48,mockupTheme:"light",activeFilter:"all",waMode:"sent",messages:[{id:1,text:"Hey, kommst du heute Abend online?",type:"sent",time:"19:18",status:"read"},{id:2,text:"Ja, bin in 5 Minuten da!",type:"received",time:"19:20",status:"read"},{id:3,text:"Lass uns raiden gehen 🎮",type:"sent",time:"19:22",status:"delivered"}]},d=ne(ie),ae=window.__LOCALE__||{};function s(e){return e.split(".").reduce((n,i)=>n!=null?n[i]:void 0,ae)??e}function se(){const e=window.location.pathname;return e.startsWith("/de/")||e==="/de"?"de":"en"}const E=500,re=.8;function oe(e){return new Promise((t,n)=>{const i=new FileReader;i.onerror=()=>n(new Error("File read failed")),i.onload=a=>{const r=new Image;r.onerror=()=>n(new Error("Image decode failed")),r.onload=()=>{let{width:o,height:l}=r;if(o>E||l>E){const p=Math.min(E/o,E/l);o=Math.round(o*p),l=Math.round(l*p)}const m=document.createElement("canvas");m.width=o,m.height=l;const c=m.getContext("2d");if(!c){n(new Error("Canvas 2D not supported"));return}c.imageSmoothingEnabled=!0,c.imageSmoothingQuality="high",c.drawImage(r,0,0,o,l),m.toBlob(p=>{if(!p){n(new Error("WebP encoding failed"));return}t(URL.createObjectURL(p))},"image/webp",re)},r.src=a.target.result},i.readAsDataURL(e)})}function le(e){const t=document.getElementById(e);t instanceof HTMLImageElement&&(t.src="")}const D="koalasnap_tutorial_completed",w=[{target:"app-library",key:"tutorial.step1"},{target:"settings-panel",key:"tutorial.step2"},{target:"canvas-area",key:"tutorial.step3"},{target:"bottom-bar",key:"tutorial.step4"},{target:"btn-topbar-export",key:"tutorial.step5"}];let x=0,y=!1,h=null;function de(){return localStorage.getItem(D)==="true"}function ce(){return y}function H(){y&&k(),x=0,y=!0;const e=ge();e.classList.remove("hidden"),e.style.pointerEvents="auto",B(0),document.addEventListener("keydown",O)}function O(e){e.key==="Escape"&&k()}function k(){y=!1,h&&(clearTimeout(h),h=null),C(x);const e=document.getElementById("tutorial-overlay");e&&(e.classList.add("hidden"),e.style.pointerEvents=""),localStorage.setItem(D,"true"),document.removeEventListener("keydown",O)}function pe(){if(C(x),x++,x>=w.length){k();return}B(x)}function ue(){C(x),x=Math.max(0,x-1),B(x)}function me(){y&&(C(x),B(x))}function ge(){let e=document.getElementById("tutorial-overlay");return e||(e=document.createElement("div"),e.id="tutorial-overlay",e.className="fixed inset-0 bg-black/60 z-40 hidden",document.body.appendChild(e)),e}function B(e){h&&(clearTimeout(h),h=null);const t=w[e];if(!t)return;const n=document.getElementById(t.target);if(!n)return;n.classList.add("tutorial-highlight"),n.style.zIndex="50",getComputedStyle(n).position==="static"&&(n.style.position="relative"),n.scrollIntoView({behavior:"smooth",block:"center"});const i=n.getBoundingClientRect();h=setTimeout(()=>{fe(e,i),h=null},400)}function C(e){h&&(clearTimeout(h),h=null);const t=w[e];if(!t)return;const n=document.getElementById(t.target);n&&(n.classList.remove("tutorial-highlight"),n.style.zIndex="",n.style.position="");const i=document.getElementById("tutorial-tooltip");i&&i.remove()}function fe(e,t){const n=document.getElementById("tutorial-tooltip");n&&n.remove();const i=w.length,a=e===0,r=e===i-1,o=document.createElement("div");o.id="tutorial-tooltip",o.className="fixed z-50 w-[320px] rounded-2xl border border-white/[10%] bg-[#1a1714]/95 backdrop-blur-2xl p-4 shadow-2xl shadow-black/50 opacity-0 transition-opacity duration-200",o.innerHTML=`
  ...
  `}function st(e){return`
    <aside id="sidebar" class="w-[340px] shrink-0 h-full overflow-y-auto p-4 flex flex-col gap-4">
      ...
      <div id="settings-panel" class="rounded-2xl border border-white/[6%] bg-[#1a1714] p-4 flex flex-col gap-4">
        <span class="text-xs font-semibold text-zinc-300 tracking-wide">${s("sidebar.settings")} · <span class="text-zinc-500 font-normal normal-case">${V()}</span></span>
        ${q(e)}
      </div>
    </aside>
  ...
  `}function ct(){const e=document.getElementById("app");if(!e)return;const t=d.getState();e.innerHTML=`
    ${at(t)}
