(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const s of a)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function n(a){const s={};return a.integrity&&(s.integrity=a.integrity),a.referrerPolicy&&(s.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?s.credentials="include":a.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(a){if(a.ep)return;a.ep=!0;const s=n(a);fetch(a.href,s)}})();const se="modulepreload",re=function(e){return"/"+e},O={},oe=function(t,n,i){let a=Promise.resolve();if(n&&n.length>0){let o=function(d){return Promise.all(d.map(p=>Promise.resolve(p).then(b=>({status:"fulfilled",value:b}),b=>({status:"rejected",reason:b}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),u=(l==null?void 0:l.nonce)||(l==null?void 0:l.getAttribute("nonce"));a=o(n.map(d=>{if(d=re(d),d in O)return;O[d]=!0;const p=d.endsWith(".css"),b=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${b}`))return;const x=document.createElement("link");if(x.rel=p?"stylesheet":se,p||(x.as="script"),x.crossOrigin="",x.href=d,u&&x.setAttribute("nonce",u),document.head.appendChild(x),p)return new Promise((k,$)=>{x.addEventListener("load",k),x.addEventListener("error",()=>$(new Error(`Unable to preload CSS for ${d}`)))})}))}function s(o){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=o,window.dispatchEvent(l),!l.defaultPrevented)throw o}return a.then(o=>{for(const l of o||[])l.status==="rejected"&&s(l.reason);return t().catch(s)})},F="koalasnap_state";function le(e){try{const t=localStorage.getItem(F);if(t)return{...e,...JSON.parse(t)}}catch{}return{...e}}function B(e){try{const{avatar:t,...n}=e;localStorage.setItem(F,JSON.stringify(n))}catch{}}function ce(e){const t=le(e),n=new Set;return{get(i){return t[i]},getState(){return{...t}},set(i,a){t[i]=a,B(t),n.forEach(s=>s(i,a,t))},setAll(i){Object.assign(t,i),B(t),n.forEach(a=>a(null,null,t))},mutate(i){Object.assign(t,i),B(t),n.forEach(a=>a(null,null,t))},subscribe(i){return n.add(i),()=>n.delete(i)},reset(){Object.assign(t,e),B(t),n.forEach(i=>i(null,null,t))}}}const de={theme:"whatsapp",author:"Maya",handle:"@maya_99",username:"Maya",roleColor:"#e81224",timestamp:"7:18 PM",message:"Hey, are you coming online tonight?",avatar:null,bgGradient:"from-sky-400 to-indigo-600",padding:48,mockupTheme:"light",waMode:"sent",locale:"en",messages:[{id:1,text:"Hey, are you coming online tonight?",type:"sent",time:"7:18 PM",status:"read"},{id:2,text:"Yeah, give me 5!",type:"received",time:"7:20 PM",status:"read"},{id:3,text:"Sure, take your time 🐨",type:"sent",time:"7:21 PM",status:"delivered"}]},c=ce(de),pe=window.__LOCALE__||{};function r(e){return e.split(".").reduce((n,i)=>n!=null?n[i]:void 0,pe)??e}function A(){const e=window.location.pathname;return e.startsWith("/de/")||e==="/de"?"de":"en"}function m(e){return typeof e!="string"?"":e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}const C=500,ue=.8;function ge(e){return new Promise((t,n)=>{const i=new FileReader;i.onerror=()=>n(new Error("File read failed")),i.onload=a=>{const s=new Image;s.onerror=()=>n(new Error("Image decode failed")),s.onload=()=>{let{width:o,height:l}=s;if(o>C||l>C){const p=Math.min(C/o,C/l);o=Math.round(o*p),l=Math.round(l*p)}const u=document.createElement("canvas");u.width=o,u.height=l;const d=u.getContext("2d");if(!d){n(new Error("Canvas 2D not supported"));return}d.imageSmoothingEnabled=!0,d.imageSmoothingQuality="high",d.drawImage(s,0,0,o,l),u.toBlob(p=>{if(!p){n(new Error("WebP encoding failed"));return}t(URL.createObjectURL(p))},"image/webp",ue)},s.src=a.target.result},i.readAsDataURL(e)})}function me(e){const t=document.getElementById(e);t instanceof HTMLImageElement&&(t.src="")}const U="koalasnap_tutorial_completed",y=[{target:"app-library",key:"tutorial.step1"},{target:"settings-panel",key:"tutorial.step2"},{target:"canvas-area",key:"tutorial.step3"},{target:"bottom-bar",key:"tutorial.step4"},{target:"btn-topbar-export",key:"tutorial.step5"}];let v=0,E=!1,w=null;function fe(){return localStorage.getItem(U)==="true"}function he(){return E}function q(){E&&z(),v=0,E=!0;const e=we();e.classList.remove("hidden"),e.style.pointerEvents="auto",S(0),document.addEventListener("keydown",W)}function W(e){e.key==="Escape"&&z()}function z(){E=!1,w&&(clearTimeout(w),w=null),I(v);const e=document.getElementById("tutorial-overlay");e&&(e.classList.add("hidden"),e.style.pointerEvents=""),localStorage.setItem(U,"true"),document.removeEventListener("keydown",W)}function xe(){if(I(v),v++,v>=y.length){z();return}S(v)}function ve(){I(v),v=Math.max(0,v-1),S(v)}function be(){E&&(I(v),S(v))}function we(){let e=document.getElementById("tutorial-overlay");return e||(e=document.createElement("div"),e.id="tutorial-overlay",e.className="fixed inset-0 bg-black/60 z-40 hidden",document.body.appendChild(e)),e}function S(e){w&&(clearTimeout(w),w=null);const t=y[e];if(!t)return;const n=document.getElementById(t.target);if(!n)return;n.classList.add("tutorial-highlight"),n.style.zIndex="50",getComputedStyle(n).position==="static"&&(n.style.position="relative"),n.scrollIntoView({behavior:"smooth",block:"center"});const i=n.getBoundingClientRect();w=setTimeout(()=>{ye(e,i),w=null},400)}function I(e){w&&(clearTimeout(w),w=null);const t=y[e];if(!t)return;const n=document.getElementById(t.target);n&&(n.classList.remove("tutorial-highlight"),n.style.zIndex="",n.style.position="");const i=document.getElementById("tutorial-tooltip");i&&i.remove()}function ye(e,t){const n=document.getElementById("tutorial-tooltip");n&&n.remove();const i=y.length,a=e===0,s=e===i-1,o=document.createElement("div");o.id="tutorial-tooltip",o.className="fixed z-50 w-[320px] rounded-2xl border border-white/[10%] bg-[#1a1714]/95 backdrop-blur-2xl p-4 shadow-2xl shadow-black/50 opacity-0 transition-opacity duration-200",o.innerHTML=`
  ...
  `,document.body.appendChild(o),$e(o,t),requestAnimationFrame(()=>{o.classList.remove("opacity-0")}),Ee(e)}function ke(e){var t;return((t=y[e])==null?void 0:t.key)||""}function $e(e,t){const a=e.offsetWidth||320,s=e.offsetHeight||160,o=window.innerWidth-a-16,l=window.innerHeight-s-16,u=t.left+t.width/2;let d=Math.max(16,Math.min(u-a/2,o)),p=t.bottom+12;p+s>window.innerHeight-16&&(p=t.top-s-12),p<16&&(p=16,d=Math.min(t.right+12,o),d=Math.max(16,d)),d=Math.max(16,Math.min(d,o)),p=Math.max(16,Math.min(p,l)),e.style.left=`${d}px`,e.style.top=`${p}px`}function Ee(e){const t=document.getElementById("tut-next");t&&(t.onclick=()=>e===y.length-1?z():xe());const n=document.getElementById("tut-prev");n&&(n.onclick=()=>ve());const i=document.getElementById("tut-skip");i&&(i.onclick=()=>z())}const K="?";function ze(e,t){const n=t==="dark";return e?`<img id="mockup-avatar" src="${e}" class="w-full h-full rounded-full object-cover" />`:`<div id="mockup-avatar" class="w-full h-full rounded-full bg-gradient-to-br ${n?"from-zinc-600 to-zinc-800":"from-sky-400 to-indigo-500"} flex items-center justify-center text-white text-sm font-bold">${K}</div>`}function Be(e){const t=e.mockupTheme==="dark",n=t?"bg-zinc-900":"bg-white",i=t?"text-zinc-100":"text-zinc-900",a=t?"text-zinc-400":"text-zinc-500",s=t?"text-zinc-300":"text-zinc-800",o=t?"bg-zinc-800":"bg-zinc-100",l=t?"text-zinc-600":"text-zinc-400",u=new Intl.DateTimeFormat(A()==="de"?"de-DE":"en-US",{hour:"2-digit",minute:"2-digit",day:"2-digit",month:"short",year:"numeric"}).format(new Date);return`
    <div id="mockup-card"
  ...
  `}function Ce(e){const t=e.mockupTheme==="dark";T("mockup-author",a=>{a.textContent=e.author}),T("mockup-handle",a=>{a.textContent=`@${e.handle}`}),T("mockup-message",a=>{a.textContent=e.message});const n=document.getElementById("mockup-avatar");if(n)if(n.parentElement,e.avatar){const a=document.createElement("img");a.id="mockup-avatar",a.src=e.avatar,a.className="w-full h-full rounded-full object-cover",n.replaceWith(a)}else{const a=document.createElement("div");a.id="mockup-avatar";const s=t?"from-zinc-600 to-zinc-800":"from-sky-400 to-indigo-500";a.className=`w-full h-full rounded-full bg-gradient-to-br ${s} flex items-center justify-center text-white text-sm font-bold`,a.textContent=K,n.replaceWith(a)}const i=document.getElementById("mockup-card");i&&(i.style.padding=`${e.padding}px`)}function T(e,t){const n=document.getElementById(e);n&&t(n)}function Le(e){const t=e.avatar?`<img id="discord-avatar" src="${e.avatar}" class="w-full h-full rounded-full object-cover" />`:'<div id="discord-avatar" class="w-full h-full rounded-full bg-[#5865F2] flex items-center justify-center text-white text-xs font-bold">?</div>';return`
    <div id="mockup-card"
  ...
  `}function nt(e){N("tg-message",n=>{n.textContent=e.message}),N("tg-time",n=>{n.textContent=e.timestamp});const t=document.getElementById("mockup-card");t&&(t.style.padding=`${e.padding}px`)}function N(e,t){const n=document.getElementById(e);n&&t(n)}const it=`<svg width="16" height="16" viewBox="0 0 16 16" fill="none">
  ...
  `}function st(e){G("sg-message",n=>{n.textContent=e.message}),G("sg-time",n=>{n.textContent=e.timestamp});const t=document.getElementById("mockup-card");t&&(t.style.padding=`${e.padding}px`)}function G(e,t){const n=document.getElementById(e);n&&t(n)}function rt(e){return`
    <div id="mockup-card"
      ...
      <div class="flex items-center gap-2">
        ...
        <div class="relative flex">
          <select id="lang-select" aria-label="Language"
            ...
            <option value="de" ${V==="de"?"selected":""}>DE</option>
            <option value="en" ${V==="en"?"selected":""}>EN</option>
          </select>
    ...
    <aside id="sidebar" class="w-[340px] shrink-0 h-full overflow-y-auto p-4 flex flex-col gap-4">
      <div id="app-library" class="rounded-2xl border border-white/[6%] bg-[#1a1714] p-4 flex flex-col gap-3">
        <div class="flex items-center justify-between cursor-pointer select-none" id="app-library-toggle">
          ...
          <div class="flex items-center gap-2">
            <span class="text-[10px] text-zinc-600">${M.length} ${r("sidebar.apps")}</span>
        ...
        <div id="app-library-body">
          ...
          <div class="flex flex-col gap-1.5">
            ${M.map(t=>{const n=t.theme===g;return`
      ...
      <div id="settings-panel" class="rounded-2xl border border-white/[6%] bg-[#1a1714] p-4 flex flex-col gap-4">
        <span class="text-xs font-semibold text-zinc-300 tracking-wide">${r("sidebar.settings")} · <span class="text-zinc-500 font-normal normal-case">${Q()}</span></span>
        ${Z(e)}
      </div>
    </aside>
  `}function Z(e){const t=["whatsapp","telegram","signal","imessage"].includes(g);let n="";return g==="discord"?n=`
      ...
      <div class="flex flex-col gap-2 mt-2">
        ...
        <div id="wa-message-list" class="flex flex-col gap-2">
          ${e.messages.map((i,a)=>ee(i,a)).join("")}
        </div>
  ...
  `}function mt(e){const n=A()==="de"?"/de":"";return`
  ...
  `,xt(),H()}function ht(e){const t=document.getElementById("settings-panel");t&&(t.innerHTML=`
    <span class="text-xs font-semibold text-zinc-300 tracking-wide">${r("sidebar.settings")} · <span class="text-zinc-500 font-normal normal-case">${Q()}</span></span>
    ${Z(e)}
  `,te())}function xt(){h("btn-topbar-export","click",yt),h("btn-mockup-theme","click",()=>{const t=c.get("mockupTheme")==="light"?"dark":"light";c.set("mockupTheme",t)}),h("lang-select","change",t=>{const n=t.target.value;window.location.href=n==="en"?"/":`/${n}/`}),h("btn-start-tour","click",()=>q()),document.querySelectorAll("[data-gradient]").forEach(t=>{t.addEventListener("click",()=>c.set("bgGradient",t.dataset.gradient))}),document.querySelectorAll("[data-app]").forEach(t=>{t.addEventListener("click",()=>{const n=M.find(i=>i.id===t.dataset.app);n&&c.set("theme",n.theme),kt()})});const e=document.getElementById("app-library-toggle");e&&e.addEventListener("click",()=>{const t=document.getElementById("app-library-body"),n=document.getElementById("app-library-chevron");if(!t)return;const i=t.style.display==="none";t.style.display=i?"":"none",n&&(n.style.transform=i?"rotate(0deg)":"rotate(180deg)")}),te()}function te(){h("input-padding","input",e=>{c.set("padding",Number(e.target.value));const t=document.getElementById("padding-value");t&&(t.textContent=e.target.value)}),h("input-message","input",e=>c.set("message",e.target.value)),h("input-avatar","change",async e=>{var n;const t=(n=e.target.files)==null?void 0:n[0];if(t&&t.type.startsWith("image/")&&!(t.size>5*1024*1024))try{const i=c.get("avatar"),a=await ge(t);i&&i.startsWith("blob:")&&URL.revokeObjectURL(i),c.set("avatar",a)}catch{c.set("avatar",null)}}),g==="social-post"?(h("input-author","input",e=>c.set("author",e.target.value)),h("input-handle","input",e=>c.set("handle",e.target.value))):g==="discord"?(h("input-username","input",e=>c.set("username",e.target.value)),h("input-rolecolor","input",e=>c.set("roleColor",e.target.value)),h("input-timestamp","input",e=>c.set("timestamp",e.target.value))):["whatsapp","telegram","signal","imessage"].includes(g)&&(h("input-username","input",e=>c.set("username",e.target.value)),g==="whatsapp"?vt():h("input-timestamp","input",e=>c.set("timestamp",e.target.value)))}function vt(){const e=document.getElementById("btn-add-message");e&&(e.onclick=()=>{const n=[...c.get("messages")];n.push({id:Date.now(),text:"",type:c.get("waMode")||"sent",time:""}),c.set("messages",n),L(c.getState())});const t=document.getElementById("wa-message-list");t&&(t.addEventListener("input",n=>{const i=n.target,a=parseInt(i.dataset.msgIdx);if(!isNaN(a)){if(i.tagName==="TEXTAREA"){const s=[...c.get("messages")];s[a]&&(s[a]={...s[a],text:i.value}),c.set("messages",s)}else if(i.dataset.msgField==="time"){const s=[...c.get("messages")];s[a]&&(s[a]={...s[a],time:i.value}),c.set("messages",s)}}}),t.addEventListener("click",n=>{const i=n.target.closest("[data-msg-type], [data-msg-status], [data-msg-action]");if(!i)return;const a=parseInt(i.dataset.msgIdx);if(!isNaN(a)){if(i.dataset.msgType){const s=[...c.get("messages")];s[a]&&(s[a]={...s[a],type:i.dataset.msgType}),c.set("messages",s),L(c.getState())}else if(i.dataset.msgStatus){const s=[...c.get("messages")];s[a]&&(s[a]={...s[a],status:i.dataset.msgStatus}),c.set("messages",s),L(c.getState())}else if(i.dataset.msgAction==="delete"){const s=c.get("messages").filter((o,l)=>l!==a);c.set("messages",s),L(c.getState())}}}))}function L(e){const t=document.getElementById("wa-message-list");t&&(t.innerHTML=e.messages.map((n,i)=>ee(n,i)).join(""))}function H(){const e=J[g];if(!e)return;const t=c.getState(),n=document.getElementById("mockup");n&&(n.innerHTML=e.render(t)),ne(t),requestAnimationFrame(ie)}function bt(e,t,n){if(!_){_=!0;try{const i=J[g];if(!i)return;if(e==="theme"){g=t;const a=ae();a&&c.mutate({author:a.author||"",handle:a.handle||"",username:a.username||a.author||"",message:a.message||"",timestamp:a.time||"",roleColor:a.roleColor||"#5865F2",messages:a.messages||[{id:1,text:a.message||"",type:c.get("waMode")||"sent",time:a.time||"",status:"read"}]}),H(),ht(c.getState()),wt(t),he()&&requestAnimationFrame(()=>be());return}if(e==="bgGradient"&&ne(n),e==="mockupTheme"){const a=document.getElementById("btn-mockup-theme");a&&(a.innerHTML=t==="light"?f.sun:f.moon),H();return}if(e==="waMode")return;e==="avatar"&&me(g==="discord"?"discord-avatar":g==="whatsapp"?"wa-avatar":"mockup-avatar"),i.sync(n)}finally{_=!1}}}function wt(e){document.querySelectorAll("[data-app]").forEach(t=>{const n=M.find(a=>a.id===t.dataset.app),i=n&&n.theme===e;t.className=`flex flex-col items-center gap-1.5 rounded-xl border p-2.5 transition-all text-center ${i?"border-white/15 bg-white/[8%]":"border-white/[4%] bg-white/[3%] hover:bg-white/[7%] hover:border-white/[8%]"}`})}function ne(e){const t=document.getElementById("canvas");if(!t)return;const n=ct[e.bgGradient]||["#38bdf8","#4f46e5"];t.style.background=`
    radial-gradient(rgba(255,255,255,0.035) 1px, transparent 1px),
    linear-gradient(135deg, ${n[0]}, ${n[1]})
  `,t.style.backgroundSize="40px 40px, 100% 100%"}function ie(){if(P)return;const e=document.getElementById("canvas"),t=document.getElementById("mockup-card");if(!e||!t)return;const n=e.getBoundingClientRect(),i=Math.min(n.width/390,n.height/844)*.9;t.style.transform=`scale(${i})`,t.style.transformOrigin="center center"}window.addEventListener("resize",ie);async function yt(){const e=document.getElementById("btn-topbar-export"),t=document.getElementById("btn-export-icon"),n=document.getElementById("btn-export-label");if(!e||e.disabled)return;P=!0,e.disabled=!0,t&&(t.innerHTML=f.spinner),n&&(n.textContent=r("topbar.rendering"));const i=document.getElementById("mockup-card");if(!i){u();return}const a=i.style.transform,s=i.style.transformOrigin;i.style.transform="",i.style.transformOrigin="";const o=i.querySelectorAll("img"),l=[];o.forEach((d,p)=>{l[p]=d.src,d.src.startsWith("blob:")&&(d.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7")}),await new Promise(d=>requestAnimationFrame(d));try{const{toPng:d}=await oe(async()=>{const{toPng:$}=await import("./index-CgJtiJsK.js");return{toPng:$}},[]),p=await d(i,{pixelRatio:2});i.style.transform=a,i.style.transformOrigin=s,o.forEach(($,D)=>{l[D]&&($.src=l[D])});const b=new Date,x=`koalasnap-${g}-${ts}.png`,k=document.createElement("a");k.download=x,k.href=p,k.click(),t&&(t.innerHTML=f.check),n&&(n.textContent=r("topbar.exported")),e.classList.remove("bg-[#f97316]","hover:bg-[#ea580c]"),e.classList.add("bg-emerald-500","hover:bg-emerald-600"),setTimeout(u,2e3)}catch(d){i.style.transform=a,i.style.transformOrigin=s,o.forEach((p,b)=>{l[b]&&(p.src=l[b])}),console.error("Export failed:",d),t&&(t.innerHTML=f.download),n&&(n.textContent=r("topbar.exportFailed")),e.disabled=!1,setTimeout(()=>{n&&(n.textContent=r("topbar.export")),t&&(t.innerHTML=f.download)},2e3)}function u(){P=!1,e.disabled=!1,e.classList.remove("bg-emerald-500","hover:bg-emerald-600"),e.classList.add("bg-[#f97316]","hover:bg-[#ea580c]"),t&&(t.innerHTML=f.download),n&&(n.textContent=r("topbar.export"))}}function h(e,t,n){var i;(i=document.getElementById(e))==null||i.addEventListener(t,n)}function kt(){const e=document.getElementById("app-library-body"),t=document.getElementById("app-library-chevron");e&&(e.style.display="none"),t&&(t.style.transform="rotate(180deg)")}function ae(){var s,o;const e=[{author:"Maya",handle:"@maya_99",username:"Maya",message:"Hey, are you coming online tonight?",time:"7:18 PM",roleColor:"#e81224",messages:[{text:"Hey, are you coming online tonight?",type:"sent",time:"7:18 PM"},{text:"Yeah, give me 5!",type:"received",time:"7:20 PM"},{text:"Sure, take your time 🐨",type:"sent",time:"7:21 PM"}]}],t=window.__LOCALE__,n=t!=null&&t.dummySets&&t.dummySets.length>0?t.dummySets:e,i=n[Math.floor(Math.random()*n.length)],a=i.messages&&i.messages.length>0?i.messages.map((l,u)=>({id:u+1,text:l.text,type:l.type,time:l.time,status:l.status||"read"})):[{id:1,text:i.message||"",type:c.get("waMode")||"sent",time:i.time||"",status:"read"}];return{author:i.author||"",handle:i.handle||"",username:i.username||i.author||"",message:i.message||((s=a[0])==null?void 0:s.text)||"",time:i.time||((o=a[0])==null?void 0:o.time)||"",roleColor:i.roleColor||"#5865F2",messages:a}}c.subscribe(bt);try{const e=localStorage.getItem("koalasnap_state"),t=A();let n=!e;if(e)try{const i=JSON.parse(e);(!i.locale||i.locale!==t)&&(n=!0)}catch{n=!0}if(n){const i=ae();i&&c.mutate({...i,locale:t})}}catch{}ft();fe()||setTimeout(()=>q(),800);
