(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(s){if(s.ep)return;s.ep=!0;const r=t(s);fetch(s.href,r)}})();const it="modulepreload",st=function(e){return"/"+e},be={},Me=function(n,t,i){let s=Promise.resolve();if(t&&t.length>0){let a=function(d){return Promise.all(d.map(u=>Promise.resolve(u).then(f=>({status:"fulfilled",value:f}),f=>({status:"rejected",reason:f}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),p=(l==null?void 0:l.nonce)||(l==null?void 0:l.getAttribute("nonce"));s=a(t.map(d=>{if(d=st(d),d in be)return;be[d]=!0;const u=d.endsWith(".css"),f=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${f}`))return;const h=document.createElement("link");if(h.rel=u?"stylesheet":it,u||(h.as="script"),h.crossOrigin="",h.href=d,p&&h.setAttribute("nonce",p),document.head.appendChild(h),u)return new Promise((x,v)=>{h.addEventListener("load",x),h.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${d}`)))})}))}function r(a){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=a,window.dispatchEvent(l),!l.defaultPrevented)throw a}return s.then(a=>{for(const l of a||[])l.status==="rejected"&&r(l.reason);return n().catch(r)})},de="koalasnap_state",N="koalasnap_templates",we="koalasnap_sidebar",J=3,ye={bgGradient:"from-sky-400 to-indigo-600"},ke={1:e=>(e.bgGradient===ye.bgGradient&&(e.bgGradient="from-slate-900 to-indigo-950"),e),2:e=>(e.bgGradient===ye.bgGradient&&(e.bgGradient="from-slate-900 to-indigo-950"),e)};function at(e){try{const n=localStorage.getItem(de);if(n){const t=JSON.parse(n);t.bgGradient==="from-sky-400 to-indigo-600"&&(t.bgGradient="from-slate-900 to-indigo-950");const i=t._version||1;if(i<J){for(let a=i;a<J;a++)ke[a]&&ke[a](t);t._version=J;const{avatar:s,...r}=t;localStorage.setItem(de,JSON.stringify(r))}return{...e,...t}}}catch{}return{...e}}function P(e){try{const{avatar:n,...t}=e;localStorage.setItem(de,JSON.stringify(t))}catch{}}function rt(){try{const n=new URLSearchParams(window.location.search).get("state");if(!n)return null;const t=atob(n),i=Uint8Array.from(t,a=>a.charCodeAt(0)),s=new TextDecoder().decode(i),r=JSON.parse(s);if(r&&typeof r=="object")return r}catch{}return null}function ot(e){const n=rt(),t=n?{...e,...n}:at(e),i=new Set,s=[],r=[],a=50;let l=!1;function p(){l||(s.push(JSON.parse(JSON.stringify(t))),s.length>a&&s.shift(),r.length=0)}return{get(d){return t[d]},getState(){return{...t}},set(d,u){p(),t[d]=u,P(t),i.forEach(f=>f(d,u,t))},setAll(d){p(),Object.assign(t,d),P(t),i.forEach(u=>u(null,null,t))},mutate(d){p(),Object.assign(t,d),P(t),i.forEach(u=>u(null,null,t))},subscribe(d){return i.add(d),()=>i.delete(d)},reset(){p(),Object.assign(t,e),P(t),i.forEach(d=>d(null,null,t))},undo(){if(s.length===0)return;r.push(JSON.parse(JSON.stringify(t)));const d=s.pop();Object.assign(t,d),P(t),i.forEach(u=>u("_undo",null,t))},redo(){if(r.length===0)return;s.push(JSON.parse(JSON.stringify(t)));const d=r.pop();Object.assign(t,d),P(t),i.forEach(u=>u("_redo",null,t))},canUndo(){return s.length>0},canRedo(){return r.length>0},pauseHistory(){l=!0},resumeHistory(){l=!1},saveTemplate(d){try{const u=JSON.parse(localStorage.getItem(N)||"{}"),{avatar:f,...h}=t;return u[d]=h,localStorage.setItem(N,JSON.stringify(u)),!0}catch{return!1}},deleteTemplate(d){try{const u=JSON.parse(localStorage.getItem(N)||"{}");return delete u[d],localStorage.setItem(N,JSON.stringify(u)),!0}catch{return!1}},loadTemplate(d){try{const f=JSON.parse(localStorage.getItem(N)||"{}")[d];return f?(this.mutate(f),!0):!1}catch{return!1}},listTemplates(){try{return Object.keys(JSON.parse(localStorage.getItem(N)||"{}"))}catch{return[]}},getSidebarOpen(){return localStorage.getItem(we)!=="false"},setSidebarOpen(d){localStorage.setItem(we,String(d))},getShareUrl(){try{const{avatar:d,...u}=t,f=JSON.stringify(u),h=new TextEncoder().encode(f),x=String.fromCharCode(...h),v=btoa(x),y=new URL(window.location.href.split("?")[0].split("#")[0]);return y.searchParams.set("state",v),y.toString()}catch{return null}}}}const lt={_version:J,theme:"whatsapp",author:"Maya",handle:"@maya_99",username:"Maya",roleColor:"#e81224",timestamp:"7:18 PM",statusBarTime:"09:41",statusText:"online",imessageMode:"imessage",statusBarBattery:100,statusBarSignal:4,statusBarWifi:!0,isGroup:!1,message:"Hey, are you coming online tonight?",avatar:null,bgGradient:"from-slate-900 to-indigo-950",padding:48,mockupTheme:"light",waMode:"sent",locale:"en",fontFamily:"system-ui",chatBg:null,chatBgGradient:"",messages:[{id:1,text:"Hey, are you coming online tonight?",type:"sent",time:"7:18 PM",status:"read"},{id:2,text:"Yeah, give me 5!",type:"received",time:"7:20 PM",status:"read"},{id:3,text:"Sure, take your time 🐨",type:"sent",time:"7:21 PM",status:"delivered"}]},o=ot(lt),ct=window.__LOCALE__||{};function c(e){return e.split(".").reduce((t,i)=>t!=null?t[i]:void 0,ct)??e}function ue(){const e=window.location.pathname.match(/^\/([a-z]{2})\//);return e?e[1]:"en"}function g(e){return typeof e!="string"?"":e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}const K=500,dt=.8;function pt(e){return new Promise((n,t)=>{const i=new FileReader;i.onerror=()=>t(new Error("File read failed")),i.onload=s=>{const r=new Image;r.onerror=()=>t(new Error("Image decode failed")),r.onload=()=>{let{width:a,height:l}=r;if(a>K||l>K){const u=Math.min(K/a,K/l);a=Math.round(a*u),l=Math.round(l*u)}const p=document.createElement("canvas");p.width=a,p.height=l;const d=p.getContext("2d");if(!d){t(new Error("Canvas 2D not supported"));return}d.imageSmoothingEnabled=!0,d.imageSmoothingQuality="high",d.drawImage(r,0,0,a,l),p.toBlob(u=>{if(!u){t(new Error("WebP encoding failed"));return}n(URL.createObjectURL(u))},"image/webp",dt)},r.src=s.target.result},i.readAsDataURL(e)})}function ut(e){const n=document.getElementById(e);n instanceof HTMLImageElement&&(n.src="")}const Le="koalasnap_tutorial_completed",R=[{target:"app-library",key:"tutorial.step1"},{target:"settings-panel",key:"tutorial.step2"},{target:"canvas-area",key:"tutorial.step3"},{target:"bottom-bar",key:"tutorial.step4"},{target:"btn-topbar-export",key:"tutorial.step5"}];let k=0,W=!1,$=null;function gt(){return localStorage.getItem(Le)==="true"}function ft(){return W}function Ie(){W&&U(),k=0,W=!0;const e=vt();e.classList.remove("hidden"),e.style.pointerEvents="auto",Q(0),document.addEventListener("keydown",je)}function je(e){e.key==="Escape"&&U()}function U(){W=!1,$&&(clearTimeout($),$=null),ee(k);const e=document.getElementById("tutorial-overlay");e&&(e.classList.add("hidden"),e.style.pointerEvents=""),localStorage.setItem(Le,"true"),document.removeEventListener("keydown",je)}function ht(){if(ee(k),k++,k>=R.length){U();return}Q(k)}function xt(){ee(k),k=Math.max(0,k-1),Q(k)}function mt(){W&&(ee(k),Q(k))}function vt(){let e=document.getElementById("tutorial-overlay");return e||(e=document.createElement("div"),e.id="tutorial-overlay",e.className="fixed inset-0 bg-black/60 z-40 hidden",document.body.appendChild(e)),e}function Q(e){$&&(clearTimeout($),$=null);const n=R[e];if(!n)return;const t=document.getElementById(n.target);if(!t)return;t.classList.add("tutorial-highlight"),t.style.zIndex="50",getComputedStyle(t).position==="static"&&(t.style.position="relative"),t.scrollIntoView({behavior:"smooth",block:"center"});const i=t.getBoundingClientRect();$=setTimeout(()=>{bt(e,i),$=null},400)}function ee(e){$&&(clearTimeout($),$=null);const n=R[e];if(!n)return;const t=document.getElementById(n.target);t&&(t.classList.remove("tutorial-highlight"),t.style.zIndex="",t.style.position="");const i=document.getElementById("tutorial-tooltip");i&&i.remove()}function bt(e,n){const t=document.getElementById("tutorial-tooltip");t&&t.remove();const i=R.length,s=e===0,r=e===i-1,a=document.createElement("div");a.id="tutorial-tooltip",a.className="fixed z-50 w-[320px] rounded-2xl border border-white/[10%] bg-[#1a1714]/95 backdrop-blur-2xl p-4 shadow-2xl shadow-black/50 opacity-0 transition-opacity duration-200",a.innerHTML=`
  ...
  `,document.body.appendChild(a),yt(a,n),requestAnimationFrame(()=>{a.classList.remove("opacity-0")}),kt(e)}function wt(e){var n;return((n=R[e])==null?void 0:n.key)||""}function yt(e,n){const s=e.offsetWidth||320,r=e.offsetHeight||160,a=window.innerWidth-s-16,l=window.innerHeight-r-16,p=n.left+n.width/2;let d=Math.max(16,Math.min(p-s/2,a)),u=n.bottom+12;u+r>window.innerHeight-16&&(u=n.top-r-12),u<16&&(u=16,d=Math.min(n.right+12,a),d=Math.max(16,d)),d=Math.max(16,Math.min(d,a)),u=Math.max(16,Math.min(u,l)),e.style.left=`${d}px`,e.style.top=`${u}px`}function kt(e){const n=document.getElementById("tut-next");n&&(n.onclick=()=>e===R.length-1?U():ht());const t=document.getElementById("tut-prev");t&&(t.onclick=()=>xt());const i=document.getElementById("tut-skip");i&&(i.onclick=()=>U())}const _e="?",ge='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>',$t='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="17 1 21 5 17 9"/><path d="M3 11V9a4 4 0 0 1 4-4h14"/><polyline points="7 23 3 19 7 15"/><path d="M21 13v2a4 4 0 0 1-4 4H3"/></svg>',fe='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>',he='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg>',Bt='<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="5" r="2"/><circle cx="12" cy="12" r="2"/><circle cx="12" cy="19" r="2"/></svg>';function xe(e,n){return e?`<img id="mockup-avatar" src="${e}" class="w-full h-full rounded-full object-cover" />`:`<div id="mockup-avatar" class="w-full h-full rounded-full bg-gradient-to-br ${n?"from-zinc-600 to-zinc-800":"from-sky-400 to-indigo-500"} flex items-center justify-center text-white text-sm font-bold">${_e}</div>`}function zt(e,n){const t=n?"bg-zinc-900":"bg-white",i=n?"text-zinc-100":"text-zinc-900",s=n?"text-zinc-400":"text-zinc-500",r=n?"text-zinc-300":"text-zinc-800",a=n?"border-zinc-700":"border-zinc-200";return`
  ...
  `}function Ct(e,n){const t=n?"bg-black":"bg-white",i=n?"text-white":"text-zinc-900",s=n?"text-zinc-400":"text-zinc-500";return`
  ...
  `}function St(e,n){const t="text-white";return`
    <div id="mockup-card" class="mx-auto" style="width:390px; height:844px;font-family:${e.fontFamily};">
  ...
  `}function Ae(e,n){const t=e.statusBarWifi!==!1?`<span class="text-[11px]">${Vt}</span>`:"",i=en(e.statusBarSignal||4),s=Qt(e.statusBarBattery!==void 0?e.statusBarBattery:100);return`
  ...
  `}function sn(e,n){const t=e.chatBg?`url(${e.chatBg})`:e.mockupTheme==="light"?"url(/whatsapp-bg-light.png)":"linear-gradient(rgba(11, 20, 26, 0.94), rgba(11, 20, 26, 0.94)), url(/whatsapp-bg-dark.png)",i=e.chatBg?"cover":"360px",s=e.chatBg?"no-repeat":"repeat";return`
  ...
  `:"";(_=e.reactions)!=null&&_[0]&&(x+=" pb-[11px]");const M=e.image?`<img src="${e.image}" class="w-full max-w-[280px] rounded-lg mb-1 object-cover shadow-[inset_0_0_1px_rgba(0,0,0,0.15)]" style="max-height: 200px" />`:"";let B="";s&&(u==="read"?B=Kt:u==="delivered"?B=qt:u==="sent"&&(B=Jt));const O=u==="unread",L=O?"font-semibold":"",C=O?`<span class="inline-flex ml-1 -mb-0.5">${Yt}</span>`:"";return`
    <div class="flex ${d} ${v} relative">
  ...
  `}function Oe(e,n){const t=e.statusBarWifi!==!1?`<span class="text-[11px]">${un}</span>`:"",i=wn(e.statusBarSignal||4),s=bn(e.statusBarBattery!==void 0?e.statusBarBattery:100);return`
  ...
  `}function Ne(e,n,t,i){var I,_;const s=e.type==="sent",r=n<t.messages.length-1?t.messages[n+1]:null,a=n>0?t.messages[n-1]:null,l=!a||a.type!==e.type,p=!r||r.type!==e.type,d=s?i.sentBg:i.recvBg,u=s?i.sentText:i.recvText,f=s?i.sentTimeText:i.timeText,h=s?"justify-end":"justify-start",x=e.status||"read";let v="",y="rounded-[12px]",z="px-3.5 py-1.5",j=l?"mt-2.5":"mt-[2px]";const S=["#2cb3c9","#57d363","#ffa500","#f44336","#9c27b0","#4caf50"],T=(e.senderName||"").split("").reduce((F,ne)=>F+ne.charCodeAt(0),0)%S.length,M=S[T],B=t.isGroup&&!s&&l&&e.senderName?`
    <div class="text-[12px] font-semibold mb-0.5 leading-tight select-none" style="color:${M}">
      ${g(e.senderName)}
    </div>
  `:"";p&&(s?(y="rounded-[12px] rounded-br-none",v=`<div class="absolute -right-[7px] bottom-[5px] w-0 h-0 border-l-[8px] border-t-[6px] border-t-transparent border-b-[6px] border-b-transparent" style="border-left-color:${d}"></div>`):(y="rounded-[12px] rounded-bl-none",v=`<div class="absolute -left-[7px] bottom-[5px] w-0 h-0 border-r-[8px] border-t-[6px] border-t-transparent border-b-[6px] border-b-transparent" style="border-right-color:${d}"></div>`));const O=(I=e.reactions)!=null&&I[0]?`
  ...
  `}function Ge(e,n){const t=e.statusBarWifi!==!1?`<span class="text-[11px]">${Tn}</span>`:"",i=Nn(e.statusBarSignal||4),s=On(e.statusBarBattery!==void 0?e.statusBarBattery:100);return`
  ...
  `}function Re(e,n,t,i){var C,I;const s=e.type==="sent",r=n>0?t.messages[n-1]:null,a=n<t.messages.length-1?t.messages[n+1]:null,l=!r||r.type!==e.type,p=!a||a.type!==e.type,d=s?i.sentBg:i.recvBg,u=s?i.sentText:i.recvText,f=s?i.sentTimeText:i.timeText,h=s?"justify-end":"justify-start",x=e.status||"read";let v="rounded-[16px]",y=l?"mt-2.5":"mt-[2px]";s?l&&p?v="rounded-[16px] rounded-br-[4px]":l?v="rounded-[16px] rounded-tr-[16px] rounded-br-[4px]":p?v="rounded-[16px] rounded-br-[4px]":v="rounded-[16px] rounded-tr-[16px] rounded-br-[4px]":l&&p?v="rounded-[16px] rounded-bl-[4px]":l?v="rounded-[16px] rounded-tl-[16px] rounded-bl-[4px]":p?v="rounded-[16px] rounded-bl-[4px]":v="rounded-[16px] rounded-tl-[16px] rounded-bl-[4px]";const z=["#10b981","#f59e0b","#ef4444","#8b5cf6","#ec4899","#3b82f6"],j=(e.senderName||"").split("").reduce((_,F)=>_+F.charCodeAt(0),0)%z.length,S=z[j],T=t.isGroup&&!s&&l&&e.senderName?`
  ...
  `:"";let B="px-3.5 py-1.5";(I=e.reactions)!=null&&I[0]&&(B="px-3.5 pt-1.5 pb-[10px]");const O=e.image?`<img src="${e.image}" class="w-full max-w-[280px] rounded-lg mb-1 object-cover shadow-[inset_0_0_1px_rgba(0,0,0,0.15)]" style="max-height: 200px" />`:"";let L="";return s&&(x==="read"||x==="delivered"?L=jn:x==="sent"&&(L=_n)),`
    <div class="flex ${h} ${y} relative">
      <div class="relative max-w-[80%]">
        <div class="${v} ${B} shadow-[0_1px_1px_rgba(0,0,0,0.08)]" style="background:${d}">
          ${T}
          ${O}
          ${e.text?`<p class="text-[14.5px]/[1.4] whitespace-pre-wrap break-words" style="color:${u}">${g(e.text)}</p>`:""}
          <div class="flex items-center justify-end gap-1 mt-0.5 select-none">
  ...
  `}function Ve(e,n){const t=e.statusBarWifi!==!1?`<span class="text-[11px]">${Un}</span>`:"",i=Yn(e.statusBarSignal||4),s=Jn(e.statusBarBattery!==void 0?e.statusBarBattery:100);return`
  ...
  `}function De(e,n){return`
    <div id="im-navbar" class="flex items-center gap-1 px-2 py-1.5 shrink-0 border-b border-black/[5%] relative z-10" style="background:${n.barBg};color:${n.navColor}">
      ...
      <div class="flex-1 min-w-0">
        <div id="im-contact-name" class="text-[15px] font-semibold leading-tight truncate ml-2" style="color:${n.statusColor}">${g(e.username)}</div>
      </div>
  ...
  `}function Zn(e,n){return`
    <div id="im-chat-container" class="flex-1 p-3 overflow-y-auto" style="background:var(--chat-bg, ${n.chatBg})${e.chatBg?`;background-image:url(${e.chatBg});background-size:cover`:""}">
      <div id="im-messages" class="flex flex-col gap-0.5">
        ${e.messages.map((t,i)=>We(t,i,e,n)).join("")}
      </div>
    </div>
  `}function We(e,n,t,i){var T,M;const s=e.type==="sent",r=n>0?t.messages[n-1]:null,a=n<t.messages.length-1?t.messages[n+1]:null,l=!r||r.type!==e.type,p=!a||a.type!==e.type,d=s?i.sentBg:i.recvBg,u=s?i.sentText:i.recvText,f=s?"justify-end":"justify-start";let h="",x="rounded-[18px]",v=l?"mt-2.5":"mt-[2px]";p&&(s?(x="rounded-[18px] rounded-br-[4px]",h=`<span class="absolute bottom-0 -right-[5px] w-[10px] h-[15px]" style="color:${d}">
  ...
  `:"";(M=e.reactions)!=null&&M[0]&&(l?v="mt-4":v="mt-3.5");const S=e.image?`<img src="${e.image}" class="w-full max-w-[280px] rounded-lg mb-1 object-cover shadow-[inset_0_0_1px_rgba(0,0,0,0.15)]" style="max-height: 200px" />`:"";return`
    <div class="flex flex-col ${f} ${v}">
      ${z}
        ...
        <div class="relative flex" id="export-dropdown-container">
          ...
          <div id="export-dropdown" class="absolute right-0 top-full mt-1 z-50 hidden min-w-[200px] rounded-xl border border-white/10 bg-[#1a1714]/95 backdrop-blur-2xl py-1 shadow-2xl shadow-black/50">
            <button data-export-action="png" class="flex items-center gap-2.5 w-full px-3 py-2 text-xs text-zinc-300 hover:bg-white/5 hover:text-white transition-all text-left">
              ${b.download} <span>${c("topbar.exportPng")}</span>
            </button>
            <button data-export-action="clipboard" class="flex items-center gap-2.5 w-full px-3 py-2 text-xs text-zinc-300 hover:bg-white/5 hover:text-white transition-all text-left">
              ${b.clipboard} <span>${c("topbar.exportClipboard")}</span>
            </button>
            <button data-export-action="share" class="flex items-center gap-2.5 w-full px-3 py-2 text-xs text-zinc-300 hover:bg-white/5 hover:text-white transition-all text-left">
              ${b.link} <span>${c("topbar.exportShare")}</span>
            </button>
          </div>
        </div>
  ...
  `}function si(e){const n=o.getSidebarOpen(),i=ue()==="de"?"/de":"";return`
  ...
  `}function Je(){const e=o.listTemplates();return`
    <div id="templates-section" class="rounded-2xl border border-white/[6%] bg-[#1a1714] p-4 flex flex-col gap-3">
      ...
      <div id="template-list" class="flex flex-col gap-1 max-h-[140px] overflow-y-auto">
        ${e.length===0?`<span class="text-[10px] text-zinc-600 text-center py-2">${c("templates.empty")}</span>`:e.map(n=>`
  ...
  `:"",p=((h=e.reactions)==null?void 0:h[0])||"",u=`
    <div class="flex gap-1 items-center mt-1.5 select-none">
      ...
      <div class="flex flex-wrap gap-0.5">
        ${["👍","❤️","😂","😮","😢","🙏"].map(x=>`
          <button data-msg-idx="${n}" data-msg-reaction="${x}"
    ...
    <div draggable="true" data-msg-idx="${n}"
      ...
      <div class="flex items-center gap-1.5 mt-1.5">
        ...
        <div class="flex gap-0.5 ml-1">
          ${ai.map(x=>`
            <button data-msg-idx="${n}" data-msg-status="${x.id}"
  ...
  `}function oi(e){const n=o.get("_zoom")||0;return`
