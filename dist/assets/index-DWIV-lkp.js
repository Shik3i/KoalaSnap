(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function s(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(i){if(i.ep)return;i.ep=!0;const r=s(i);fetch(i.href,r)}})();const zt="modulepreload",Ct=function(e){return"/"+e},He={},Ke=function(t,s,n){let i=Promise.resolve();if(s&&s.length>0){let o=function(c){return Promise.all(c.map(u=>Promise.resolve(u).then(x=>({status:"fulfilled",value:x}),x=>({status:"rejected",reason:x}))))};document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),l=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));i=o(s.map(c=>{if(c=Ct(c),c in He)return;He[c]=!0;const u=c.endsWith(".css"),x=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${x}`))return;const g=document.createElement("link");if(g.rel=u?"stylesheet":zt,u||(g.as="script"),g.crossOrigin="",g.href=c,l&&g.setAttribute("nonce",l),document.head.appendChild(g),u)return new Promise((h,m)=>{g.addEventListener("load",h),g.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(o){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=o,window.dispatchEvent(a),!a.defaultPrevented)throw o}return i.then(o=>{for(const a of o||[])a.status==="rejected"&&r(a.reason);return t().catch(r)})},ke="koalasnap_state",F="koalasnap_templates",Pe="koalasnap_sidebar",le=3,Ne={bgGradient:"from-sky-400 to-indigo-600"},Oe={1:e=>(e.bgGradient===Ne.bgGradient&&(e.bgGradient="from-slate-900 to-indigo-950"),e),2:e=>(e.bgGradient===Ne.bgGradient&&(e.bgGradient="from-slate-900 to-indigo-950"),e)};function Mt(e){try{const t=localStorage.getItem(ke);if(t){const s=JSON.parse(t);s.bgGradient==="from-sky-400 to-indigo-600"&&(s.bgGradient="from-slate-900 to-indigo-950");const n=s._version||1;if(n<le){for(let o=n;o<le;o++)Oe[o]&&Oe[o](s);s._version=le;const{avatar:i,...r}=s;localStorage.setItem(ke,JSON.stringify(r))}return{...e,...s}}}catch{}return{...e}}function V(e){try{const{avatar:t,...s}=e;localStorage.setItem(ke,JSON.stringify(s))}catch{}}function Tt(){try{const t=new URLSearchParams(window.location.search).get("state");if(!t)return null;const s=atob(t),n=Uint8Array.from(s,o=>o.charCodeAt(0)),i=new TextDecoder().decode(n),r=JSON.parse(i);if(r&&typeof r=="object")return r}catch{}return null}function Et(e){const t=Tt(),s=t?{...e,...t}:Mt(e),n=new Set,i=[],r=[],o=50;let a=!1;function l(){a||(i.push(JSON.parse(JSON.stringify(s))),i.length>o&&i.shift(),r.length=0)}return{get(c){return s[c]},getState(){return{...s}},set(c,u){l(),s[c]=u,V(s),n.forEach(x=>x(c,u,s))},setAll(c){l(),Object.assign(s,c),V(s),n.forEach(u=>u(null,null,s))},mutate(c){l(),Object.assign(s,c),V(s),n.forEach(u=>u(null,null,s))},subscribe(c){return n.add(c),()=>n.delete(c)},reset(){l(),Object.assign(s,e),V(s),n.forEach(c=>c(null,null,s))},undo(){if(i.length===0)return;r.push(JSON.parse(JSON.stringify(s)));const c=i.pop();Object.assign(s,c),V(s),n.forEach(u=>u("_undo",null,s))},redo(){if(r.length===0)return;i.push(JSON.parse(JSON.stringify(s)));const c=r.pop();Object.assign(s,c),V(s),n.forEach(u=>u("_redo",null,s))},canUndo(){return i.length>0},canRedo(){return r.length>0},pauseHistory(){a=!0},resumeHistory(){a=!1},saveTemplate(c){try{const u=JSON.parse(localStorage.getItem(F)||"{}"),{avatar:x,...g}=s;return u[c]=g,localStorage.setItem(F,JSON.stringify(u)),!0}catch{return!1}},deleteTemplate(c){try{const u=JSON.parse(localStorage.getItem(F)||"{}");return delete u[c],localStorage.setItem(F,JSON.stringify(u)),!0}catch{return!1}},loadTemplate(c){try{const x=JSON.parse(localStorage.getItem(F)||"{}")[c];return x?(this.mutate(x),!0):!1}catch{return!1}},listTemplates(){try{return Object.keys(JSON.parse(localStorage.getItem(F)||"{}"))}catch{return[]}},getSidebarOpen(){return localStorage.getItem(Pe)!=="false"},setSidebarOpen(c){localStorage.setItem(Pe,String(c))},getShareUrl(){try{const{avatar:c,...u}=s,x=JSON.stringify(u),g=new TextEncoder().encode(x),h=String.fromCharCode(...g),m=btoa(h),y=new URL(window.location.href.split("?")[0].split("#")[0]);return y.searchParams.set("state",m),y.toString()}catch{return null}}}}const St={_version:le,theme:"whatsapp",viewMode:"mobile",author:"Maya",handle:"@maya_99",username:"Maya",roleColor:"#e81224",timestamp:"7:18 PM",statusBarTime:"09:41",statusText:"online",imessageMode:"imessage",statusBarBattery:100,statusBarSignal:4,statusBarWifi:!0,isGroup:!1,message:"Hey, are you coming online tonight?",avatar:null,bgGradient:"from-slate-900 to-indigo-950",padding:48,mockupTheme:"light",waMode:"sent",locale:"en",fontFamily:"system-ui",_toolbarPos:"right",chatBg:null,chatBgGradient:"",messages:[{id:1,text:"Hey, are you coming online tonight?",type:"sent",time:"7:18 PM",status:"read"},{id:2,text:"Yeah, give me 5!",type:"received",time:"7:20 PM",status:"read"},{id:3,text:"Sure, take your time 🐨",type:"sent",time:"7:21 PM",status:"delivered"}]},d=Et(St),jt=window.__LOCALE__||{};function f(e){return e.split(".").reduce((s,n)=>s!=null?s[n]:void 0,jt)??e}function Te(){const e=window.location.pathname.match(/^\/([a-z]{2})\//);return e?e[1]:"en"}function p(e){return typeof e!="string"?"":e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}const re=500,Lt=.8;function It(e){return new Promise((t,s)=>{const n=new FileReader;n.onerror=()=>s(new Error("File read failed")),n.onload=i=>{const r=new Image;r.onerror=()=>s(new Error("Image decode failed")),r.onload=()=>{let{width:o,height:a}=r;if(o>re||a>re){const u=Math.min(re/o,re/a);o=Math.round(o*u),a=Math.round(a*u)}const l=document.createElement("canvas");l.width=o,l.height=a;const c=l.getContext("2d");if(!c){s(new Error("Canvas 2D not supported"));return}c.imageSmoothingEnabled=!0,c.imageSmoothingQuality="high",c.drawImage(r,0,0,o,a),l.toBlob(u=>{if(!u){s(new Error("WebP encoding failed"));return}t(URL.createObjectURL(u))},"image/webp",Lt)},r.src=i.target.result},n.readAsDataURL(e)})}function At(e){const t=document.getElementById(e);t instanceof HTMLImageElement&&(t.src="")}const De="koalasnap_tutorial_completed",K=[{target:"app-library",key:"tutorial.step1"},{target:"settings-panel",key:"tutorial.step2"},{target:"canvas-area",key:"tutorial.step3"},{target:"bottom-bar",key:"tutorial.step4"},{target:"btn-topbar-export",key:"tutorial.step5"}];let $=0,ne=!1,z=null;function _t(){return localStorage.getItem(De)==="true"}function Ht(){return ne}function qe(){ne&&ie(),$=0,ne=!0;const e=Gt();e.classList.remove("hidden"),e.style.pointerEvents="auto",fe(0),document.addEventListener("keydown",Je)}function Je(e){e.key==="Escape"&&ie()}function ie(){ne=!1,z&&(clearTimeout(z),z=null),ue($);const e=document.getElementById("tutorial-overlay");e&&(e.classList.add("hidden"),e.style.pointerEvents=""),localStorage.setItem(De,"true"),document.removeEventListener("keydown",Je)}function Pt(){if(ue($),$++,$>=K.length){ie();return}fe($)}function Nt(){ue($),$=Math.max(0,$-1),fe($)}function Ot(){ne&&(ue($),fe($))}function Gt(){let e=document.getElementById("tutorial-overlay");return e||(e=document.createElement("div"),e.id="tutorial-overlay",e.className="fixed inset-0 bg-black/60 z-40 hidden",document.body.appendChild(e)),e}function fe(e){z&&(clearTimeout(z),z=null);const t=K[e];if(!t)return;const s=document.getElementById(t.target);if(!s)return;s.classList.add("tutorial-highlight"),s.style.zIndex="50",getComputedStyle(s).position==="static"&&(s.style.position="relative"),s.scrollIntoView({behavior:"smooth",block:"center"});const n=s.getBoundingClientRect();z=setTimeout(()=>{Rt(e,n),z=null},400)}function ue(e){z&&(clearTimeout(z),z=null);const t=K[e];if(!t)return;const s=document.getElementById(t.target);s&&(s.classList.remove("tutorial-highlight"),s.style.zIndex="",s.style.position="");const n=document.getElementById("tutorial-tooltip");n&&n.remove()}function Rt(e,t){const s=document.getElementById("tutorial-tooltip");s&&s.remove();const n=K.length,i=e===0,r=e===n-1,o=document.createElement("div");o.id="tutorial-tooltip",o.className="fixed z-50 w-[320px] rounded-2xl border border-white/[10%] bg-[#1a1714]/95 backdrop-blur-2xl p-4 shadow-2xl shadow-black/50 opacity-0 transition-opacity duration-200",o.innerHTML=`
    <p class="text-sm text-zinc-200 leading-relaxed mb-4">${f(Ft(e))}</p>
    <div class="flex items-center justify-between">
      <span class="text-xs text-zinc-500">${e+1} ${f("tutorial.of")} ${n}</span>
      <div class="flex items-center gap-2">
        ${i?"":`<button id="tut-prev" class="px-3 py-1.5 rounded-full text-xs font-medium text-zinc-400 hover:text-zinc-200 hover:bg-white/5 transition-all">${f("tutorial.back")}</button>`}
        <button id="tut-next" class="px-4 py-1.5 rounded-full text-xs font-semibold text-white bg-[#f97316] hover:bg-[#ea580c] active:scale-[0.97] transition-all">${f(r?"tutorial.done":"tutorial.next")}</button>
      </div>
    </div>
    <button id="tut-skip" class="mt-2 text-[10px] text-zinc-600 hover:text-zinc-400 transition-colors">${f("tutorial.skip")}</button>
  `,document.body.appendChild(o),Vt(o,t),requestAnimationFrame(()=>{o.classList.remove("opacity-0")}),Wt(e)}function Ft(e){var t;return((t=K[e])==null?void 0:t.key)||""}function Vt(e,t){const i=e.offsetWidth||320,r=e.offsetHeight||160,o=window.innerWidth-i-16,a=window.innerHeight-r-16,l=t.left+t.width/2;let c=Math.max(16,Math.min(l-i/2,o)),u=t.bottom+12;u+r>window.innerHeight-16&&(u=t.top-r-12),u<16&&(u=16,c=Math.min(t.right+12,o),c=Math.max(16,c)),c=Math.max(16,Math.min(c,o)),u=Math.max(16,Math.min(u,a)),e.style.left=`${c}px`,e.style.top=`${u}px`}function Wt(e){const t=document.getElementById("tut-next");t&&(t.onclick=()=>e===K.length-1?ie():Pt());const s=document.getElementById("tut-prev");s&&(s.onclick=()=>Nt());const n=document.getElementById("tut-skip");n&&(n.onclick=()=>ie())}const Ye="?",D='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>',Xe='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="17 1 21 5 17 9"/><path d="M3 11V9a4 4 0 0 1 4-4h14"/><polyline points="7 23 3 19 7 15"/><path d="M21 13v2a4 4 0 0 1-4 4H3"/></svg>',q='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>',J='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg>',Ut='<svg width="32" height="32" viewBox="0 0 24 24" fill="white"><polygon points="5 3 19 12 5 21 5 3"/></svg>',Kt='<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="5" r="2"/><circle cx="12" cy="12" r="2"/><circle cx="12" cy="19" r="2"/></svg>';function G(e,t){return e?`<img id="mockup-avatar" src="${e}" class="w-full h-full rounded-full object-cover" />`:`<div id="mockup-avatar" class="w-full h-full rounded-full bg-gradient-to-br ${t?"from-zinc-600 to-zinc-800":"from-sky-400 to-indigo-500"} flex items-center justify-center text-white text-sm font-bold">${Ye}</div>`}function Dt(e,t){const s=t?"#18181b":"#ffffff",n=t?"text-zinc-100":"text-zinc-900",i=t?"text-zinc-400":"text-zinc-500",r=t?"text-zinc-300":"text-zinc-800",o=t?"border-zinc-700":"border-zinc-200";return`
    <div id="mockup-card" class="rounded-2xl shadow-2xl shadow-black/20 mx-auto overflow-hidden ring-1 ring-white/[6%] p-3" style="width:400px; height:520px;font-family:${e.fontFamily};background:var(--chat-bg, ${s})${e.chatBg?`;background-image:url(${e.chatBg});background-size:cover`:""}">
      ...
      <div class="flex items-center justify-between mt-2 pt-2 ${o} border-t text-sm ${i}">
        <div class="flex items-center gap-5">
          ...
          <span class="flex items-center gap-1">${Xe} <span id="mockup-retweets">3</span></span>
          <span class="flex items-center gap-1">${D} <span id="mockup-likes">12</span></span>
        </div>
        <span>${J}</span>
      </div>
    </div>
  `}function qt(e,t){const s=t?"#000000":"#ffffff",n=t?"text-white":"text-zinc-900",i=t?"text-zinc-400":"text-zinc-500";return`
  ...
  `}function Jt(e,t){const s=t?"#1a1a2e":"#f0f2f5",n=t?"#1c1c2e":"#007aff";return`
  ...
  `}function Yt(e,t){const s="text-white",n="text-zinc-300",i="linear-gradient(transparent 60%, rgba(0,0,0,0.7))",r=t?"#111111":"#161616";return`
    <div id="mockup-card" class="mx-auto" style="width:390px; height:844px;font-family:${e.fontFamily};">
            ...
            <div class="flex items-start gap-3">
              ...
              <div class="flex flex-col items-center gap-3 shrink-0">
                ...
                <div class="flex flex-col items-center gap-4 text-white text-xs">
                  <div class="flex flex-col items-center gap-0.5">${D}<span id="mockup-likes" class="text-[10px]">12.4k</span></div>
  ...
  `}function X(e){const t=e.mockupTheme==="dark",s=e.theme||"twitter";if(e.viewMode==="desktop")switch(s){case"instagram":return Qt(e,t);case"messenger":return ts(e,t);case"tiktok":return es(e,t);case"twitter":default:return Zt(e,t)}switch(s){case"instagram":return qt(e,t);case"messenger":return Jt(e,t);case"tiktok":return Yt(e,t);case"twitter":default:return Dt(e,t)}}function Z(e){if(e.viewMode==="desktop"){Xt(e);return}const t=e.theme||"twitter";B("mockup-author",s=>{s&&(s.textContent=e.author)}),B("mockup-message",s=>{s&&(s.textContent=e.message)}),B("mockup-likes",s=>{s&&(s.textContent="142")}),B("mockup-replies",s=>{s&&(s.textContent="1")}),B("mockup-retweets",s=>{s&&(s.textContent="3")}),t==="messenger"?B("mockup-avatar",s=>{s&&Be(s,e,!1)}):B("mockup-avatar",s=>{s&&Be(s,e,e.mockupTheme==="dark")})}function Xt(e){const t=e.mockupTheme==="dark";B("mockup-author",n=>{n&&(n.textContent=e.author)}),B("mockup-author-header",n=>{n&&(n.textContent=e.author)}),B("mockup-message",n=>{n&&(n.textContent=e.message)}),B("mockup-message-preview",n=>{n&&(n.textContent=e.message)}),document.querySelectorAll("#mockup-avatar").forEach(n=>{Be(n,e,t)})}function Zt(e,t){const s=t?"#000000":"#ffffff",n=t?"#000000":"#ffffff",i=t?"text-zinc-100":"text-zinc-900",r="text-zinc-500",o=t?"border-zinc-800":"border-zinc-200",a=G(e.avatar,t);return`
      ...
      <div class="flex-1 flex flex-col min-w-0 text-left">
        ...
        <div class="flex-1 overflow-y-auto p-4 flex flex-col gap-4">
          ...
          <div class="flex items-center justify-around py-1 border-b ${o} ${r} select-none">
            <span class="cursor-pointer hover:text-sky-500">${q}</span>
            <span class="cursor-pointer hover:text-emerald-500">${Xe}</span>
            <span class="cursor-pointer hover:text-rose-500">${D}</span>
  ...
  `}function Qt(e,t){const s=t?"#000000":"#ffffff",n=t?"text-white":"text-zinc-900",i="text-zinc-500",r=G(e.avatar,t);return`
  ...
  `}function es(e,t){const s=t?"#121212":"#ffffff",n=t?"#121212":"#ffffff",i=t?"text-zinc-100":"text-zinc-900",r="text-zinc-500",o=t?"border-zinc-800":"border-zinc-200",a=G(e.avatar,t);return`
    <div id="mockup-card" class="mx-auto flex rounded-xl overflow-hidden shadow-2xl border" style="width:1100px; height:750px; font-family:${e.fontFamily}; border-color:${t?"#2f2f2f":"#e3e3e3"}; background:${s};">
      ...
      <div class="flex-1 flex items-center justify-center shrink-0" style="background:#000000; position:relative;">
        <div class="w-full h-full flex items-center justify-center" style="${e.chatBg?`background-image:url(${e.chatBg});background-size:cover;background-position:center;`:""}">
          ${e.chatBg?"":`<span class="text-4xl text-white opacity-40">${Ut}</span>`}
        </div>
      </div>
  ...
  `}function ts(e,t){const s=t?"#181818":"#ffffff",n=t?"#1c1c1e":"#ffffff",i=t?"#2e2e2e":"#f0f2f5",r=t?"rgba(255,255,255,0.08)":"rgba(0,0,0,0.08)",o=t?"#aebac1":"#65676b",a=t?"#ffffff":"#050505",l=G(e.avatar,t);return`
  ...
  `}function Be(e,t,s){if(t.avatar){const n=document.createElement("img");n.id="mockup-avatar",n.src=t.avatar,n.className="w-full h-full rounded-full object-cover",n.alt="",e.replaceWith(n)}else{const n=document.createElement("div");n.id="mockup-avatar";const i=s?"from-zinc-600 to-zinc-800":"from-sky-400 to-indigo-500";n.className=`w-full h-full rounded-full bg-gradient-to-br ${i} flex items-center justify-center text-white text-sm font-bold`,n.textContent=Ye,e.replaceWith(n)}}function B(e,t){const s=document.getElementById(e);s&&t(s)}const Q='<svg width="20" height="20" viewBox="0 0 24 24" fill="#949ba4"><path d="M5 9h14M5 15h14M11 3L9 21M15 3l-2 18"/></svg>',Ze='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#949ba4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2z"/></svg>',Qe='<svg width="16" height="16" viewBox="0 0 24 24" fill="#949ba4"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>',ss='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#949ba4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>',et='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#b5bac1" stroke-width="2" stroke-linecap="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>',tt='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#b5bac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 12 20 22 4 22 4 12"/><rect x="2" y="7" width="20" height="5"/><line x1="12" y1="22" x2="12" y2="7"/><path d="M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7z"/><path d="M12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7z"/></svg>',ns=`url("data:image/svg+xml,%3Csvg width='200' height='200' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='30' cy='30' r='2' fill='white' opacity='0.02'/%3E%3Ccircle cx='100' cy='60' r='1.5' fill='white' opacity='0.015'/%3E%3Ccircle cx='170' cy='30' r='1' fill='white' opacity='0.02'/%3E%3Ccircle cx='50' cy='120' r='1.5' fill='white' opacity='0.015'/%3E%3Ccircle cx='150' cy='150' r='2' fill='white' opacity='0.02'/%3E%3C/svg%3E")`,is={guildsBg:"#e3e5e8",sidebarBg:"#f2f3f5",chatBg:"#ffffff",inputBg:"#ebedef",sidebarText:"#4e5058",chatText:"#2e3035",inputText:"#2e3035",userAreaBg:"#ebedef",userTagText:"#313338",placeholder:"#5c5e66",divider:"#e3e5e8",borderCol:"rgba(0,0,0,0.06)",dotPattern:"none"},os={guildsBg:"#1e1f22",sidebarBg:"#2b2d31",chatBg:"#313338",inputBg:"#383a40",sidebarText:"#949ba4",chatText:"#dbdee1",inputText:"#dbdee1",userAreaBg:"#232428",userTagText:"#f2f3f5",placeholder:"#949ba4",divider:"#3f4147",borderCol:"rgba(255,255,255,0.04)",dotPattern:ns};function rs(e){return e.mockupTheme==="light"?is:os}function as(e){const t=rs(e);if(e.viewMode==="desktop")return cs(e,t);const s=e.avatar?`<img id="discord-avatar" src="${e.avatar}" class="w-10 h-10 rounded-full object-cover" />`:'<div id="discord-avatar" class="w-10 h-10 rounded-full bg-[#5865F2] flex items-center justify-center text-white text-xs font-bold">?</div>';return`
    <div id="mockup-card" class="mx-auto" style="width:390px; height:844px;font-family:${e.fontFamily};">
  ...
  `}function ds(e){W("discord-username",s=>{s.textContent=e.username,s.style.color=e.roleColor}),W("discord-timestamp",s=>{s.textContent=e.timestamp}),W("discord-message",s=>{s.textContent=e.message}),document.querySelectorAll("#discord-avatar").forEach(s=>{if(e.avatar){const n=document.createElement("img");n.id="discord-avatar",n.src=e.avatar,n.className="w-full h-full rounded-full object-cover",n.alt="",s.replaceWith(n)}else{const n=document.createElement("div");n.id="discord-avatar",n.className="w-full h-full rounded-full bg-[#5865F2] flex items-center justify-center text-white text-[11px] font-bold",n.textContent="?",s.replaceWith(n)}})}function W(e,t){const s=document.getElementById(e);s&&t(s)}const ps='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#e9edef" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>',fs='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/></svg>',us='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',gs='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><path d="M9 11.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm-3.3-3.3a4.5 4.5 0 0 1 6.6 0l-1.1 1.1a3 3 0 0 0-4.4 0L5.7 8.2zM2.9 5.1a8 8 0 0 1 12.2 0l-1.1 1.1a6.5 6.5 0 0 0-10 0L2.9 5.1z" fill="currentColor"/></svg>',xs='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8696a0" stroke-width="2.5" stroke-linecap="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>',hs='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/></svg>',st='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/><line x1="8" y1="23" x2="16" y2="23"/></svg>',Ee='<svg width="14" height="14" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#53bdeb" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 5.5L9.5 9L16 1" stroke="#53bdeb" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" opacity="0.7"/></svg>',Se='<svg width="14" height="14" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 5.5L9.5 9L16 1" stroke="#8696a0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" opacity="0.7"/></svg>',je='<svg width="14" height="14" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',ms='<svg width="8" height="8" viewBox="0 0 8 8" fill="#53bdeb"><circle cx="4" cy="4" r="4"/></svg>',vs='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9" stroke-dasharray="10 4 6 4"/></svg>',bs='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>',Ge='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><circle cx="12" cy="12" r="1"/><circle cx="12" cy="5" r="1"/><circle cx="12" cy="19" r="1"/></svg>',ys='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/></svg>',ws='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.44 11.05l-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48"/></svg>',Re='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>',$s={barBg:"#008069",chatBg:"#efeae2",sentBg:"#d9fdd3",recvBg:"#ffffff",sentText:"#111b21",recvText:"#111b21",timeText:"#667781",inputBg:"#f0f2f5",fieldBg:"#ffffff",fieldText:"#111b21",placeholder:"#8696a0"},ks={barBg:"#202c33",chatBg:"#0b141a",sentBg:"#005c4b",recvBg:"#202c33",sentText:"#e9edef",recvText:"#e9edef",timeText:"#ffffff8c",inputBg:"#202c33",fieldBg:"#2a3942",fieldText:"#e9edef",placeholder:"#8696a0"};function te(e){return e.mockupTheme==="light"?$s:ks}function Bs(e){return`<svg width="24" height="12" viewBox="0 0 26 12" fill="none" class="opacity-90"><rect x="0.5" y="0.5" width="22" height="11" rx="2" stroke="currentColor" fill="none"/><rect x="2" y="2" width="${Math.max(1,Math.min(19.5,e/100*19.5))}" height="8" rx="1.5" fill="currentColor"/><rect x="24" y="3.5" width="2" height="5" rx="0.75" fill="currentColor"/></svg>`}function zs(e){const t=e>=1?"1":"0.3",s=e>=2?"1":"0.3",n=e>=3?"1":"0.3",i=e>=4?"1":"0.3";return`<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><rect x="1" y="8" width="2" height="3" rx="0.4" fill="currentColor" opacity="${t}"/><rect x="5" y="5" width="2" height="6" rx="0.4" fill="currentColor" opacity="${s}"/><rect x="9" y="2.5" width="2" height="8.5" rx="0.4" fill="currentColor" opacity="${n}"/><rect x="13" y="0.5" width="2" height="10.5" rx="0.4" fill="currentColor" opacity="${i}"/></svg>`}function Cs(e){const t=te(e);if(e.viewMode==="desktop")return Ms(e,t);const s=e.mockupTheme==="light"?"#ffffff":"#121212";return`
    <div id="mockup-card" class="mx-auto" style="width:390px; height:844px;font-family:${e.fontFamily};">
          ...
          <div class="flex gap-3 px-3 py-3 cursor-pointer select-none" style="background:${r};">
            ...
            <div class="flex-1 min-w-0 flex flex-col justify-center">
              ...
              <div class="flex items-center gap-1 mt-0.5">
                ...
                <span id="wa-chat-last-message" class="text-[13px] truncate flex-1" style="color:${a};">${p(u)}</span>
              </div>
            </div>
          </div>
  ...
  `}function nt(e,t){const s=e.statusBarWifi!==!1?`<span class="text-[11px]">${gs}</span>`:"",n=zs(e.statusBarSignal||4),i=Bs(e.statusBarBattery!==void 0?e.statusBarBattery:100);return`
  ...
  `}function Es(e,t){const s=e.chatBg?`url(${e.chatBg})`:e.mockupTheme==="light"?"url(/whatsapp-bg-light.png)":"linear-gradient(rgba(11, 20, 26, 0.94), rgba(11, 20, 26, 0.94)), url(/whatsapp-bg-dark.png)",n=e.chatBg?"cover":"360px",i=e.chatBg?"no-repeat":"repeat";return`
  ...
  `:"";(N=e.reactions)!=null&&N[0]&&(h+=" pb-[11px]");const L=e.image?`<img src="${e.image}" class="w-full max-w-[280px] rounded-lg mb-1 object-cover shadow-[inset_0_0_1px_rgba(0,0,0,0.15)]" style="max-height: 200px" />`:"";let T="";i&&(u==="read"?T=Ee:u==="delivered"?T=Se:u==="sent"&&(T=je));const R=u==="unread",I=R?"font-semibold":"",S=R?`<span class="inline-flex ml-1 -mb-0.5">${ms}</span>`:"";return`
  ...
  `}function js(e){if(e.viewMode==="desktop"){Ls(e);return}const t=te(e),s=document.getElementById("wa-statusbar");s&&(s.outerHTML=nt(e,t)),_("wa-contact-name",o=>{o.textContent=e.username}),_("wa-status-text",o=>{o.textContent=e.statusText||"online"}),_("wa-statusbar-time",o=>{o.textContent=e.statusBarTime||"09:41"});const n=document.getElementById("wa-avatar");if(n)if(e.avatar){const o=document.createElement("img");o.id="wa-avatar",o.src=e.avatar,o.className="w-full h-full rounded-full object-cover",o.alt="",n.replaceWith(o)}else{const o=document.createElement("div");o.id="wa-avatar",o.className="w-full h-full rounded-full bg-[#2c2c2c] flex items-center justify-center",o.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="#8696a0"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>',n.replaceWith(o)}const i=document.getElementById("wa-messages");if(i){const o=te(e);i.innerHTML=e.messages.map((a,l)=>ge(a,l,e,o)).join("")}const r=document.getElementById("wa-chat-container");if(r){const o=te(e),a=e.chatBg?`url(${e.chatBg})`:e.mockupTheme==="light"?"url(/whatsapp-bg-light.png)":"linear-gradient(rgba(11, 20, 26, 0.94), rgba(11, 20, 26, 0.94)), url(/whatsapp-bg-dark.png)",l=e.chatBg?"cover":"360px",c=e.chatBg?"no-repeat":"repeat";r.style.background=`var(--chat-bg, ${o.chatBg})`,r.style.backgroundImage=a,r.style.backgroundSize=l,r.style.backgroundRepeat=c}}function Ls(e){const t=te(e);_("wa-contact-name",l=>{l.textContent=e.username}),_("wa-contact-name-header",l=>{l.textContent=e.username}),_("wa-status-text",l=>{l.textContent=e.statusText||"online"});const s=e.messages[e.messages.length-1]||{text:"",time:""},n=s.text||(s.image?"📷 Photo":"");_("wa-chat-time",l=>{l.textContent=s.time||""});let i="";s.type==="sent"&&(s.status==="read"?i=Ee:s.status==="delivered"?i=Se:s.status==="sent"&&(i=je)),_("wa-chat-last-message",l=>{l.innerHTML=`${i?`<span class="inline-flex mr-1">${i}</span>`:""}${p(n)}`}),document.querySelectorAll("#wa-avatar").forEach(l=>{if(e.avatar){const c=document.createElement("img");c.id="wa-avatar",c.src=e.avatar,c.className="w-full h-full rounded-full object-cover",c.alt="",l.replaceWith(c)}else{const c=document.createElement("div");c.id="wa-avatar",c.className="w-full h-full rounded-full bg-[#2c2c2c] flex items-center justify-center",c.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="#8696a0"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>',l.replaceWith(c)}});const o=document.getElementById("wa-messages");o&&(o.innerHTML=e.messages.map((l,c)=>ge(l,c,e,t)).join(""));const a=document.getElementById("wa-chat-container");if(a){const l=e.chatBg?`url(${e.chatBg})`:e.mockupTheme==="light"?"url(/whatsapp-bg-light.png)":"linear-gradient(rgba(11, 20, 26, 0.94), rgba(11, 20, 26, 0.94)), url(/whatsapp-bg-dark.png)",c=e.chatBg?"cover":"360px",u=e.chatBg?"no-repeat":"repeat";a.style.background=`var(--chat-bg, ${t.chatBg})`,a.style.backgroundImage=l,a.style.backgroundSize=c,a.style.backgroundRepeat=u}}function _(e,t){const s=document.getElementById(e);s&&t(s)}const Is='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#e9edef" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>',ze='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#e9edef" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>',it='<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/></svg>',ot='<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.44 11.05l-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48"/></svg>',rt='<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/><line x1="8" y1="23" x2="16" y2="23"/></svg>',As='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><path d="M9 11.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm-3.3-3.3a4.5 4.5 0 0 1 6.6 0l-1.1 1.1a3 3 0 0 0-4.4 0L5.7 8.2zM2.9 5.1a8 8 0 0 1 12.2 0l-1.1 1.1a6.5 6.5 0 0 0-10 0L2.9 5.1z" fill="currentColor"/></svg>',Le='<svg width="14" height="14" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#ffffffd0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 5.5L9.5 9L16 1" stroke="#ffffffd0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" opacity="0.75"/></svg>',Ie='<svg width="14" height="14" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#ffffffd0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',_s=`url("data:image/svg+xml,%3Csvg width='200' height='200' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='30' cy='30' r='2' fill='white' opacity='0.04'/%3E%3Ccircle cx='100' cy='60' r='1.5' fill='white' opacity='0.03'/%3E%3Ccircle cx='170' cy='30' r='1' fill='white' opacity='0.04'/%3E%3Ccircle cx='50' cy='120' r='1.5' fill='white' opacity='0.03'/%3E%3Ccircle cx='150' cy='150' r='2' fill='white' opacity='0.04'/%3E%3Ccircle cx='80' cy='180' r='1' fill='white' opacity='0.03'/%3E%3Ccircle cx='20' cy='170' r='1.5' fill='white' opacity='0.03'/%3E%3C/svg%3E")`,Hs=`url("data:image/svg+xml,%3Csvg width='200' height='200' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='30' cy='30' r='2' fill='black' opacity='0.04'/%3E%3Ccircle cx='100' cy='60' r='1.5' fill='black' opacity='0.03'/%3E%3Ccircle cx='170' cy='30' r='1' fill='black' opacity='0.04'/%3E%3Ccircle cx='50' cy='120' r='1.5' fill='black' opacity='0.03'/%3E%3Ccircle cx='150' cy='150' r='2' fill='black' opacity='0.04'/%3E%3Ccircle cx='80' cy='180' r='1' fill='black' opacity='0.03'/%3E%3Ccircle cx='20' cy='170' r='1.5' fill='black' opacity='0.03'/%3E%3C/svg%3E")`,Ps={barBg:"#4e8ad4",chatBg:"#eef2f6",sentBg:"#8774e1",recvBg:"#ffffff",sentText:"#ffffff",recvText:"#000000",timeText:"#00000080",sentTimeText:"#ffffffb3",inputBg:"#ffffff",fieldBg:"#eef2f6",dotPattern:Hs},Ns={barBg:"#2f6ea5",chatBg:"#0f0f0f",sentBg:"#8774e1",recvBg:"#181818",sentText:"#ffffff",recvText:"#ffffff",timeText:"#ffffff8c",sentTimeText:"#ffffffb3",inputBg:"#1c1c1e",fieldBg:"#2a2a2e",dotPattern:_s};function se(e){return e.mockupTheme==="light"?Ps:Ns}function Os(e){return`<svg width="24" height="12" viewBox="0 0 26 12" fill="none" class="opacity-90"><rect x="0.5" y="0.5" width="22" height="11" rx="2" stroke="currentColor" fill="none"/><rect x="2" y="2" width="${Math.max(1,Math.min(19.5,e/100*19.5))}" height="8" rx="1.5" fill="currentColor"/><rect x="24" y="3.5" width="2" height="5" rx="0.75" fill="currentColor"/></svg>`}function Gs(e){const t=e>=1?"1":"0.3",s=e>=2?"1":"0.3",n=e>=3?"1":"0.3",i=e>=4?"1":"0.3";return`<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><rect x="1" y="8" width="2" height="3" rx="0.4" fill="currentColor" opacity="${t}"/><rect x="5" y="5" width="2" height="6" rx="0.4" fill="currentColor" opacity="${s}"/><rect x="9" y="2.5" width="2" height="8.5" rx="0.4" fill="currentColor" opacity="${n}"/><rect x="13" y="0.5" width="2" height="10.5" rx="0.4" fill="currentColor" opacity="${i}"/></svg>`}function Rs(e){const t=se(e);if(e.viewMode==="desktop")return Fs(e,t);const s=e.mockupTheme==="light"?"#ffffff":"#121212";return`
    <div id="mockup-card" class="mx-auto" style="width:390px; height:844px;font-family:${e.fontFamily};">
      <div class="w-full h-full overflow-hidden rounded-[2.5rem] border-8 flex flex-col" style="border-color:${s};background:${s}">
        ${at(e,t)}
        ${Vs(e,t)}
        ...
        <div class="flex-1 overflow-y-auto flex flex-col">
          <div class="flex gap-3 px-3 py-2.5 cursor-pointer select-none" style="background:${r};">
            ...
            <div class="flex-1 min-w-0 flex flex-col justify-center">
              ...
              <div class="flex items-center gap-1 mt-0.5">
                ${g?`<span class="inline-flex">${g}</span>`:""}
                <span id="tg-chat-last-message" class="text-[13px] truncate flex-1" style="color:${a};">${p(u)}</span>
              </div>
            </div>
          </div>
  ...
  `}function at(e,t){const s=e.statusBarWifi!==!1?`<span class="text-[11px]">${As}</span>`:"",n=Gs(e.statusBarSignal||4),i=Os(e.statusBarBattery!==void 0?e.statusBarBattery:100);return`
    ...
    <div class="flex ${g} ${E} relative">
      <div class="relative max-w-[80%]">
        <div class="${y} ${k} shadow-[0_1px_1px_rgba(0,0,0,0.1)]" style="background:${c}">
          ${T}
          ${I}
          ${e.text?`<p class="text-[14.5px]/[1.4] whitespace-pre-wrap break-words" style="color:${u}">${p(e.text)}</p>`:""}
          <div class="flex items-center justify-end gap-1 mt-0.5 select-none">
  ...
  `}function Ks(e){if(e.viewMode==="desktop"){Ds(e);return}const t=se(e),s=document.getElementById("tg-statusbar");s&&(s.outerHTML=at(e,t)),H("tg-contact-name",o=>{o.textContent=e.username}),H("tg-status-text",o=>{o.textContent=e.statusText||"online"}),H("tg-statusbar-time",o=>{o.textContent=e.statusBarTime||"09:41"});const n=document.getElementById("tg-avatar");if(n)if(e.avatar){const o=document.createElement("img");o.id="tg-avatar",o.src=e.avatar,o.className="w-full h-full rounded-full object-cover",o.alt="",n.replaceWith(o)}else{const o=document.createElement("div");o.id="tg-avatar",o.className="w-full h-full rounded-full bg-[#527da3] flex items-center justify-center",o.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="#e9edef"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>',n.replaceWith(o)}const i=document.getElementById("tg-messages");if(i){const o=se(e);i.innerHTML=e.messages.map((a,l)=>xe(a,l,e,o)).join("")}const r=document.getElementById("tg-chat-container");if(r){const o=se(e);r.style.background=`var(--chat-bg, ${o.chatBg})`,e.chatBg?(r.style.backgroundImage=`url(${e.chatBg})`,r.style.backgroundSize="cover"):(r.style.backgroundImage=o.dotPattern,r.style.backgroundSize="")}}function Ds(e){const t=se(e);H("tg-contact-name",l=>{l.textContent=e.username}),H("tg-contact-name-header",l=>{l.textContent=e.username}),H("tg-status-text",l=>{l.textContent=e.statusText||"online"});const s=e.messages[e.messages.length-1]||{text:"",time:""},n=s.text||(s.image?"📷 Photo":"");H("tg-chat-time",l=>{l.textContent=s.time||""});let i="";s.type==="sent"&&(s.status==="read"||s.status==="delivered"?i=Le:s.status==="sent"&&(i=Ie)),H("tg-chat-last-message",l=>{l.innerHTML=`${i?`<span class="inline-flex mr-1">${i}</span>`:""}${p(n)}`}),document.querySelectorAll("#tg-avatar").forEach(l=>{if(e.avatar){const c=document.createElement("img");c.id="tg-avatar",c.src=e.avatar,c.className="w-full h-full rounded-full object-cover",c.alt="",l.replaceWith(c)}else{const c=document.createElement("div");c.id="tg-avatar",c.className="w-full h-full rounded-full bg-[#527da3] flex items-center justify-center text-white text-[13px] font-bold",c.textContent=e.username.slice(0,2),l.replaceWith(c)}});const o=document.getElementById("tg-messages");o&&(o.innerHTML=e.messages.map((l,c)=>xe(l,c,e,t)).join(""));const a=document.getElementById("tg-chat-container");a&&(a.style.background=`var(--chat-bg, ${t.chatBg})`,e.chatBg?(a.style.backgroundImage=`url(${e.chatBg})`,a.style.backgroundSize="cover"):(a.style.backgroundImage=t.dotPattern,a.style.backgroundSize=""))}function H(e,t){const s=document.getElementById(e);s&&t(s)}const qs='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#e9edef" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>',lt='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/></svg>',ct='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',Js='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><path d="M9 11.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm-3.3-3.3a4.5 4.5 0 0 1 6.6 0l-1.1 1.1a3 3 0 0 0-4.4 0L5.7 8.2zM2.9 5.1a8 8 0 0 1 12.2 0l-1.1 1.1a6.5 6.5 0 0 0-10 0L2.9 5.1z" fill="currentColor"/></svg>',dt='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/></svg>',Ys='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.44 11.05l-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48"/></svg>',pt='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/><line x1="8" y1="23" x2="16" y2="23"/></svg>',Xs='<svg width="14" height="14" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#ffffffd0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 5.5L9.5 9L16 1" stroke="#ffffffd0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" opacity="0.75"/></svg>',Zs='<svg width="14" height="14" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#ffffffb3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',Qs={barBg:"#3b82f6",chatBg:"#f0f2f5",sentBg:"#3b82f6",recvBg:"#ffffff",sentText:"#ffffff",recvText:"#111b21",timeText:"#00000080",sentTimeText:"#ffffffb3",inputBg:"#f0f2f5",fieldBg:"#ffffff",fieldText:"#111b21",placeholder:"#8696a0"},en={barBg:"#1e1f22",chatBg:"#101214",sentBg:"#3b82f6",recvBg:"#2b2d30",sentText:"#ffffff",recvText:"#e9edef",timeText:"#ffffff8c",sentTimeText:"#ffffffb3",inputBg:"#1e1f22",fieldBg:"#2b2d30",fieldText:"#e9edef",placeholder:"#8696a0"};function ce(e){return e.mockupTheme==="light"?Qs:en}function tn(e){return`<svg width="24" height="12" viewBox="0 0 26 12" fill="none" class="opacity-90"><rect x="0.5" y="0.5" width="22" height="11" rx="2" stroke="currentColor" fill="none"/><rect x="2" y="2" width="${Math.max(1,Math.min(19.5,e/100*19.5))}" height="8" rx="1.5" fill="currentColor"/><rect x="24" y="3.5" width="2" height="5" rx="0.75" fill="currentColor"/></svg>`}function sn(e){const t=e>=1?"1":"0.3",s=e>=2?"1":"0.3",n=e>=3?"1":"0.3",i=e>=4?"1":"0.3";return`<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><rect x="1" y="8" width="2" height="3" rx="0.4" fill="currentColor" opacity="${t}"/><rect x="5" y="5" width="2" height="6" rx="0.4" fill="currentColor" opacity="${s}"/><rect x="9" y="2.5" width="2" height="8.5" rx="0.4" fill="currentColor" opacity="${n}"/><rect x="13" y="0.5" width="2" height="10.5" rx="0.4" fill="currentColor" opacity="${i}"/></svg>`}function nn(e){const t=ce(e);if(e.viewMode==="desktop")return on(e,t);const s=e.mockupTheme==="light"?"#ffffff":"#121212";return`
    <div id="mockup-card" class="mx-auto" style="width:390px; height:844px;font-family:${e.fontFamily};">
      <div class="w-full h-full overflow-hidden rounded-[2.5rem] border-8 flex flex-col" style="border-color:${s};background:${s}">
        ${ft(e,t)}
        ${rn(e,t)}
    ...
    <div id="mockup-card" class="mx-auto flex rounded-xl overflow-hidden shadow-2xl border" style="width:1000px; height:700px; font-family:${e.fontFamily}; border-color:${o}; background:${n}; color:${l};">
        ...
        <div class="flex-1 overflow-y-auto flex flex-col">
          <div class="flex gap-3 px-3 py-2.5 cursor-pointer select-none" style="background:${r};">
            ...
            <div class="flex-1 min-w-0 flex flex-col justify-center">
              ...
              <div class="flex items-center gap-1 mt-0.5">
                <span id="sg-chat-last-message" class="text-[13px] truncate flex-1" style="color:${a};">${p(u)}</span>
              </div>
            </div>
          </div>
          <div class="flex gap-3 px-3 py-2.5 cursor-pointer select-none opacity-40 hover:opacity-60 transition-opacity">
      ...
      <div class="flex-1 flex flex-col min-w-0">
        ...
        <div class="p-3 shrink-0 flex items-center gap-3 border-l" style="background:${i}; border-color:${o}; text-align: left;">
          ...
          <span style="color:${a};">${dt}</span>
          <span style="color:${a};">${pt}</span>
        </div>
      </div>
    </div>
  `}function ft(e,t){const s=e.statusBarWifi!==!1?`<span class="text-[11px]">${Js}</span>`:"",n=sn(e.statusBarSignal||4),i=tn(e.statusBarBattery!==void 0?e.statusBarBattery:100);return`
  ...
  `:"";let T="px-3.5 py-1.5";(A=e.reactions)!=null&&A[0]&&(T="px-3.5 pt-1.5 pb-[10px]");const R=e.image?`<img src="${e.image}" class="w-full max-w-[280px] rounded-lg mb-1 object-cover shadow-[inset_0_0_1px_rgba(0,0,0,0.15)]" style="max-height: 200px" />`:"";let I="";return i&&(h==="read"||h==="delivered"?I=Xs:h==="sent"&&(I=Zs)),`
  ...
  `}function ln(e){return`
    <div class="flex items-center gap-2 px-3 py-2 shrink-0" style="background:${e.inputBg}">
      <span>${dt}</span>
          ...
          `}function cn(e){if(e.viewMode==="desktop"){dn(e);return}const t=ce(e),s=document.getElementById("sg-statusbar");s&&(s.outerHTML=ft(e,t)),O("sg-contact-name",o=>{o.textContent=e.username}),O("sg-status-text",o=>{o.textContent=e.statusText||"online"});const n=document.getElementById("sg-avatar");if(n)if(e.avatar){const o=document.createElement("img");o.id="sg-avatar",o.src=e.avatar,o.className="w-full h-full rounded-full object-cover",o.alt="",n.replaceWith(o)}else{const o=document.createElement("div");o.id="sg-avatar",o.className="w-full h-full rounded-full bg-[#2c2c2c] flex items-center justify-center",o.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="#8696a0"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>',n.replaceWith(o)}const i=document.getElementById("sg-messages");if(i){const o=ce(e);i.innerHTML=e.messages.map((a,l)=>he(a,l,e,o)).join("")}const r=document.getElementById("sg-chat-container");r&&(r.style.background=`var(--chat-bg, ${t.chatBg})`,e.chatBg?(r.style.backgroundImage=`url(${e.chatBg})`,r.style.backgroundSize="cover"):r.style.backgroundImage="")}function dn(e){const t=ce(e);O("sg-contact-name",a=>{a.textContent=e.username}),O("sg-contact-name-header",a=>{a.textContent=e.username}),O("sg-status-text",a=>{a.textContent=e.statusText||"online"});const s=e.messages[e.messages.length-1]||{text:"",time:""},n=s.text||(s.image?"📷 Photo":"");O("sg-chat-time",a=>{a.textContent=s.time||""}),O("sg-chat-last-message",a=>{a.textContent=n}),document.querySelectorAll("#sg-avatar").forEach(a=>{if(e.avatar){const l=document.createElement("img");l.id="sg-avatar",l.src=e.avatar,l.className="w-full h-full rounded-full object-cover",l.alt="",a.replaceWith(l)}else{const l=document.createElement("div");l.id="sg-avatar",l.className="w-full h-full rounded-full bg-[#2c2c2c] flex items-center justify-center text-white text-[13px] font-bold",l.textContent=e.username.slice(0,2),a.replaceWith(l)}});const r=document.getElementById("sg-messages");r&&(r.innerHTML=e.messages.map((a,l)=>he(a,l,e,t)).join(""));const o=document.getElementById("sg-chat-container");o&&(o.style.background=`var(--chat-bg, ${t.chatBg})`,e.chatBg?(o.style.backgroundImage=`url(${e.chatBg})`,o.style.backgroundSize="cover"):o.style.backgroundImage="")}function O(e,t){const s=document.getElementById(e);s&&t(s)}const pn='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>',fn='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>',un='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><path d="M9 11.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm-3.3-3.3a4.5 4.5 0 0 1 6.6 0l-1.1 1.1a3 3 0 0 0-4.4 0L5.7 8.2zM2.9 5.1a8 8 0 0 1 12.2 0l-1.1 1.1a6.5 6.5 0 0 0-10 0L2.9 5.1z" fill="currentColor"/></svg>',gn={barBg:"#f8f8f8",chatBg:"#ffffff",sentBg:"#007aff",recvBg:"#e5e5ea",sentText:"#ffffff",recvText:"#000000",timeText:"#8e8e93",inputBg:"#f8f8f8",fieldBg:"#e5e5ea",fieldText:"#000000",statusColor:"#000000",navColor:"#007aff"},xn={barBg:"#1c1c1e",chatBg:"#000000",sentBg:"#0a84ff",recvBg:"#262629",sentText:"#ffffff",recvText:"#ffffff",timeText:"#8e8e93",inputBg:"#1c1c1e",fieldBg:"#2c2c2e",fieldText:"#ffffff",statusColor:"#ffffff",navColor:"#ffffff"};function de(e){const t=e.imessageMode==="sms",s=e.mockupTheme==="light"?{...gn}:{...xn};return t&&(s.sentBg=e.mockupTheme==="light"?"#34c759":"#30d158",s.navColor=e.mockupTheme==="light"?"#34c759":"#ffffff"),s}function hn(e){return`<svg width="24" height="12" viewBox="0 0 26 12" fill="none" class="opacity-90"><rect x="0.5" y="0.5" width="22" height="11" rx="2" stroke="currentColor" fill="none"/><rect x="2" y="2" width="${Math.max(1,Math.min(19.5,e/100*19.5))}" height="8" rx="1.5" fill="currentColor"/><rect x="24" y="3.5" width="2" height="5" rx="0.75" fill="currentColor"/></svg>`}function mn(e){const t=e>=1?"1":"0.3",s=e>=2?"1":"0.3",n=e>=3?"1":"0.3",i=e>=4?"1":"0.3";return`<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><rect x="1" y="8" width="2" height="3" rx="0.4" fill="currentColor" opacity="${t}"/><rect x="5" y="5" width="2" height="6" rx="0.4" fill="currentColor" opacity="${s}"/><rect x="9" y="2.5" width="2" height="8.5" rx="0.4" fill="currentColor" opacity="${n}"/><rect x="13" y="0.5" width="2" height="10.5" rx="0.4" fill="currentColor" opacity="${i}"/></svg>`}function vn(e){const t=de(e);if(e.viewMode==="desktop")return bn(e,t);const s=e.mockupTheme==="light"?"#e5e5ea":"#1c1c1e";return`
    <div id="mockup-card" class="mx-auto" style="width:390px; height:844px;font-family:${e.fontFamily};">
      <div class="w-full h-full overflow-hidden rounded-[2.5rem] border-8 flex flex-col" style="border-color:${s};background:${s}">
        ${ut(e,t)}
        ${gt(e,t)}
        ...
        <div class="flex-1 overflow-y-auto flex flex-col">
          <div class="flex gap-3 px-3 py-2.5 cursor-pointer select-none" style="background:${r}; color:#ffffff;">
            ...
            <div class="flex-1 min-w-0 flex flex-col justify-center">
              ...
              <div class="flex items-center gap-1 mt-0.5">
                <span id="im-chat-last-message" class="text-[13px] truncate flex-1 opacity-90">${p(u)}</span>
              </div>
            </div>
          </div>
          <div class="flex gap-3 px-3 py-2.5 cursor-pointer select-none opacity-40 hover:opacity-60 transition-opacity">
  ...
  `}function ut(e,t){const s=e.statusBarWifi!==!1?`<span class="text-[11px]">${un}</span>`:"",n=mn(e.statusBarSignal||4),i=hn(e.statusBarBattery!==void 0?e.statusBarBattery:100);return`
  ...
  `}function gt(e,t){return`
    <div id="im-navbar" class="flex items-center gap-1 px-2 py-1.5 shrink-0 border-b border-black/[5%] relative z-10" style="background:${t.barBg};color:${t.navColor}">
      <span class="shrink-0 px-1">${pn}</span>
  ...
  `}function me(e,t,s,n){var M,L;const i=e.type==="sent",r=t>0?s.messages[t-1]:null,o=t<s.messages.length-1?s.messages[t+1]:null,a=!r||r.type!==e.type,l=!o||o.type!==e.type,c=i?n.sentBg:n.recvBg,u=i?n.sentText:n.recvText,x=i?"justify-end":"justify-start";let g="",h="rounded-[18px]",m=a?"mt-2.5":"mt-[2px]";l&&(i?(h="rounded-[18px] rounded-br-[4px]",g=`<span class="absolute bottom-0 -right-[5px] w-[10px] h-[15px]" style="color:${c}">
    ...
    <div class="flex flex-col ${x} ${m}">
      ...
      <div class="relative max-w-[75%]">
        ...
        <div class="${h} px-3.5 py-2" style="background:${c}">
          ${C}
          ${e.text?`<p class="text-[15.5px]/[1.35] whitespace-pre-wrap break-words" style="color:${u}">${p(e.text)}</p>`:""}
        </div>
        ${g}
      </div>
      ${y}
    </div>
  `}function xt(e,t){const s=e.imessageMode==="sms"?"Text Message":"iMessage";return`
  ...
  `}function wn(e){if(e.viewMode==="desktop"){$n(e);return}const t=de(e),s=document.getElementById("im-statusbar");s&&(s.outerHTML=ut(e,t));const n=document.getElementById("im-navbar");n&&(n.outerHTML=gt(e,t));const i=document.getElementById("im-inputbar");i&&(i.outerHTML=xt(e,t)),ee("im-contact-name",l=>{l.textContent=e.username});const r=document.getElementById("im-avatar");if(r)if(e.avatar){const l=document.createElement("img");l.id="im-avatar",l.src=e.avatar,l.className="w-full h-full rounded-full object-cover",l.alt="",r.replaceWith(l)}else{const l=document.createElement("div");l.id="im-avatar",l.className="w-full h-full rounded-full bg-[#2c2c2c] flex items-center justify-center",l.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="#8e8e93"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>',r.replaceWith(l)}const o=document.getElementById("im-messages");if(o){const l=de(e);o.innerHTML=e.messages.map((c,u)=>me(c,u,e,l)).join("")}const a=document.getElementById("im-chat-container");a&&(a.style.background=`var(--chat-bg, ${t.chatBg})`,e.chatBg?(a.style.backgroundImage=`url(${e.chatBg})`,a.style.backgroundSize="cover"):a.style.backgroundImage="")}function $n(e){const t=de(e);ee("im-contact-name",a=>{a.textContent=e.username}),ee("im-contact-name-header",a=>{a.textContent=e.username});const s=e.messages[e.messages.length-1]||{text:"",time:""},n=s.text||(s.image?"📷 Photo":"");ee("im-chat-time",a=>{a.textContent=s.time||""}),ee("im-chat-last-message",a=>{a.textContent=n}),document.querySelectorAll("#im-avatar").forEach(a=>{if(e.avatar){const l=document.createElement("img");l.id="im-avatar",l.src=e.avatar,l.className="w-full h-full rounded-full object-cover",l.alt="",a.replaceWith(l)}else{const l=document.createElement("div");l.id="im-avatar",l.className="w-full h-full rounded-full bg-[#8e8e93] flex items-center justify-center text-white text-[13px] font-bold",l.textContent=e.username.slice(0,2),a.replaceWith(l)}});const r=document.getElementById("im-messages");r&&(r.innerHTML=e.messages.map((a,l)=>me(a,l,e,t)).join(""));const o=document.getElementById("im-chat-container");o&&(o.style.background=`var(--chat-bg, ${t.chatBg})`,e.chatBg?(o.style.backgroundImage=`url(${e.chatBg})`,o.style.backgroundSize="cover"):o.style.backgroundImage="")}function ee(e,t){const s=document.getElementById(e);s&&t(s)}const b={koala:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><ellipse cx="12" cy="12" rx="8" ry="7.5"/><circle cx="7" cy="5" r="4"/><circle cx="17" cy="5" r="4"/><circle cx="9" cy="11" r="1.2" fill="#0d0a07"/><circle cx="15" cy="11" r="1.2" fill="#0d0a07"/><ellipse cx="12" cy="16" rx="2.5" ry="1.2"/></svg>',sun:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>',moon:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>',search:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>',download:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>',spinner:'<svg class="animate-spin" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2a10 10 0 0 1 10 10"/></svg>',check:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>',chevronDown:'<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>',github:'<svg width="20" height="20" viewBox="0 0 16 16" fill="currentColor"><path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0016 8c0-4.42-3.58-8-8-8z"/></svg>',sidebarToggle:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="9" y1="3" x2="9" y2="21"/></svg>',undo:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 2.13-9.36L1 10"/></svg>',redo:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 4 23 10 17 10"/><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"/></svg>',clipboard:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/></svg>',link:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>',folder:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg>',zoomIn:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><line x1="11" y1="8" x2="11" y2="14"/><line x1="8" y1="11" x2="14" y2="11"/></svg>',zoomOut:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><line x1="8" y1="11" x2="14" y2="11"/></svg>',dockRight:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="15" y1="3" x2="15" y2="21"/></svg>',dockBottom:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="3" y1="15" x2="21" y2="15"/></svg>',mobile:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"/><line x1="12" y1="18" x2="12.01" y2="18"/></svg>',desktop:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>'},kn={"from-slate-900 to-indigo-950":["#050508","#121020"],"from-sky-400 to-indigo-600":["#38bdf8","#4f46e5"],"from-rose-400 to-orange-600":["#fb7185","#ea580c"],"from-emerald-400 to-cyan-600":["#34d399","#0891b2"],"from-amber-400 to-red-600":["#fbbf24","#dc2626"],"from-violet-400 to-fuchsia-600":["#a78bfa","#c026d3"],"from-zinc-800 to-zinc-950":["#27272a","#09090b"]},Fe=[{label:"Default",value:"",colors:null},{label:"Warm",value:"#efeae2",colors:null},{label:"Cool",value:"#eef2f6",colors:null},{label:"Dark",value:"#0b141a",colors:null},{label:"Deep",value:"#101214",colors:null},{label:"Rose",value:"linear-gradient(135deg,#fce4ec,#f8bbd0)",colors:null},{label:"Sky",value:"linear-gradient(135deg,#e3f2fd,#bbdefb)",colors:null},{label:"Mint",value:"linear-gradient(135deg,#e8f5e9,#c8e6c9)",colors:null},{label:"Lavender",value:"linear-gradient(135deg,#f3e5f5,#e1bee7)",colors:null}],pe=[{id:"whatsapp",theme:"whatsapp",name:"WhatsApp",tag:"chat",svg:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 0 0-3.48-8.413z"/></svg>'},{id:"telegram",theme:"telegram",name:"Telegram",tag:"chat",svg:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0m4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635"/></svg>'},{id:"signal",theme:"signal",name:"Signal",tag:"chat",svg:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 0q-.934 0-1.83.139l.17 1.111a11 11 0 0 1 3.32 0l.172-1.111A12 12 0 0 0 12 0M9.152.34A12 12 0 0 0 5.77 1.742l.584.961a10.8 10.8 0 0 1 3.066-1.27zm5.696 0l-.268 1.094a10.8 10.8 0 0 1 3.066 1.27l.584-.962A12 12 0 0 0 14.848.34M12 2.25a9.75 9.75 0 0 0-8.539 14.459c.074.134.1.292.064.441l-1.013 4.338 4.338-1.013a.62.62 0 0 1 .441.064A9.7 9.7 0 0 0 12 21.75c5.385 0 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25m-7.092.068a12 12 0 0 0-2.59 2.59l.909.664a11 11 0 0 1 2.345-2.345zm14.184 0l-.664.909a11 11 0 0 1 2.345 2.345l.909-.664a12 12 0 0 0-2.59-2.59M1.742 5.77A12 12 0 0 0 .34 9.152l1.094.268a10.8 10.8 0 0 1 1.269-3.066zm20.516 0l-.961.584a10.8 10.8 0 0 1 1.27 3.066l1.093-.268a12 12 0 0 0-1.402-3.383M.138 10.168A12 12 0 0 0 0 12q0 .934.139 1.83l1.111-.17A11 11 0 0 1 1.125 12q0-.848.125-1.66zm23.723.002l-1.111.17q.125.812.125 1.66c0 .848-.042 1.12-.125 1.66l1.111.172a12.1 12.1 0 0 0 0-3.662M1.434 14.58l-1.094.268a12 12 0 0 0 .96 2.591l-.265 1.14 1.096.255.36-1.539-.188-.365a10.8 10.8 0 0 1-.87-2.35m21.133 0a10.8 10.8 0 0 1-1.27 3.067l.962.584a12 12 0 0 0 1.402-3.383zm-1.793 3.848a11 11 0 0 1-2.345 2.345l.664.909a12 12 0 0 0 2.59-2.59zm-19.959 1.1L.357 21.48a1.8 1.8 0 0 0 2.162 2.161l1.954-.455-.256-1.095-1.953.455a.675.675 0 0 1-.81-.81l.454-1.954zm16.832 1.769a10.8 10.8 0 0 1-3.066 1.27l.268 1.093a12 12 0 0 0 3.382-1.402zm-10.94.213l-1.54.36.256 1.095 1.139-.266c.814.415 1.683.74 2.591.961l.268-1.094a10.8 10.8 0 0 1-2.35-.869zm3.634 1.24l-.172 1.111a12.1 12.1 0 0 0 3.662 0l-.17-1.111q-.812.125-1.66.125a11 11 0 0 1-1.66-.125"/></svg>'},{id:"messenger",theme:"messenger",name:"Messenger",tag:"chat",svg:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.24 0 0 4.952 0 11.64c0 3.499 1.434 6.521 3.769 8.61a.96.96 0 0 1 .323.683l.065 2.135a.96.96 0 0 0 1.347.85l2.381-1.053a.96.96 0 0 1 .641-.046A13 13 0 0 0 12 23.28c6.76 0 12-4.952 12-11.64S18.76 0 12 0m6.806 7.44c.522-.03.971.567.63 1.094l-4.178 6.457a.707.707 0 0 1-.977.208l-3.87-2.504a.44.44 0 0 0-.49.007l-4.363 3.01c-.637.438-1.415-.317-.995-.966l4.179-6.457a.706.706 0 0 1 .977-.21l3.87 2.505c.15.097.344.094.491-.007l4.362-3.008a.7.7 0 0 1 .364-.13"/></svg>'},{id:"imessage",theme:"imessage",name:"iMessage",tag:"chat",svg:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M5.285 0A5.273 5.273 0 0 0 0 5.285v13.43A5.273 5.273 0 0 0 5.285 24h13.43A5.273 5.273 0 0 0 24 18.715V5.285A5.273 5.273 0 0 0 18.715 0ZM12 4.154a8.809 7.337 0 0 1 8.809 7.338A8.809 7.337 0 0 1 12 18.828a8.809 7.337 0 0 1-2.492-.303A8.656 7.337 0 0 1 5.93 19.93a9.929 7.337 0 0 0 1.54-2.155 8.809 7.337 0 0 1-4.279-6.283A8.809 7.337 0 0 1 12 4.154"/></svg>'},{id:"instagram",theme:"instagram",name:"Instagram",tag:"social",svg:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M7.0301.084c-1.2768.0602-2.1487.264-2.911.5634-.7888.3075-1.4575.72-2.1228 1.3877-.6652.6677-1.075 1.3368-1.3802 2.127-.2954.7638-.4956 1.6365-.552 2.914-.0564 1.2775-.0689 1.6882-.0626 4.947.0062 3.2586.0206 3.6671.0825 4.9473.061 1.2765.264 2.1482.5635 2.9107.308.7889.72 1.4573 1.388 2.1228.6679.6655 1.3365 1.0743 2.1285 1.38.7632.295 1.6361.4961 2.9134.552 1.2773.056 1.6884.069 4.9462.0627 3.2578-.0062 3.668-.0207 4.9478-.0814 1.28-.0607 2.147-.2652 2.9098-.5633.7889-.3086 1.4578-.72 2.1228-1.3881.665-.6682 1.0745-1.3378 1.3795-2.1284.2957-.7632.4966-1.636.552-2.9124.056-1.2809.0692-1.6898.063-4.948-.0063-3.2583-.021-3.6668-.0817-4.9465-.0607-1.2797-.264-2.1487-.5633-2.9117-.3084-.7889-.72-1.4568-1.3876-2.1228C21.2982 1.33 20.628.9208 19.8378.6165 19.074.321 18.2017.1197 16.9244.0645 15.6471.0093 15.236-.005 11.977.0014 8.718.0076 8.31.0215 7.0301.0839m.1402 21.6932c-1.17-.0509-1.8053-.2453-2.2287-.408-.5606-.216-.96-.4771-1.3819-.895-.422-.4178-.6811-.8186-.9-1.378-.1644-.4234-.3624-1.058-.4171-2.228-.0595-1.2645-.072-1.6442-.079-4.848-.007-3.2037.0053-3.583.0607-4.848.05-1.169.2456-1.805.408-2.2282.216-.5613.4762-.96.895-1.3816.4188-.4217.8184-.6814 1.3783-.9003.423-.1651 1.0575-.3614 2.227-.4171 1.2655-.06 1.6447-.072 4.848-.079 3.2033-.007 3.5835.005 4.8495.0608 1.169.0508 1.8053.2445 2.228.408.5608.216.96.4754 1.3816.895.4217.4194.6816.8176.9005 1.3787.1653.4217.3617 1.056.4169 2.2263.0602 1.2655.0739 1.645.0796 4.848.0058 3.203-.0055 3.5834-.061 4.848-.051 1.17-.245 1.8055-.408 2.2294-.216.5604-.4763.96-.8954 1.3814-.419.4215-.8181.6811-1.3783.9-.4224.1649-1.0577.3617-2.2262.4174-1.2656.0595-1.6448.072-4.8493.079-3.2045.007-3.5825-.006-4.848-.0608M16.953 5.5864A1.44 1.44 0 1 0 18.39 4.144a1.44 1.44 0 0 0-1.437 1.4424M5.8385 12.012c.0067 3.4032 2.7706 6.1557 6.173 6.1493 3.4026-.0065 6.157-2.7701 6.1506-6.1733-.0065-3.4032-2.771-6.1565-6.174-6.1498-3.403.0067-6.156 2.771-6.1496 6.1738M8 12.0077a4 4 0 1 1 4.008 3.9921A3.9996 3.9996 0 0 1 8 12.0077"/></svg>'},{id:"twitter",theme:"twitter",name:"X",tag:"social",svg:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>'},{id:"tiktok",theme:"tiktok",name:"TikTok",tag:"social",svg:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07"/></svg>'},{id:"discord",theme:"discord",name:"Discord",tag:"chat",svg:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M20.317 4.3698a19.7913 19.7913 0 0 0-4.8851-1.5152.0741.0741 0 0 0-.0785.0371c-.211.3753-.4447.8648-.6083 1.2495-1.8447-.2762-3.68-.2762-5.4868 0-.1636-.3933-.4058-.8742-.6177-1.2495a.077.077 0 0 0-.0785-.037 19.7363 19.7363 0 0 0-4.8852 1.515.0699.0699 0 0 0-.0321.0277C.5334 9.0458-.319 13.5799.0992 18.0578a.0824.0824 0 0 0 .0312.0561c2.0528 1.5076 4.0413 2.4228 5.9929 3.0294a.0777.0777 0 0 0 .0842-.0276c.4616-.6304.8731-1.2952 1.226-1.9942a.076.076 0 0 0-.0416-.1057c-.6528-.2476-1.2743-.5495-1.8722-.8923a.077.077 0 0 1-.0076-.1277c.1258-.0943.2517-.1923.3718-.2914a.0743.0743 0 0 1 .0776-.0105c3.9278 1.7933 8.18 1.7933 12.0614 0a.0739.0739 0 0 1 .0785.0095c.1202.099.246.1981.3728.2924a.077.077 0 0 1-.0066.1276 12.2986 12.2986 0 0 1-1.873.8914.0766.0766 0 0 0-.0407.1067c.3604.698.7719 1.3628 1.225 1.9932a.076.076 0 0 0 .0842.0286c1.961-.6067 3.9495-1.5219 6.0023-3.0294a.077.077 0 0 0 .0313-.0552c.5004-5.177-.8382-9.6739-3.5485-13.6604a.061.061 0 0 0-.0312-.0286zM8.02 15.3312c-1.1825 0-2.1569-1.0857-2.1569-2.419 0-1.3332.9555-2.4189 2.157-2.4189 1.2108 0 2.1757 1.0952 2.1568 2.419 0 1.3332-.9555 2.4189-2.1569 2.4189zm7.9748 0c-1.1825 0-2.1569-1.0857-2.1569-2.419 0-1.3332.9554-2.4189 2.1569-2.4189 1.2108 0 2.1757 1.0952 2.1568 2.419 0 1.3332-.946 2.4189-2.1568 2.4189"/></svg>'}],ht={"social-post":{render:X,sync:Z},messenger:{render:X,sync:Z},instagram:{render:X,sync:Z},twitter:{render:X,sync:Z},tiktok:{render:X,sync:Z},discord:{render:as,sync:ls},whatsapp:{render:Cs,sync:js},telegram:{render:Rs,sync:Ks},signal:{render:nn,sync:cn},imessage:{render:vn,sync:wn}};let w=d.get("theme"),be=!1,Ce=!1;function mt(){return{"social-post":f("sidebar.socialPost"),messenger:f("sidebar.socialPost"),instagram:f("sidebar.socialPost"),twitter:f("sidebar.socialPost"),tiktok:f("sidebar.socialPost"),discord:f("sidebar.discord"),whatsapp:"WhatsApp",telegram:"Telegram",signal:"Signal",imessage:"iMessage"}[w]||w}const Ve=Te(),Bn={de:"Deutsch",en:"English",es:"Español"};function We(e){return e==="de"?"🇩🇪":e==="en"?"🇬🇧":e==="es"?"🇪🇸":""}function zn(e){return d.getSidebarOpen(),`
    <header class="h-14 shrink-0 flex items-center justify-between px-5 border-b border-white/[5%] bg-[#0d0a07]/80 backdrop-blur-xl relative z-50">
      <div class="flex items-center gap-3">
        ...
        <span class="text-sm font-bold tracking-tight hidden sm:inline">${f("app.name")}</span>
        <button id="btn-sidebar-toggle" aria-label="${f("topbar.toggleSidebar")}"
          class="rounded-full p-1.5 text-zinc-500 hover:text-zinc-200 hover:bg-white/5 transition-all ml-2">
          ${b.sidebarToggle}
        </button>
      </div>
      <div class="flex items-center gap-1.5">
        <button id="btn-undo" aria-label="${f("topbar.undo")}"
        ...
        <button id="btn-redo" aria-label="${f("topbar.redo")}"
          class="rounded-full p-1.5 text-zinc-500 hover:text-zinc-200 hover:bg-white/5 transition-all disabled:opacity-30 disabled:pointer-events-none"
          ${d.canRedo()?"":"disabled"}>
          ${b.redo}
        </button>
        <div class="relative flex" id="export-dropdown-container">
          <button id="btn-topbar-export" aria-label="${f("topbar.export")}"
            ...
            <span id="btn-export-label">${f("topbar.export")}</span>
          </button>
          <button id="btn-export-chevron" aria-label="${f("topbar.more")}"
          ...
          <div id="export-dropdown" class="absolute right-0 top-full mt-1 z-50 hidden min-w-[200px] rounded-xl border border-white/10 bg-[#1a1714]/95 backdrop-blur-2xl py-1 shadow-2xl shadow-black/50">
            <button data-export-action="png" class="flex items-center gap-2.5 w-full px-3 py-2 text-xs text-zinc-300 hover:bg-white/5 hover:text-white transition-all text-left">
              ${b.download} <span>${f("topbar.exportPng")}</span>
            </button>
            <button data-export-action="clipboard" class="flex items-center gap-2.5 w-full px-3 py-2 text-xs text-zinc-300 hover:bg-white/5 hover:text-white transition-all text-left">
              ${b.clipboard} <span>${f("topbar.exportClipboard")}</span>
            </button>
            <button data-export-action="share" class="flex items-center gap-2.5 w-full px-3 py-2 text-xs text-zinc-300 hover:bg-white/5 hover:text-white transition-all text-left">
              ${b.link} <span>${f("topbar.exportShare")}</span>
            </button>
          </div>
        </div>
        <button id="btn-start-tour" aria-label="${f("tutorial.restart")}"
          class="rounded-full bg-white/5 border border-white/10 px-3 py-1.5 text-xs text-zinc-400 hover:text-zinc-200 hover:border-white/20 transition-all mr-1">${f("tutorial.restart")}</button>
  ...
  `}function Cn(e){const t=d.getSidebarOpen(),n=Te()==="de"?"/de":"";return`
    <aside id="sidebar" class="shrink-0 h-full overflow-y-auto flex flex-col gap-4 transition-all duration-300 bg-[#0d0a07] border-white/[6%] z-40 fixed left-0 top-14 bottom-0 border-r md:relative md:top-0 md:translate-x-0
      ...
      <div id="app-library" class="rounded-2xl border border-white/[6%] bg-[#1a1714] p-4 flex flex-col gap-3">
        <div class="flex items-center justify-between cursor-pointer select-none" id="app-library-toggle">
          <span class="text-xs font-semibold text-zinc-300 tracking-wide">${f("sidebar.appLibrary")}</span>
          <div class="flex items-center gap-2">
            <span class="text-[10px] text-zinc-600">${pe.length} ${f("sidebar.apps")}</span>
        ...
        <div id="app-library-body">
          <div class="relative mb-2">
            ...
            <input type="text" placeholder="${f("sidebar.search")}"
          ...
          <div class="flex flex-col gap-1.5">
            ${pe.map(i=>{const r=i.theme===w;return`
                ...
                <div class="w-7 h-7 rounded-lg bg-white/[8%] flex items-center justify-center shrink-0 text-zinc-300">${i.svg}</div>
                  ...
                  <span class="text-[9px] text-zinc-600 uppercase tracking-wider">${i.tag==="chat"?f("canvas.chat"):f("canvas.social")}</span>
                </button>
              `}).join("")}
          </div>
        </div>
      ...
      <div id="settings-panel" class="rounded-2xl border border-white/[6%] bg-[#1a1714] p-4 flex flex-col gap-3">
        <div class="flex items-center justify-between cursor-pointer select-none" id="settings-toggle">
          <span id="settings-toggle-title" class="text-xs font-semibold text-zinc-300 tracking-wide">${f("sidebar.settings")} · <span class="text-zinc-500 font-normal normal-case">${mt()}</span></span>
          <span id="settings-chevron" class="text-zinc-500 transition-transform" style="transform: rotate(180deg)">${b.chevronDown}</span>
        </div>
  ...
  `}function vt(){const e=d.listTemplates();return`
    <div id="templates-section" class="rounded-2xl border border-white/[6%] bg-[#1a1714] p-4 flex flex-col gap-3">
      <div class="flex items-center justify-between">
        <span class="text-xs font-semibold text-zinc-300 tracking-wide">${f("templates.title")}</span>
        <span class="text-[10px] text-zinc-600">${e.length}</span>
      </div>
      <div class="flex items-center gap-2">
        <input id="input-template-name" type="text" placeholder="${f("templates.namePlaceholder")}"
        ...
        <button id="btn-template-save"
          class="rounded-xl bg-[#f97316] px-3 py-2 text-xs font-semibold text-white hover:bg-[#ea580c] transition-all shrink-0">${f("templates.save")}</button>
      </div>
      <div id="template-list" class="flex flex-col gap-1 max-h-[140px] overflow-y-auto">
        ${e.length===0?`<span class="text-[10px] text-zinc-600 text-center py-2">${f("templates.empty")}</span>`:e.map(t=>`
            <div class="flex items-center gap-1 group" data-tmpl-name="${t}">
              <span class="flex-1 text-xs text-zinc-400 truncate">${t}</span>
              <button data-tmpl-action="load" class="hidden group-hover:inline-flex px-2 py-0.5 rounded-lg text-[10px] text-zinc-500 hover:text-zinc-200 hover:bg-white/5 transition-all">${f("templates.load")}</button>
              <button data-tmpl-action="delete" class="hidden group-hover:inline-flex px-2 py-0.5 rounded-lg text-[10px] text-red-400 hover:text-red-300 hover:bg-red-500/10 transition-all">${f("templates.delete")}</button>
            </div>
          `).join("")}
      </div>
    </div>
  `}function bt(e){const t=["whatsapp","telegram","signal","imessage"].includes(w);let s="";return w==="discord"?s=`
      <label class="flex flex-col gap-1.5">
        <span class="text-[10px] uppercase tracking-wider text-zinc-500">${f("sidebar.labels.username")}</span>
      ...
      <label class="flex flex-col gap-1.5 mt-4">
        <span class="text-[10px] uppercase tracking-wider text-zinc-500">${f("sidebar.labels.roleColor")}</span>
        <div class="flex items-center gap-3">
      ...
      <label class="flex flex-col gap-1.5 mt-4">
        <span class="text-[10px] uppercase tracking-wider text-zinc-500">${f("sidebar.labels.timestamp")}</span>
      ...
      <label class="flex flex-col gap-1.5 mt-4">
        <span class="text-[10px] uppercase tracking-wider text-zinc-500">${f("sidebar.labels.statusText")}</span>
        <input id="input-statusText" type="text" value="${e.statusText||"online"}"
          class="rounded-xl border border-white/[6%] bg-white/[4%] px-3 py-2 text-sm text-zinc-200 placeholder:text-zinc-600 outline-0 focus:border-zinc-600 transition-colors" />
      </label>
      <label class="flex flex-col gap-1.5 mt-4">
        <span class="text-[10px] uppercase tracking-wider text-zinc-500">${f("sidebar.labels.statusBarTime")}</span>
      ...
      <div class="flex flex-col gap-2 mt-4">
        <span class="text-[10px] uppercase tracking-wider text-zinc-500">${f("sidebar.labels.message")}</span>
        <div id="wa-message-list" class="flex flex-col gap-2">
          ${e.messages.map((n,i)=>yt(n,i)).join("")}
        </div>
        <button id="btn-add-message"
          class="w-full rounded-xl border border-dashed border-white/[8%] py-2 text-xs text-zinc-500 hover:text-zinc-300 hover:border-white/20 transition-all">+ ${f("sidebar.addMessage")}</button>
      </div>`:s=`
      <label class="flex flex-col gap-1.5">
        <span class="text-[10px] uppercase tracking-wider text-zinc-500">${f("sidebar.labels.author")}</span>
        <input id="input-author" type="text" value="${e.author}"
          class="rounded-xl border border-white/[6%] bg-white/[4%] px-3 py-2 text-sm text-zinc-200 placeholder:text-zinc-600 outline-0 focus:border-zinc-600 transition-colors" />
      </label>
      <label class="flex flex-col gap-1.5 mt-4">
        <span class="text-[10px] uppercase tracking-wider text-zinc-500">${f("sidebar.labels.handle")}</span>
    ...
    <div id="settings-fields">
      ...
      <label class="flex flex-col gap-1.5 mt-4">
        <span class="text-[10px] uppercase tracking-wider text-zinc-500">${f("sidebar.labels.avatar")}</span>
  ...
  `}const Mn=[{id:"read",title:"Read",svg:'<svg width="13" height="13" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#53bdeb" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 5.5L9.5 9L16 1" stroke="#53bdeb" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" opacity="0.7"/></svg>'},{id:"delivered",title:"Delivered",svg:'<svg width="13" height="13" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 5.5L9.5 9L16 1" stroke="#8696a0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" opacity="0.7"/></svg>'},{id:"sent",title:"Sent",svg:'<svg width="13" height="13" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>'},{id:"unread",title:"Unread",svg:'<svg width="8" height="8" viewBox="0 0 8 8" fill="#53bdeb"><circle cx="4" cy="4" r="4"/></svg>'}];function yt(e,t){var g;const s=d.getState(),n=e.type==="sent",i=n?"bg-white text-zinc-900":"bg-white/[4%] text-zinc-500 hover:text-zinc-300",r=n?"bg-white/[4%] text-zinc-500 hover:text-zinc-300":"bg-white text-zinc-900",o=e.status||"read",a=s.isGroup&&!n?`
  ...
  `:"",l=((g=e.reactions)==null?void 0:g[0])||"",u=`
  ...
  `;return`
    <div draggable="true" data-msg-idx="${t}"
      ...
      <textarea data-msg-idx="${t}" rows="2"
        class="w-full rounded-lg border border-white/[6%] bg-white/[4%] px-2.5 py-1.5 text-xs text-zinc-200 placeholder:text-zinc-600 outline-0 focus:border-zinc-600 transition-colors resize-none" placeholder="${f("sidebar.messagePlaceholder")}">${p(e.text)}</textarea>
      ${a}
      ${u}
      ${x}
      <div class="flex items-center gap-1.5 mt-1.5">
        <button data-msg-idx="${t}" data-msg-type="sent"
          class="flex-1 py-1 rounded-lg text-[10px] font-medium transition-all ${i}">${f("sidebar.sent")}</button>
        <button data-msg-idx="${t}" data-msg-type="received"
          class="flex-1 py-1 rounded-lg text-[10px] font-medium transition-all ${r}">${f("sidebar.received")}</button>
        ${n?`
        ...
        <input type="text" data-msg-idx="${t}" data-msg-field="time" value="${p(e.time)}"
          class="w-14 rounded-lg border border-white/[6%] bg-white/[4%] px-2 py-1 text-[10px] text-zinc-200 text-center outline-0 focus:border-zinc-600 transition-colors" placeholder="${f("sidebar.timePlaceholder")}" />
        <button data-msg-idx="${t}" data-msg-action="delete"
          class="p-1 rounded-lg text-zinc-600 hover:text-red-400 hover:bg-red-500/10 transition-all" title="${f("sidebar.deleteMessage")}">
  ...
  `}function Tn(e){return`
    <label class="flex flex-col gap-1.5">
      <span class="text-[10px] uppercase tracking-wider text-zinc-500">${f("sidebar.labels.padding")}</span>
      <div class="flex items-center gap-3">
    ...
    <label class="flex flex-col gap-1.5">
      <span class="text-[10px] uppercase tracking-wider text-zinc-500">${f("sidebar.labels.background")}</span>
    ...
    <label class="flex flex-col gap-1.5 mt-4">
      <span class="text-[10px] uppercase tracking-wider text-zinc-500">${f("sidebar.labels.font")}</span>
    ...
    <label class="flex flex-col gap-1.5 mt-4">
      <span class="text-[10px] uppercase tracking-wider text-zinc-500">${f("sidebar.labels.uploadBg")}</span>
      <input id="input-chatbg" type="file" accept="image/*"
        class="text-xs text-zinc-500 file:mr-3 file:rounded-xl file:border-0 file:bg-white/10 file:px-3 file:py-1.5 file:text-xs file:text-zinc-200 file:font-medium hover:file:bg-white/15 transition-colors" />
    </label>
  `}function En(e){const t=d.get("_zoom")||0,s=d.get("_toolbarPos")||"right";return Sn(e,s,t)}function Sn(e,t,s){const n=t==="right"?b.dockBottom:b.dockRight,r=(e.viewMode||"mobile")==="desktop"?b.mobile:b.desktop;return`
  ...
  `,In(),P(),Pn();const n=d.get("_zoom")||0;kt(n)}function Ln(){const e=document.getElementById("btn-undo"),t=document.getElementById("btn-redo");e&&(e.disabled=!d.canUndo()),t&&(t.disabled=!d.canRedo())}function Ue(e){const t=document.getElementById("settings-toggle-title");t&&(t.innerHTML=`${f("sidebar.settings")} · <span class="text-zinc-500 font-normal normal-case">${mt()}</span>`);const s=document.getElementById("settings-body");s&&(s.innerHTML=bt(e),wt())}function In(){v("btn-topbar-export","click",()=>ye()),v("btn-export-chevron","click",Nn),v("btn-sidebar-toggle","click",we),v("btn-sidebar-open","click",we),v("sidebar-overlay","click",we),v("btn-undo","click",()=>d.undo()),v("btn-redo","click",()=>d.redo()),v("btn-mockup-theme","click",()=>{const n=d.get("mockupTheme")==="light"?"dark":"light";d.set("mockupTheme",n)}),v("btn-view-mode","click",()=>{const n=d.get("viewMode")==="desktop"?"mobile":"desktop";d.set("viewMode",n)}),v("lang-btn","click",n=>{n.stopPropagation(),document.getElementById("lang-dropdown").classList.toggle("hidden")}),document.addEventListener("click",()=>{const n=document.getElementById("lang-dropdown");n&&!n.classList.contains("hidden")&&n.classList.add("hidden")}),document.querySelectorAll("[data-lang]").forEach(n=>{n.addEventListener("click",()=>{const i=n.dataset.lang;window.location.href=i==="en"?"/":`/${i}/`})}),v("btn-start-tour","click",()=>qe()),v("btn-template-save","click",Vn),v("zoom-slider","input",Fn),v("btn-zoom-in","click",()=>$e(10)),v("btn-zoom-out","click",()=>$e(-10)),v("btn-toolbar-pos","click",()=>{const n=d.get("_toolbarPos")==="right"?"bottom":"right";d.set("_toolbarPos",n)}),document.querySelectorAll("[data-chat-bg]").forEach(n=>{n.addEventListener("click",()=>d.set("chatBgGradient",n.dataset.chatBg))}),document.querySelectorAll("[data-app]").forEach(n=>{n.addEventListener("click",()=>{const i=pe.find(r=>r.id===n.dataset.app);i&&d.set("theme",i.theme)})}),document.querySelectorAll("[data-export-action]").forEach(n=>{n.addEventListener("click",i=>{const r=n.dataset.exportAction;On(),r==="png"?ye():r==="clipboard"?Gn():r==="share"&&Rn()})}),document.querySelectorAll("[data-tmpl-action]").forEach(n=>{n.addEventListener("click",i=>{var a;const r=n.dataset.tmplAction,o=(a=n.closest("[data-tmpl-name]"))==null?void 0:a.dataset.tmplName;o&&(r==="load"?d.loadTemplate(o):r==="delete"&&(d.deleteTemplate(o),_e()))})});const e=document.getElementById("app-library-toggle");e&&e.addEventListener("click",()=>{const n=document.getElementById("app-library-body"),i=document.getElementById("app-library-chevron");if(!n)return;const r=n.style.display==="none";if(n.style.display=r?"":"none",i&&(i.style.transform=r?"rotate(0deg)":"rotate(180deg)"),!r){const o=document.getElementById("settings-body"),a=document.getElementById("settings-chevron");o&&o.style.display==="none"&&(o.style.display="",a&&(a.style.transform="rotate(0deg)"))}});const t=document.getElementById("settings-toggle");t&&t.addEventListener("click",()=>{const n=document.getElementById("settings-body"),i=document.getElementById("settings-chevron");if(!n)return;const r=n.style.display==="none";n.style.display=r?"":"none",i&&(i.style.transform=r?"rotate(0deg)":"rotate(180deg)")}),document.addEventListener("keydown",n=>{const i=n.metaKey||n.ctrlKey;i&&n.key==="z"&&!n.shiftKey&&(n.preventDefault(),d.undo()),i&&n.key==="z"&&n.shiftKey&&(n.preventDefault(),d.redo()),i&&n.key==="e"&&(n.preventDefault(),ye())});const s=document.getElementById("canvas");s&&s.addEventListener("wheel",n=>{(n.ctrlKey||n.metaKey)&&(n.preventDefault(),$e(n.deltaY>0?-5:5))},{passive:!1}),wt()}function wt(){v("input-padding","input",e=>{d.set("padding",Number(e.target.value));const t=document.getElementById("padding-value");t&&(t.textContent=e.target.value)}),v("input-font","change",e=>d.set("fontFamily",e.target.value)),v("input-chatbg","change",async e=>{var s;const t=(s=e.target.files)==null?void 0:s[0];if(t&&t.type.startsWith("image/")&&!(t.size>5*1024*1024))try{const n=await new Promise((i,r)=>{const o=new FileReader;o.onload=()=>i(o.result),o.onerror=r,o.readAsDataURL(t)});d.set("chatBg",n)}catch{}}),v("input-message","input",e=>d.set("message",e.target.value)),v("input-avatar","change",async e=>{var s;const t=(s=e.target.files)==null?void 0:s[0];if(t&&t.type.startsWith("image/")&&!(t.size>5*1024*1024))try{const n=d.get("avatar"),i=await It(t);n&&n.startsWith("blob:")&&URL.revokeObjectURL(n),d.set("avatar",i)}catch{d.set("avatar",null)}}),["messenger","instagram","twitter","tiktok","social-post"].includes(w)?(v("input-author","input",e=>d.set("author",e.target.value)),v("input-handle","input",e=>d.set("handle",e.target.value))):w==="discord"?(v("input-username","input",e=>d.set("username",e.target.value)),v("input-rolecolor","input",e=>d.set("roleColor",e.target.value)),v("input-timestamp","input",e=>d.set("timestamp",e.target.value))):["whatsapp","telegram","signal","imessage"].includes(w)&&(v("input-username","input",e=>d.set("username",e.target.value)),v("input-statusText","input",e=>d.set("statusText",e.target.value)),v("input-statusBarTime","input",e=>d.set("statusBarTime",e.target.value)),v("input-imessageMode","change",e=>d.set("imessageMode",e.target.value)),v("input-statusBarBattery","input",e=>{d.set("statusBarBattery",Number(e.target.value)),P()}),v("input-statusBarSignal","input",e=>{d.set("statusBarSignal",Number(e.target.value)),P()}),v("input-statusBarWifi","change",e=>d.set("statusBarWifi",e.target.checked)),v("input-isGroup","change",e=>{d.set("isGroup",e.target.checked),Ae()}),An())}function An(){const e=document.getElementById("btn-add-message");e&&(e.onclick=()=>{const n=[...d.get("messages")];n.push({id:Date.now(),text:"",type:d.get("waMode")||"sent",time:""}),d.set("messages",n),j(d.getState())});const t=document.getElementById("wa-message-list");if(!t)return;t.addEventListener("input",n=>{const i=n.target,r=parseInt(i.dataset.msgIdx);if(!isNaN(r)){if(i.tagName==="TEXTAREA"){const o=[...d.get("messages")];o[r]&&(o[r]={...o[r],text:i.value}),d.set("messages",o)}else if(i.dataset.msgField==="time"){const o=[...d.get("messages")];o[r]&&(o[r]={...o[r],time:i.value}),d.set("messages",o)}else if(i.dataset.msgField==="senderName"){const o=[...d.get("messages")];o[r]&&(o[r]={...o[r],senderName:i.value}),d.set("messages",o)}}}),t.addEventListener("change",async n=>{var r;const i=n.target;if(i.dataset.msgField==="imageUpload"){const o=parseInt(i.dataset.msgIdx);if(isNaN(o))return;const a=(r=i.files)==null?void 0:r[0];if(!a)return;try{const l=await new Promise((u,x)=>{const g=new FileReader;g.onload=()=>u(g.result),g.onerror=x,g.readAsDataURL(a)}),c=[...d.get("messages")];c[o]&&(c[o]={...c[o],image:l}),d.set("messages",c),j(d.getState())}catch{}}}),t.addEventListener("click",n=>{const i=n.target.closest("[data-msg-type], [data-msg-status], [data-msg-action], [data-msg-reaction], [data-msg-reaction-clear], [data-msg-image-clear]");if(!i)return;const r=parseInt(i.dataset.msgIdx);if(!isNaN(r)){if(i.dataset.msgType){const o=[...d.get("messages")];o[r]&&(o[r]={...o[r],type:i.dataset.msgType}),d.set("messages",o),j(d.getState())}else if(i.dataset.msgStatus){const o=[...d.get("messages")];o[r]&&(o[r]={...o[r],status:i.dataset.msgStatus}),d.set("messages",o),j(d.getState())}else if(i.dataset.msgReaction){const o=[...d.get("messages")];o[r]&&(o[r]={...o[r],reactions:[i.dataset.msgReaction]}),d.set("messages",o),j(d.getState())}else if(i.dataset.msgReactionClear){const o=[...d.get("messages")];o[r]&&(o[r]={...o[r],reactions:[]}),d.set("messages",o),j(d.getState())}else if(i.dataset.msgImageClear){const o=[...d.get("messages")];o[r]&&(o[r]={...o[r],image:null}),d.set("messages",o),j(d.getState())}else if(i.dataset.msgAction==="delete"){const o=d.get("messages").filter((a,l)=>l!==r);d.set("messages",o),j(d.getState())}}});let s=null;t.addEventListener("dragstart",n=>{const i=n.target.closest("[draggable]");i&&(s=parseInt(i.dataset.msgIdx),i.style.opacity="0.4")}),t.addEventListener("dragend",n=>{const i=n.target.closest("[draggable]");i&&(i.style.opacity=""),s=null}),t.addEventListener("dragover",n=>{n.preventDefault();const i=n.target.closest("[draggable]");i&&(i.style.borderColor="rgba(255,255,255,0.3)")}),t.addEventListener("dragleave",n=>{const i=n.target.closest("[draggable]");i&&(i.style.borderColor="")}),t.addEventListener("drop",n=>{n.preventDefault();const i=n.target.closest("[draggable]");if(!i)return;i.style.borderColor="";const r=parseInt(i.dataset.msgIdx);if(s===null||s===r)return;const o=[...d.get("messages")],[a]=o.splice(s,1);o.splice(r,0,a),d.set("messages",o),j(d.getState())})}function j(e){const t=document.getElementById("wa-message-list");t&&(t.innerHTML=e.messages.map((s,n)=>yt(s,n)).join(""))}function P(){const e=ht[w];if(!e)return;const t=d.getState(),s=document.getElementById("mockup");s&&(s.innerHTML=e.render(t)),Me(t),requestAnimationFrame(oe)}function _n(e,t,s){if(!be){be=!0;try{const n=ht[w];if(!n)return;if(e==="theme"){w=t;const i=Bt();i&&d.mutate({author:i.author||"",handle:i.handle||"",username:i.username||i.author||"",message:i.message||"",timestamp:i.time||"",roleColor:i.roleColor||"#5865F2",messages:i.messages||[{id:1,text:i.message||"",type:d.get("waMode")||"sent",time:i.time||"",status:"read"}]}),P(),Ue(d.getState()),Hn(t),Ht()&&requestAnimationFrame(()=>Ot());return}if(e==="bgGradient"&&Me(s),e==="chatBgGradient"){Me(s);return}if(e==="viewMode"){const i=document.getElementById("btn-view-mode");i&&(i.innerHTML=t==="desktop"?b.mobile:b.desktop),P(),oe();return}if(e==="mockupTheme"){const i=document.getElementById("btn-mockup-theme");i&&(i.innerHTML=t==="light"?b.sun:b.moon),P();return}if(e==="fontFamily"||e==="chatBg"){P();return}if(e==="waMode")return;if(e==="_zoom"){kt(t);return}if(e==="_toolbarPos"){jn(t);return}if(e==="_undo"||e==="_redo"){P(),Ue(d.getState()),Ln();return}e==="avatar"&&At(w==="discord"?"discord-avatar":w==="whatsapp"?"wa-avatar":"mockup-avatar"),n.sync(s)}finally{be=!1}}}function Hn(e){document.querySelectorAll("[data-app]").forEach(t=>{const s=pe.find(i=>i.id===t.dataset.app),n=s&&s.theme===e;t.className=`flex items-center gap-3 rounded-xl border p-2.5 transition-all text-left ${n?"border-white/15 bg-white/[8%]":"border-white/[4%] bg-white/[3%] hover:bg-white/[7%] hover:border-white/[8%]"}`})}function Me(e){const t=document.getElementById("canvas");if(t){const n=kn[e.bgGradient]||["#0f172a","#1e1b4b"],i="radial-gradient(rgba(255,255,255,0.035) 1px, transparent 1px)",r=`linear-gradient(135deg, ${n[0]}, ${n[1]})`;t.style.background=`${i}, ${r}`,t.style.backgroundSize="40px 40px, 100% 100%"}e.chatBgGradient?document.documentElement.style.setProperty("--chat-bg",e.chatBgGradient):document.documentElement.style.removeProperty("--chat-bg");const s=document.getElementById("mockup-card");s&&(e.chatBgGradient?s.style.setProperty("--chat-bg",e.chatBgGradient):s.style.removeProperty("--chat-bg"))}let ae=null;function Pn(){ae&&ae.disconnect();const e=document.getElementById("canvas");e&&(ae=new ResizeObserver(()=>{oe()}),ae.observe(e))}function oe(){if(Ce)return;const e=document.getElementById("canvas"),t=document.getElementById("mockup");if(!e||!t)return;const s=e.getBoundingClientRect(),n=document.getElementById("mockup-card");let i=390,r=844;n&&(i=parseInt(n.style.width)||n.offsetWidth||390,r=parseInt(n.style.height)||n.offsetHeight||844);const o=Math.min(s.width/i,s.height/r)*.8,l=1+(d.get("_zoom")||0)/100,c=o*l;t.style.transform=`translate(-50%, -50%) scale(${c})`}window.addEventListener("resize",oe);async function $t(e){const t=e.querySelectorAll("img"),s=[];for(const n of t)if(n.src&&n.src.startsWith("blob:")){s.push({img:n,src:n.src});try{const i=await new Promise((r,o)=>{const a=new Image;a.onload=()=>{const l=document.createElement("canvas");l.width=a.naturalWidth,l.height=a.naturalHeight;const c=l.getContext("2d");if(!c){o(new Error("Canvas 2D not supported"));return}c.drawImage(a,0,0),r(l.toDataURL("image/png"))},a.onerror=o,a.src=n.src});n.src=i}catch{n.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"}}return()=>{s.forEach(({img:n,src:i})=>{n.src=i})}}async function ye(){const e=document.getElementById("btn-topbar-export"),t=document.getElementById("btn-export-icon"),s=document.getElementById("btn-export-label");if(!e||e.disabled)return;Ce=!0,e.disabled=!0,t&&(t.innerHTML=b.spinner),s&&(s.textContent=f("topbar.rendering"));const n=document.getElementById("mockup-card");if(!n){a();return}const i=n.style.transform,r=n.style.transformOrigin;n.style.transform="",n.style.transformOrigin="",await new Promise(l=>requestAnimationFrame(l));let o;try{o=await $t(n);const{toPng:l}=await Ke(async()=>{const{toPng:m}=await import("./index-CgJtiJsK.js");return{toPng:m}},[]),c=await l(n,{pixelRatio:2});n.style.transform=i,n.style.transformOrigin=r;const u=new Date,x=`${u.getFullYear()}-${String(u.getMonth()+1).padStart(2,"0")}-${String(u.getDate()).padStart(2,"0")}_${String(u.getHours()).padStart(2,"0")}-${String(u.getMinutes()).padStart(2,"0")}-${String(u.getSeconds()).padStart(2,"0")}`,g=`koalasnap-${w}-${x}.png`,h=document.createElement("a");h.download=g,h.href=c,h.click(),t&&(t.innerHTML=b.check),s&&(s.textContent=f("topbar.exported")),e.classList.remove("bg-[#f97316]","hover:bg-[#ea580c]"),e.classList.add("bg-emerald-500","hover:bg-emerald-600"),setTimeout(a,2e3)}catch(l){n.style.transform=i,n.style.transformOrigin=r,console.error("Export failed:",(l==null?void 0:l.message)||l,(l==null?void 0:l.stack)||""),t&&(t.innerHTML=b.download),s&&(s.textContent=f("topbar.exportFailed")),e.disabled=!1,setTimeout(()=>{s&&(s.textContent=f("topbar.export")),t&&(t.innerHTML=b.download)},2e3)}finally{o&&o()}function a(){Ce=!1,e.disabled=!1,e.classList.remove("bg-emerald-500","hover:bg-emerald-600"),e.classList.add("bg-[#f97316]","hover:bg-[#ea580c]"),t&&(t.innerHTML=b.download),s&&(s.textContent=f("topbar.export"))}}function Nn(){const e=document.getElementById("export-dropdown");if(!e)return;const t=!e.classList.contains("hidden");e.classList.toggle("hidden",t)}function On(){const e=document.getElementById("export-dropdown");e&&e.classList.add("hidden")}async function Gn(){const e=document.getElementById("mockup-card");if(!e)return;const t=document.getElementById("btn-topbar-export"),s=document.getElementById("btn-export-icon"),n=document.getElementById("btn-export-label");t&&(t.disabled=!0),s&&(s.innerHTML=b.spinner),n&&(n.textContent=f("topbar.rendering"));const i=e.style.transform,r=e.style.transformOrigin;e.style.transform="",e.style.transformOrigin="";let o;try{o=await $t(e);const a=e.querySelectorAll('[style*="background-image"]'),l=[];a.forEach((x,g)=>{l[g]=x.style.backgroundImage,x.style.backgroundImage="none"}),await new Promise(x=>requestAnimationFrame(x));const{toBlob:c}=await Ke(async()=>{const{toBlob:x}=await import("./index-CgJtiJsK.js");return{toBlob:x}},[]),u=await c(e,{pixelRatio:2});e.style.transform=i,e.style.transformOrigin=r,a.forEach((x,g)=>{x.style.backgroundImage=l[g]}),u&&(await navigator.clipboard.write([new ClipboardItem({"image/png":u})]),U(f("topbar.copied")))}catch(a){console.error("Clipboard copy failed:",a),U(f("topbar.exportFailed"))}finally{o&&o()}t&&(t.disabled=!1),s&&(s.innerHTML=b.download),n&&(n.textContent=f("topbar.export"))}function Rn(){const e=d.getShareUrl();if(!e){U(f("topbar.exportFailed"));return}try{navigator.clipboard.writeText(e),U(f("topbar.linkCopied"))}catch{U(f("topbar.exportFailed"))}}function U(e){const t=document.getElementById("toast");t&&t.remove();const s=document.createElement("div");s.id="toast",s.className="fixed bottom-28 left-1/2 -translate-x-1/2 z-50 rounded-full bg-zinc-800/90 backdrop-blur-xl border border-white/10 px-5 py-2.5 text-sm text-zinc-200 shadow-2xl shadow-black/30 animate-fade-in",s.textContent=e,document.body.appendChild(s),setTimeout(()=>{s.style.opacity="0",s.style.transition="opacity 0.3s",setTimeout(()=>s.remove(),300)},2e3)}function we(){const t=!d.getSidebarOpen();d.setSidebarOpen(t),Ae()}function $e(e){const t=d.get("_zoom")||0,s=Math.max(-50,Math.min(100,t+e));d.set("_zoom",s)}function Fn(e){const t=parseInt(e.target.value);d.set("_zoom",t)}function kt(e){const t=document.getElementById("zoom-slider");t&&(t.value=e);const s=document.getElementById("zoom-label");s&&(s.textContent=e>0?`+${e}%`:`${e}%`),oe()}function _e(){const e=document.getElementById("templates-section");if(!e||!document.getElementById("sidebar"))return;const s=document.createElement("div");s.innerHTML=vt(),e.replaceWith(s.firstElementChild),document.querySelectorAll("[data-tmpl-action]").forEach(n=>{n.addEventListener("click",i=>{var a;const r=n.dataset.tmplAction,o=(a=n.closest("[data-tmpl-name]"))==null?void 0:a.dataset.tmplName;o&&(r==="load"?d.loadTemplate(o):r==="delete"&&(d.deleteTemplate(o),_e()))})})}function Vn(){const e=document.getElementById("input-template-name");if(!e||!e.value.trim())return;const t=e.value.trim();d.saveTemplate(t),e.value="",_e(),U(f("templates.saved"))}function v(e,t,s){var n;(n=document.getElementById(e))==null||n.addEventListener(t,s)}function Bt(){var r,o;const e=[{author:"Maya",handle:"@maya_99",username:"Maya",message:"Hey, are you coming online tonight?",time:"7:18 PM",roleColor:"#e81224",messages:[{text:"Hey, are you coming online tonight?",type:"sent",time:"7:18 PM"},{text:"Yeah, give me 5!",type:"received",time:"7:20 PM"},{text:"Sure, take your time 🐨",type:"sent",time:"7:21 PM"}]}],t=window.__LOCALE__,s=t!=null&&t.dummySets&&t.dummySets.length>0?t.dummySets:e,n=s[Math.floor(Math.random()*s.length)],i=n.messages&&n.messages.length>0?n.messages.map((a,l)=>({id:l+1,text:a.text,type:a.type,time:a.time,status:a.status||"read"})):[{id:1,text:n.message||"",type:d.get("waMode")||"sent",time:n.time||"",status:"read"}];return{author:n.author||"",handle:n.handle||"",username:n.username||n.author||"",message:n.message||((r=i[0])==null?void 0:r.text)||"",time:n.time||((o=i[0])==null?void 0:o.time)||"",roleColor:n.roleColor||"#5865F2",messages:i}}d.subscribe(_n);try{const e=localStorage.getItem("koalasnap_state"),t=Te();let s=!e;if(e)try{const n=JSON.parse(e);(!n.locale||n.locale!==t)&&(s=!0)}catch{s=!0}if(s){const n=Bt();n&&d.mutate({...n,locale:t})}}catch{}Ae();"serviceWorker"in navigator&&navigator.serviceWorker.register("/sw.js",{updateViaCache:"none"}).catch(()=>{});_t()||setTimeout(()=>qe(),800);
