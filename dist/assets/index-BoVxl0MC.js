(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function n(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(s){if(s.ep)return;s.ep=!0;const r=n(s);fetch(s.href,r)}})();const it="modulepreload",st=function(e){return"/"+e},be={},Me=function(t,n,i){let s=Promise.resolve();if(n&&n.length>0){let a=function(d){return Promise.all(d.map(u=>Promise.resolve(u).then(f=>({status:"fulfilled",value:f}),f=>({status:"rejected",reason:f}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),p=(l==null?void 0:l.nonce)||(l==null?void 0:l.getAttribute("nonce"));s=a(n.map(d=>{if(d=st(d),d in be)return;be[d]=!0;const u=d.endsWith(".css"),f=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${f}`))return;const h=document.createElement("link");if(h.rel=u?"stylesheet":it,u||(h.as="script"),h.crossOrigin="",h.href=d,p&&h.setAttribute("nonce",p),document.head.appendChild(h),u)return new Promise((x,b)=>{h.addEventListener("load",x),h.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${d}`)))})}))}function r(a){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=a,window.dispatchEvent(l),!l.defaultPrevented)throw a}return s.then(a=>{for(const l of a||[])l.status==="rejected"&&r(l.reason);return t().catch(r)})},de="koalasnap_state",O="koalasnap_templates",we="koalasnap_sidebar",J=3,ye={bgGradient:"from-sky-400 to-indigo-600"},ke={1:e=>(e.bgGradient===ye.bgGradient&&(e.bgGradient="from-slate-900 to-indigo-950"),e),2:e=>(e.bgGradient===ye.bgGradient&&(e.bgGradient="from-slate-900 to-indigo-950"),e)};function at(e){try{const t=localStorage.getItem(de);if(t){const n=JSON.parse(t);n.bgGradient==="from-sky-400 to-indigo-600"&&(n.bgGradient="from-slate-900 to-indigo-950");const i=n._version||1;if(i<J){for(let a=i;a<J;a++)ke[a]&&ke[a](n);n._version=J;const{avatar:s,...r}=n;localStorage.setItem(de,JSON.stringify(r))}return{...e,...n}}}catch{}return{...e}}function N(e){try{const{avatar:t,...n}=e;localStorage.setItem(de,JSON.stringify(n))}catch{}}function rt(){try{const t=new URLSearchParams(window.location.search).get("state");if(!t)return null;const n=atob(t),i=Uint8Array.from(n,a=>a.charCodeAt(0)),s=new TextDecoder().decode(i),r=JSON.parse(s);if(r&&typeof r=="object")return r}catch{}return null}function ot(e){const t=rt(),n=t?{...e,...t}:at(e),i=new Set,s=[],r=[],a=50;let l=!1;function p(){l||(s.push(JSON.parse(JSON.stringify(n))),s.length>a&&s.shift(),r.length=0)}return{get(d){return n[d]},getState(){return{...n}},set(d,u){p(),n[d]=u,N(n),i.forEach(f=>f(d,u,n))},setAll(d){p(),Object.assign(n,d),N(n),i.forEach(u=>u(null,null,n))},mutate(d){p(),Object.assign(n,d),N(n),i.forEach(u=>u(null,null,n))},subscribe(d){return i.add(d),()=>i.delete(d)},reset(){p(),Object.assign(n,e),N(n),i.forEach(d=>d(null,null,n))},undo(){if(s.length===0)return;r.push(JSON.parse(JSON.stringify(n)));const d=s.pop();Object.assign(n,d),N(n),i.forEach(u=>u("_undo",null,n))},redo(){if(r.length===0)return;s.push(JSON.parse(JSON.stringify(n)));const d=r.pop();Object.assign(n,d),N(n),i.forEach(u=>u("_redo",null,n))},canUndo(){return s.length>0},canRedo(){return r.length>0},pauseHistory(){l=!0},resumeHistory(){l=!1},saveTemplate(d){try{const u=JSON.parse(localStorage.getItem(O)||"{}"),{avatar:f,...h}=n;return u[d]=h,localStorage.setItem(O,JSON.stringify(u)),!0}catch{return!1}},deleteTemplate(d){try{const u=JSON.parse(localStorage.getItem(O)||"{}");return delete u[d],localStorage.setItem(O,JSON.stringify(u)),!0}catch{return!1}},loadTemplate(d){try{const f=JSON.parse(localStorage.getItem(O)||"{}")[d];return f?(this.mutate(f),!0):!1}catch{return!1}},listTemplates(){try{return Object.keys(JSON.parse(localStorage.getItem(O)||"{}"))}catch{return[]}},getSidebarOpen(){return localStorage.getItem(we)!=="false"},setSidebarOpen(d){localStorage.setItem(we,String(d))},getShareUrl(){try{const{avatar:d,...u}=n,f=JSON.stringify(u),h=new TextEncoder().encode(f),x=String.fromCharCode(...h),b=btoa(x),y=new URL(window.location.href.split("?")[0].split("#")[0]);return y.searchParams.set("state",b),y.toString()}catch{return null}}}}const lt={_version:J,theme:"whatsapp",author:"Maya",handle:"@maya_99",username:"Maya",roleColor:"#e81224",timestamp:"7:18 PM",statusBarTime:"09:41",statusText:"online",imessageMode:"imessage",statusBarBattery:100,statusBarSignal:4,statusBarWifi:!0,isGroup:!1,message:"Hey, are you coming online tonight?",avatar:null,bgGradient:"from-slate-900 to-indigo-950",padding:48,mockupTheme:"light",waMode:"sent",locale:"en",fontFamily:"system-ui",_toolbarPos:"right",chatBg:null,chatBgGradient:"",messages:[{id:1,text:"Hey, are you coming online tonight?",type:"sent",time:"7:18 PM",status:"read"},{id:2,text:"Yeah, give me 5!",type:"received",time:"7:20 PM",status:"read"},{id:3,text:"Sure, take your time 🐨",type:"sent",time:"7:21 PM",status:"delivered"}]},o=ot(lt),ct=window.__LOCALE__||{};function c(e){return e.split(".").reduce((n,i)=>n!=null?n[i]:void 0,ct)??e}function ue(){const e=window.location.pathname.match(/^\/([a-z]{2})\//);return e?e[1]:"en"}function g(e){return typeof e!="string"?"":e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}const K=500,dt=.8;function pt(e){return new Promise((t,n)=>{const i=new FileReader;i.onerror=()=>n(new Error("File read failed")),i.onload=s=>{const r=new Image;r.onerror=()=>n(new Error("Image decode failed")),r.onload=()=>{let{width:a,height:l}=r;if(a>K||l>K){const u=Math.min(K/a,K/l);a=Math.round(a*u),l=Math.round(l*u)}const p=document.createElement("canvas");p.width=a,p.height=l;const d=p.getContext("2d");if(!d){n(new Error("Canvas 2D not supported"));return}d.imageSmoothingEnabled=!0,d.imageSmoothingQuality="high",d.drawImage(r,0,0,a,l),p.toBlob(u=>{if(!u){n(new Error("WebP encoding failed"));return}t(URL.createObjectURL(u))},"image/webp",dt)},r.src=s.target.result},i.readAsDataURL(e)})}function ut(e){const t=document.getElementById(e);t instanceof HTMLImageElement&&(t.src="")}const Le="koalasnap_tutorial_completed",G=[{target:"app-library",key:"tutorial.step1"},{target:"settings-panel",key:"tutorial.step2"},{target:"canvas-area",key:"tutorial.step3"},{target:"bottom-bar",key:"tutorial.step4"},{target:"btn-topbar-export",key:"tutorial.step5"}];let k=0,W=!1,$=null;function gt(){return localStorage.getItem(Le)==="true"}function ft(){return W}function Ie(){W&&U(),k=0,W=!0;const e=vt();e.classList.remove("hidden"),e.style.pointerEvents="auto",Q(0),document.addEventListener("keydown",je)}function je(e){e.key==="Escape"&&U()}function U(){W=!1,$&&(clearTimeout($),$=null),ee(k);const e=document.getElementById("tutorial-overlay");e&&(e.classList.add("hidden"),e.style.pointerEvents=""),localStorage.setItem(Le,"true"),document.removeEventListener("keydown",je)}function ht(){if(ee(k),k++,k>=G.length){U();return}Q(k)}function xt(){ee(k),k=Math.max(0,k-1),Q(k)}function mt(){W&&(ee(k),Q(k))}function vt(){let e=document.getElementById("tutorial-overlay");return e||(e=document.createElement("div"),e.id="tutorial-overlay",e.className="fixed inset-0 bg-black/60 z-40 hidden",document.body.appendChild(e)),e}function Q(e){$&&(clearTimeout($),$=null);const t=G[e];if(!t)return;const n=document.getElementById(t.target);if(!n)return;n.classList.add("tutorial-highlight"),n.style.zIndex="50",getComputedStyle(n).position==="static"&&(n.style.position="relative"),n.scrollIntoView({behavior:"smooth",block:"center"});const i=n.getBoundingClientRect();$=setTimeout(()=>{bt(e,i),$=null},400)}function ee(e){$&&(clearTimeout($),$=null);const t=G[e];if(!t)return;const n=document.getElementById(t.target);n&&(n.classList.remove("tutorial-highlight"),n.style.zIndex="",n.style.position="");const i=document.getElementById("tutorial-tooltip");i&&i.remove()}function bt(e,t){const n=document.getElementById("tutorial-tooltip");n&&n.remove();const i=G.length,s=e===0,r=e===i-1,a=document.createElement("div");a.id="tutorial-tooltip",a.className="fixed z-50 w-[320px] rounded-2xl border border-white/[10%] bg-[#1a1714]/95 backdrop-blur-2xl p-4 shadow-2xl shadow-black/50 opacity-0 transition-opacity duration-200",a.innerHTML=`
  ...
  `}function Ct(e,t){const n=t?"bg-black":"bg-white",i=t?"text-white":"text-zinc-900",s=t?"text-zinc-400":"text-zinc-500";return`
  ...
  `}function St(e,t){const n="text-white";return`
    <div id="mockup-card" class="mx-auto" style="width:390px; height:844px;font-family:${e.fontFamily};">
  ...
  `}function Ae(e,t){const n=e.statusBarWifi!==!1?`<span class="text-[11px]">${Ft}</span>`:"",i=en(e.statusBarSignal||4),s=Qt(e.statusBarBattery!==void 0?e.statusBarBattery:100);return`
  ...
  `}function Pe(e,t){const n=e.statusBarWifi!==!1?`<span class="text-[11px]">${un}</span>`:"",i=wn(e.statusBarSignal||4),s=bn(e.statusBarBattery!==void 0?e.statusBarBattery:100);return`
  ...
  `}function $n(e,t){return`
    <div id="tg-chat-container" class="flex-1 p-4 overflow-y-auto" style="background:var(--chat-bg, ${t.chatBg})${e.chatBg?`;background-image:url(${e.chatBg});background-size:cover`:`;background-image:${t.dotPattern}`}">
      <div id="tg-messages" class="flex flex-col gap-0.5">
        ${e.messages.map((n,i)=>Oe(n,i,e,t)).join("")}
      </div>
    </div>
  `}function Oe(e,t,n,i){var I,_;const s=e.type==="sent",r=t<n.messages.length-1?n.messages[t+1]:null,a=t>0?n.messages[t-1]:null,l=!a||a.type!==e.type,p=!r||r.type!==e.type,d=s?i.sentBg:i.recvBg,u=s?i.sentText:i.recvText,f=s?i.sentTimeText:i.timeText,h=s?"justify-end":"justify-start",x=e.status||"read";let b="",y="rounded-[12px]",z="px-3.5 py-1.5",j=l?"mt-2.5":"mt-[2px]";const S=["#2cb3c9","#57d363","#ffa500","#f44336","#9c27b0","#4caf50"],T=(e.senderName||"").split("").reduce((V,ne)=>V+ne.charCodeAt(0),0)%S.length,M=S[T],B=n.isGroup&&!s&&l&&e.senderName?`
  ...
  `}function Gn(e,t){return`
    <div id="sg-chat-container" class="flex-1 p-4 overflow-y-auto" style="background:var(--chat-bg, ${t.chatBg})${e.chatBg?`;background-image:url(${e.chatBg});background-size:cover`:""}">
      <div id="sg-messages" class="flex flex-col gap-0.5">
        ${e.messages.map((n,i)=>Ge(n,i,e,t)).join("")}
      </div>
    </div>
  `}function Ge(e,t,n,i){var C,I;const s=e.type==="sent",r=t>0?n.messages[t-1]:null,a=t<n.messages.length-1?n.messages[t+1]:null,l=!r||r.type!==e.type,p=!a||a.type!==e.type,d=s?i.sentBg:i.recvBg,u=s?i.sentText:i.recvText,f=s?i.sentTimeText:i.timeText,h=s?"justify-end":"justify-start",x=e.status||"read";let b="rounded-[16px]",y=l?"mt-2.5":"mt-[2px]";s?l&&p?b="rounded-[16px] rounded-br-[4px]":l?b="rounded-[16px] rounded-tr-[16px] rounded-br-[4px]":p?b="rounded-[16px] rounded-br-[4px]":b="rounded-[16px] rounded-tr-[16px] rounded-br-[4px]":l&&p?b="rounded-[16px] rounded-bl-[4px]":l?b="rounded-[16px] rounded-tl-[16px] rounded-bl-[4px]":p?b="rounded-[16px] rounded-bl-[4px]":b="rounded-[16px] rounded-tl-[16px] rounded-bl-[4px]";const z=["#10b981","#f59e0b","#ef4444","#8b5cf6","#ec4899","#3b82f6"],j=(e.senderName||"").split("").reduce((_,V)=>_+V.charCodeAt(0),0)%z.length,S=z[j],T=n.isGroup&&!s&&l&&e.senderName?`
  ...
  `}function Fe(e,t){const n=e.statusBarWifi!==!1?`<span class="text-[11px]">${Un}</span>`:"",i=Yn(e.statusBarSignal||4),s=Jn(e.statusBarBattery!==void 0?e.statusBarBattery:100);return`
  ...
  `}function De(e,t){return`
    <div id="im-navbar" class="flex items-center gap-1 px-2 py-1.5 shrink-0 border-b border-black/[5%] relative z-10" style="background:${t.barBg};color:${t.navColor}">
      <span class="shrink-0 px-1">${Dn}</span>
      ...
      <div class="flex items-center gap-2 shrink-0 px-1">
        <span style="color:${t.navColor}">${Wn}</span>
      </div>
    </div>
          ...
          <div id="lang-dropdown" class="hidden absolute right-0 top-full mt-1.5 z-50 min-w-[130px] rounded-xl border border-white/10 bg-[#1a1714]/95 backdrop-blur-2xl py-1 shadow-2xl shadow-black/50">
            ${["de","en","es"].map(t=>`
              <button data-lang="${t}"
                ...
                <span class="font-flags text-sm shrink-0 leading-none">${Ee(t)}</span>
                ${ni[t]}
              </button>
            `).join("")}
          </div>
  ...
  `}function si(e){const t=o.getSidebarOpen(),i=ue()==="de"?"/de":"";return`
    <aside id="sidebar" class="shrink-0 h-full overflow-y-auto flex flex-col gap-4 transition-all duration-300 bg-[#0d0a07] border-white/[6%] z-40 fixed left-0 top-14 bottom-0 border-r md:relative md:top-0 md:translate-x-0
      ...
      <div id="settings-panel" class="rounded-2xl border border-white/[6%] bg-[#1a1714] p-4 flex flex-col gap-4">
        <span class="text-xs font-semibold text-zinc-300 tracking-wide">${c("sidebar.settings")} · <span class="text-zinc-500 font-normal normal-case">${qe()}</span></span>
        ${Ye(e)}
      </div>
