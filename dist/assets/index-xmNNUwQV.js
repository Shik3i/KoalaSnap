(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(r){if(r.ep)return;r.ep=!0;const o=t(r);fetch(r.href,o)}})();const Le="modulepreload",Ae=function(e){return"/"+e},se={},fe=function(n,t,i){let r=Promise.resolve();if(t&&t.length>0){let s=function(c){return Promise.all(c.map(p=>Promise.resolve(p).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};document.getElementsByTagName("link");const d=document.querySelector("meta[property=csp-nonce]"),h=(d==null?void 0:d.nonce)||(d==null?void 0:d.getAttribute("nonce"));r=s(t.map(c=>{if(c=Ae(c),c in se)return;se[c]=!0;const p=c.endsWith(".css"),g=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${g}`))return;const u=document.createElement("link");if(u.rel=p?"stylesheet":Le,p||(u.as="script"),u.crossOrigin="",u.href=c,h&&u.setAttribute("nonce",h),document.head.appendChild(u),p)return new Promise((v,C)=>{u.addEventListener("load",v),u.addEventListener("error",()=>C(new Error(`Unable to preload CSS for ${c}`)))})}))}function o(s){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=s,window.dispatchEvent(d),!d.defaultPrevented)throw s}return r.then(s=>{for(const d of s||[])d.status==="rejected"&&o(d.reason);return n().catch(o)})},X="koalasnap_state",$="koalasnap_templates",oe="koalasnap_sidebar",H=2,Te={bgGradient:"from-sky-400 to-indigo-600"},ae={1:e=>(e.bgGradient===Te.bgGradient&&(e.bgGradient="from-slate-900 to-indigo-950"),e)};function Ie(e){try{const n=localStorage.getItem(X);if(n){const t=JSON.parse(n),i=t._version||1;if(i<H){for(let s=i;s<H;s++)ae[s]&&ae[s](t);t._version=H;const{avatar:r,...o}=t;localStorage.setItem(X,JSON.stringify(o))}return{...e,...t}}}catch{}return{...e}}function B(e){try{const{avatar:n,...t}=e;localStorage.setItem(X,JSON.stringify(t))}catch{}}function je(){try{const n=new URLSearchParams(window.location.search).get("state");if(!n)return null;const t=atob(n),i=Uint8Array.from(t,s=>s.charCodeAt(0)),r=new TextDecoder().decode(i),o=JSON.parse(r);if(o&&typeof o=="object")return o}catch{}return null}function _e(e){const n=je(),t=n?{...e,...n}:Ie(e),i=new Set,r=[],o=[],s=50;let d=!1;function h(){d||(r.push(JSON.parse(JSON.stringify(t))),r.length>s&&r.shift(),o.length=0)}return{get(c){return t[c]},getState(){return{...t}},set(c,p){h(),t[c]=p,B(t),i.forEach(g=>g(c,p,t))},setAll(c){h(),Object.assign(t,c),B(t),i.forEach(p=>p(null,null,t))},mutate(c){h(),Object.assign(t,c),B(t),i.forEach(p=>p(null,null,t))},subscribe(c){return i.add(c),()=>i.delete(c)},reset(){h(),Object.assign(t,e),B(t),i.forEach(c=>c(null,null,t))},undo(){if(r.length===0)return;o.push(JSON.parse(JSON.stringify(t)));const c=r.pop();Object.assign(t,c),B(t),i.forEach(p=>p("_undo",null,t))},redo(){if(o.length===0)return;r.push(JSON.parse(JSON.stringify(t)));const c=o.pop();Object.assign(t,c),B(t),i.forEach(p=>p("_redo",null,t))},canUndo(){return r.length>0},canRedo(){return o.length>0},pauseHistory(){d=!0},resumeHistory(){d=!1},saveTemplate(c){try{const p=JSON.parse(localStorage.getItem($)||"{}"),{avatar:g,...u}=t;return p[c]=u,localStorage.setItem($,JSON.stringify(p)),!0}catch{return!1}},deleteTemplate(c){try{const p=JSON.parse(localStorage.getItem($)||"{}");return delete p[c],localStorage.setItem($,JSON.stringify(p)),!0}catch{return!1}},loadTemplate(c){try{const g=JSON.parse(localStorage.getItem($)||"{}")[c];return g?(this.mutate(g),!0):!1}catch{return!1}},listTemplates(){try{return Object.keys(JSON.parse(localStorage.getItem($)||"{}"))}catch{return[]}},getSidebarOpen(){return localStorage.getItem(oe)!=="false"},setSidebarOpen(c){localStorage.setItem(oe,String(c))},getShareUrl(){try{const{avatar:c,...p}=t,g=JSON.stringify(p),u=new TextEncoder().encode(g),v=String.fromCharCode(...u),C=btoa(v),_=new URL(window.location.href.split("?")[0].split("#")[0]);return _.searchParams.set("state",C),_.toString()}catch{return null}}}}const Oe={_version:H,theme:"whatsapp",author:"Maya",handle:"@maya_99",username:"Maya",roleColor:"#e81224",timestamp:"7:18 PM",message:"Hey, are you coming online tonight?",avatar:null,bgGradient:"from-slate-900 to-indigo-950",padding:48,mockupTheme:"light",waMode:"sent",locale:"en",fontFamily:"system-ui",chatBg:null,messages:[{id:1,text:"Hey, are you coming online tonight?",type:"sent",time:"7:18 PM",status:"read"},{id:2,text:"Yeah, give me 5!",type:"received",time:"7:20 PM",status:"read"},{id:3,text:"Sure, take your time 🐨",type:"sent",time:"7:21 PM",status:"delivered"}]},l=_e(Oe),Pe=window.__LOCALE__||{};function a(e){return e.split(".").reduce((t,i)=>t!=null?t[i]:void 0,Pe)??e}function Z(){const e=window.location.pathname.match(/^\/([a-z]{2})\//);return e?e[1]:"en"}function f(e){return typeof e!="string"?"":e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}const P=500,He=.8;function Ge(e){return new Promise((n,t)=>{const i=new FileReader;i.onerror=()=>t(new Error("File read failed")),i.onload=r=>{const o=new Image;o.onerror=()=>t(new Error("Image decode failed")),o.onload=()=>{let{width:s,height:d}=o;if(s>P||d>P){const p=Math.min(P/s,P/d);s=Math.round(s*p),d=Math.round(d*p)}const h=document.createElement("canvas");h.width=s,h.height=d;const c=h.getContext("2d");if(!c){t(new Error("Canvas 2D not supported"));return}c.imageSmoothingEnabled=!0,c.imageSmoothingQuality="high",c.drawImage(o,0,0,s,d),h.toBlob(p=>{if(!p){t(new Error("WebP encoding failed"));return}n(URL.createObjectURL(p))},"image/webp",He)},o.src=r.target.result},i.readAsDataURL(e)})}function Ne(e){const n=document.getElementById(e);n instanceof HTMLImageElement&&(n.src="")}const he="koalasnap_tutorial_completed",z=[{target:"app-library",key:"tutorial.step1"},{target:"settings-panel",key:"tutorial.step2"},{target:"canvas-area",key:"tutorial.step3"},{target:"bottom-bar",key:"tutorial.step4"},{target:"btn-topbar-export",key:"tutorial.step5"}];let w=0,I=!1,y=null;function Ve(){return localStorage.getItem(he)==="true"}function Re(){return I}function xe(){I&&j(),w=0,I=!0;const e=Ue();e.classList.remove("hidden"),e.style.pointerEvents="auto",N(0),document.addEventListener("keydown",me)}function me(e){e.key==="Escape"&&j()}function j(){I=!1,y&&(clearTimeout(y),y=null),V(w);const e=document.getElementById("tutorial-overlay");e&&(e.classList.add("hidden"),e.style.pointerEvents=""),localStorage.setItem(he,"true"),document.removeEventListener("keydown",me)}function Fe(){if(V(w),w++,w>=z.length){j();return}N(w)}function De(){V(w),w=Math.max(0,w-1),N(w)}function We(){I&&(V(w),N(w))}function Ue(){let e=document.getElementById("tutorial-overlay");return e||(e=document.createElement("div"),e.id="tutorial-overlay",e.className="fixed inset-0 bg-black/60 z-40 hidden",document.body.appendChild(e)),e}function N(e){y&&(clearTimeout(y),y=null);const n=z[e];if(!n)return;const t=document.getElementById(n.target);if(!t)return;t.classList.add("tutorial-highlight"),t.style.zIndex="50",getComputedStyle(t).position==="static"&&(t.style.position="relative"),t.scrollIntoView({behavior:"smooth",block:"center"});const i=t.getBoundingClientRect();y=setTimeout(()=>{Ke(e,i),y=null},400)}function V(e){y&&(clearTimeout(y),y=null);const n=z[e];if(!n)return;const t=document.getElementById(n.target);t&&(t.classList.remove("tutorial-highlight"),t.style.zIndex="",t.style.position="");const i=document.getElementById("tutorial-tooltip");i&&i.remove()}function Ke(e,n){const t=document.getElementById("tutorial-tooltip");t&&t.remove();const i=z.length,r=e===0,o=e===i-1,s=document.createElement("div");s.id="tutorial-tooltip",s.className="fixed z-50 w-[320px] rounded-2xl border border-white/[10%] bg-[#1a1714]/95 backdrop-blur-2xl p-4 shadow-2xl shadow-black/50 opacity-0 transition-opacity duration-200",s.innerHTML=`
  ...
  `,document.body.appendChild(s),Je(s,n),requestAnimationFrame(()=>{s.classList.remove("opacity-0")}),Ye(e)}function qe(e){var n;return((n=z[e])==null?void 0:n.key)||""}function Je(e,n){const r=e.offsetWidth||320,o=e.offsetHeight||160,s=window.innerWidth-r-16,d=window.innerHeight-o-16,h=n.left+n.width/2;let c=Math.max(16,Math.min(h-r/2,s)),p=n.bottom+12;p+o>window.innerHeight-16&&(p=n.top-o-12),p<16&&(p=16,c=Math.min(n.right+12,s),c=Math.max(16,c)),c=Math.max(16,Math.min(c,s)),p=Math.max(16,Math.min(p,d)),e.style.left=`${c}px`,e.style.top=`${p}px`}function Ye(e){const n=document.getElementById("tut-next");n&&(n.onclick=()=>e===z.length-1?j():Fe());const t=document.getElementById("tut-prev");t&&(t.onclick=()=>De());const i=document.getElementById("tut-skip");i&&(i.onclick=()=>j())}const ve="?",ee='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>',Xe='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="17 1 21 5 17 9"/><path d="M3 11V9a4 4 0 0 1 4-4h14"/><polyline points="7 23 3 19 7 15"/><path d="M21 13v2a4 4 0 0 1-4 4H3"/></svg>',te='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>',ne='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg>',Qe='<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="5" r="2"/><circle cx="12" cy="12" r="2"/><circle cx="12" cy="19" r="2"/></svg>';function ie(e,n){return e?`<img id="mockup-avatar" src="${e}" class="w-full h-full rounded-full object-cover" />`:`<div id="mockup-avatar" class="w-full h-full rounded-full bg-gradient-to-br ${n?"from-zinc-600 to-zinc-800":"from-sky-400 to-indigo-500"} flex items-center justify-center text-white text-sm font-bold">${ve}</div>`}function Ze(e,n){const t=n?"bg-zinc-900":"bg-white",i=n?"text-zinc-100":"text-zinc-900",r=n?"text-zinc-400":"text-zinc-500",o=n?"text-zinc-300":"text-zinc-800",s=n?"border-zinc-700":"border-zinc-200";return`
    <div id="mockup-card" class="${t} rounded-2xl shadow-2xl shadow-black/20 mx-auto overflow-hidden ring-1 ring-white/[6%] p-3" style="width:400px; height:520px;font-family:${e.fontFamily};">
      ...
      <div class="flex items-center justify-between mt-2 pt-2 ${s} border-t text-sm ${r}">
        <div class="flex items-center gap-5">
          <span class="flex items-center gap-1">${te} <span id="mockup-replies">1</span></span>
          <span class="flex items-center gap-1">${Xe} <span id="mockup-retweets">3</span></span>
          <span class="flex items-center gap-1">${ee} <span id="mockup-likes">12</span></span>
        </div>
        <span>${ne}</span>
      </div>
    </div>
  `}function et(e,n){const t=n?"bg-black":"bg-white",i=n?"text-white":"text-zinc-900",r=n?"text-zinc-400":"text-zinc-500";return`
  ...
  `}function tt(e,n){const t=n?"#1a1a2e":"#f0f2f5",i=n?"#1c1c2e":"#007aff";return`
  ...
  `}function nt(e,n){const t="text-white";return`
    <div id="mockup-card" class="mx-auto" style="width:390px; height:844px;font-family:${e.fontFamily};">
            ...
            <div class="flex items-start gap-3">
              ...
              <div class="flex flex-col items-center gap-3 shrink-0">
                ...
                <div class="flex flex-col items-center gap-4 text-white text-xs">
                  <div class="flex flex-col items-center gap-0.5">${ee}<span id="mockup-likes" class="text-[10px]">12.4k</span></div>
                  <div class="flex flex-col items-center gap-0.5">${te}<span id="mockup-replies" class="text-[10px]">241</span></div>
                  <div class="flex flex-col items-center gap-0.5">${ne}<span class="text-[10px]">Share</span></div>
                </div>
              </div>
            </div>
          </div>
  ...
  `}function M(e){const n=e.mockupTheme==="dark";switch(e.theme||"twitter"){case"instagram":return et(e,n);case"messenger":return tt(e,n);case"tiktok":return nt(e,n);case"twitter":default:return Ze(e,n)}}function L(e){const n=e.theme||"twitter";k("mockup-author",t=>{t&&(t.textContent=e.author)}),k("mockup-message",t=>{t&&(t.textContent=e.message)}),k("mockup-likes",t=>{t&&(t.textContent="142")}),k("mockup-replies",t=>{t&&(t.textContent="1")}),k("mockup-retweets",t=>{t&&(t.textContent="3")}),n==="messenger"?k("mockup-avatar",t=>{t&&le(t,e,!1)}):k("mockup-avatar",t=>{t&&le(t,e,e.mockupTheme==="dark")})}function le(e,n,t){if(n.avatar){const i=document.createElement("img");i.id="mockup-avatar",i.src=n.avatar,i.className="w-full h-full rounded-full object-cover",i.alt="",e.replaceWith(i)}else{const i=document.createElement("div");i.id="mockup-avatar";const r=t?"from-zinc-600 to-zinc-800":"from-sky-400 to-indigo-500";i.className=`w-full h-full rounded-full bg-gradient-to-br ${r} flex items-center justify-center text-white text-sm font-bold`,i.textContent=ve,e.replaceWith(i)}}function k(e,n){const t=document.getElementById(e);t&&n(t)}const it='<svg width="20" height="20" viewBox="0 0 24 24" fill="#949ba4"><path d="M5 9h14M5 15h14M11 3L9 21M15 3l-2 18"/></svg>',rt='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#949ba4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2z"/></svg>',st='<svg width="16" height="16" viewBox="0 0 24 24" fill="#949ba4"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>',ot='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#b5bac1" stroke-width="2" stroke-linecap="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>',at='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#b5bac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 12 20 22 4 22 4 12"/><rect x="2" y="7" width="20" height="5"/><line x1="12" y1="22" x2="12" y2="7"/><path d="M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7z"/><path d="M12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7z"/></svg>',lt=`url("data:image/svg+xml,%3Csvg width='200' height='200' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='30' cy='30' r='2' fill='white' opacity='0.02'/%3E%3Ccircle cx='100' cy='60' r='1.5' fill='white' opacity='0.015'/%3E%3Ccircle cx='170' cy='30' r='1' fill='white' opacity='0.02'/%3E%3Ccircle cx='50' cy='120' r='1.5' fill='white' opacity='0.015'/%3E%3Ccircle cx='150' cy='150' r='2' fill='white' opacity='0.02'/%3E%3C/svg%3E")`,ct={sidebarBg:"#2b2d31",chatBg:"#313338",inputBg:"#383a40",inputText:"#dbdee1",placeholder:"#949ba4",divider:"#3f4147",dotPattern:"none"},dt={sidebarBg:"#1e1f22",chatBg:"#313338",inputBg:"#383a40",inputText:"#dbdee1",placeholder:"#949ba4",divider:"#3f4147",dotPattern:lt};function pt(e){return e.mockupTheme==="light"?ct:dt}function ut(e){const n=pt(e),t=e.avatar?`<img id="discord-avatar" src="${e.avatar}" class="w-10 h-10 rounded-full object-cover" />`:'<div id="discord-avatar" class="w-10 h-10 rounded-full bg-[#5865F2] flex items-center justify-center text-white text-xs font-bold">?</div>';return`
    <div id="mockup-card" class="mx-auto" style="width:390px; height:844px;font-family:${e.fontFamily};">
  ...
  `}function gt(e){D("discord-username",t=>{t.textContent=e.username,t.style.color=e.roleColor}),D("discord-timestamp",t=>{t.textContent=e.timestamp}),D("discord-message",t=>{t.textContent=e.message});const n=document.getElementById("discord-avatar");if(n)if(e.avatar){const t=document.createElement("img");t.id="discord-avatar",t.src=e.avatar,t.className="w-10 h-10 rounded-full object-cover",t.alt="",n.replaceWith(t)}else{const t=document.createElement("div");t.id="discord-avatar",t.className="w-10 h-10 rounded-full bg-[#5865F2] flex items-center justify-center text-white text-xs font-bold",t.textContent="?",n.replaceWith(t)}}function D(e,n){const t=document.getElementById(e);t&&n(t)}const ft='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#e9edef" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>',ht='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/></svg>',xt='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',mt='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><rect x="1" y="8" width="2" height="3" rx="0.4" fill="currentColor"/><rect x="5" y="5" width="2" height="6" rx="0.4" fill="currentColor"/><rect x="9" y="2.5" width="2" height="8.5" rx="0.4" fill="currentColor"/><rect x="13" y="0.5" width="2" height="10.5" rx="0.4" fill="currentColor"/></svg>',vt='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><path d="M9 11.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm-3.3-3.3a4.5 4.5 0 0 1 6.6 0l-1.1 1.1a3 3 0 0 0-4.4 0L5.7 8.2zM2.9 5.1a8 8 0 0 1 12.2 0l-1.1 1.1a6.5 6.5 0 0 0-10 0L2.9 5.1z" fill="currentColor"/></svg>',bt='<svg width="24" height="12" viewBox="0 0 26 12" fill="none"><rect x="0.5" y="0.5" width="22" height="11" rx="2" stroke="currentColor" fill="none"/><rect x="2" y="2" width="19.5" height="8" rx="1.5" fill="currentColor"/><rect x="24" y="3.5" width="2" height="5" rx="0.75" fill="currentColor"/></svg>',wt='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8696a0" stroke-width="2.5" stroke-linecap="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>',yt='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/></svg>',kt='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/><line x1="8" y1="23" x2="16" y2="23"/></svg>',$t=`url("data:image/svg+xml,%3Csvg width='200' height='200' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='30' cy='30' r='2' fill='white' opacity='0.04'/%3E%3Ccircle cx='100' cy='60' r='1.5' fill='white' opacity='0.03'/%3E%3Ccircle cx='170' cy='30' r='1' fill='white' opacity='0.04'/%3E%3Ccircle cx='50' cy='120' r='1.5' fill='white' opacity='0.03'/%3E%3Ccircle cx='150' cy='150' r='2' fill='white' opacity='0.04'/%3E%3Ccircle cx='80' cy='180' r='1' fill='white' opacity='0.03'/%3E%3Ccircle cx='20' cy='170' r='1.5' fill='white' opacity='0.03'/%3E%3C/svg%3E")`,Bt=`url("data:image/svg+xml,%3Csvg width='200' height='200' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='30' cy='30' r='2' fill='black' opacity='0.04'/%3E%3Ccircle cx='100' cy='60' r='1.5' fill='black' opacity='0.03'/%3E%3Ccircle cx='170' cy='30' r='1' fill='black' opacity='0.04'/%3E%3Ccircle cx='50' cy='120' r='1.5' fill='black' opacity='0.03'/%3E%3Ccircle cx='150' cy='150' r='2' fill='black' opacity='0.04'/%3E%3Ccircle cx='80' cy='180' r='1' fill='black' opacity='0.03'/%3E%3Ccircle cx='20' cy='170' r='1.5' fill='black' opacity='0.03'/%3E%3C/svg%3E")`,Et='<svg width="14" height="14" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#53bdeb" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 5.5L9.5 9L16 1" stroke="#53bdeb" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" opacity="0.7"/></svg>',zt='<svg width="14" height="14" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 5.5L9.5 9L16 1" stroke="#8696a0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" opacity="0.7"/></svg>',Ct='<svg width="14" height="14" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',St='<svg width="8" height="8" viewBox="0 0 8 8" fill="#53bdeb"><circle cx="4" cy="4" r="4"/></svg>',Mt={barBg:"#008069",chatBg:"#efeae2",sentBg:"#d9fdd3",recvBg:"#ffffff",sentText:"#111b21",recvText:"#111b21",timeText:"#667781",inputBg:"#f0f2f5",fieldBg:"#ffffff",fieldText:"#111b21",placeholder:"#8696a0",dotPattern:Bt},Lt={barBg:"#202c33",chatBg:"#0b141a",sentBg:"#005c4b",recvBg:"#202c33",sentText:"#e9edef",recvText:"#e9edef",timeText:"#ffffffcc",inputBg:"#202c33",fieldBg:"#2a3942",fieldText:"#e9edef",placeholder:"#8696a0",dotPattern:$t};function be(e){return e.mockupTheme==="light"?Mt:Lt}function At(e){const n=be(e),t=e.mockupTheme==="light"?"#ffffff":"#121212";return`
    <div id="mockup-card" class="mx-auto" style="width:390px; height:844px;font-family:${e.fontFamily};">
  ...
  `}function jt(e,n){return`
    <div class="flex-1 p-4 overflow-y-auto" style="background:${n.chatBg}${e.chatBg?`;background-image:url(${e.chatBg});background-size:cover`:`;background-image:${n.dotPattern}`}">
      <div id="wa-messages" class="flex flex-col gap-3">
        ${e.messages.map(t=>we(t,n)).join("")}
      </div>
    </div>
  `}function we(e,n){const t=e.type==="sent",i=t?n.sentBg:n.recvBg,r=t?n.sentText:n.recvText,o=i,s=t?"justify-end":"justify-start",d=e.status||"read",h=t?`<div class="absolute -right-[7px] bottom-[6px] w-0 h-0 border-l-[8px] border-t-[6px] border-t-transparent border-b-[6px] border-b-transparent" style="border-left-color:${o}"></div>`:`<div class="absolute -left-[7px] bottom-[6px] w-0 h-0 border-r-[8px] border-t-[6px] border-t-transparent border-b-[6px] border-b-transparent" style="border-right-color:${o}"></div>`;let c="";t&&(d==="read"?c=Et:d==="delivered"?c=zt:d==="sent"&&(c=Ct));const p=d==="unread",g=p?"font-semibold":"",u=p?`<span class="inline-flex ml-1 -mb-0.5">${St}</span>`:"";return`
    <div class="flex ${s}">
  ...
  `}function Ot(e){Pt("wa-contact-name",i=>{i.textContent=e.username});const n=document.getElementById("wa-avatar");if(n)if(e.avatar){const i=document.createElement("img");i.id="wa-avatar",i.src=e.avatar,i.className="w-full h-full rounded-full object-cover",i.alt="",n.replaceWith(i)}else{const i=document.createElement("div");i.id="wa-avatar",i.className="w-full h-full rounded-full bg-[#2c2c2c] flex items-center justify-center",i.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="#8696a0"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>',n.replaceWith(i)}const t=document.getElementById("wa-messages");if(t){const i=be(e);t.innerHTML=e.messages.map(r=>we(r,i)).join("")}}function Pt(e,n){const t=document.getElementById(e);t&&n(t)}const Ht='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#e9edef" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>',Gt='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#e9edef" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>',Nt='<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/></svg>',Vt='<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.44 11.05l-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48"/></svg>',Rt='<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/><line x1="8" y1="23" x2="16" y2="23"/></svg>',Ft='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><rect x="1" y="8" width="2" height="3" rx="0.4" fill="currentColor"/><rect x="5" y="5" width="2" height="6" rx="0.4" fill="currentColor"/><rect x="9" y="2.5" width="2" height="8.5" rx="0.4" fill="currentColor"/><rect x="13" y="0.5" width="2" height="10.5" rx="0.4" fill="currentColor"/></svg>',Dt='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><path d="M9 11.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm-3.3-3.3a4.5 4.5 0 0 1 6.6 0l-1.1 1.1a3 3 0 0 0-4.4 0L5.7 8.2zM2.9 5.1a8 8 0 0 1 12.2 0l-1.1 1.1a6.5 6.5 0 0 0-10 0L2.9 5.1z" fill="currentColor"/></svg>',Wt='<svg width="24" height="12" viewBox="0 0 26 12" fill="none"><rect x="0.5" y="0.5" width="22" height="11" rx="2" stroke="currentColor" fill="none"/><rect x="2" y="2" width="19.5" height="8" rx="1.5" fill="currentColor"/><rect x="24" y="3.5" width="2" height="5" rx="0.75" fill="currentColor"/></svg>',Ut='<svg width="14" height="14" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#ffffffcc" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',Kt=`url("data:image/svg+xml,%3Csvg width='200' height='200' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='30' cy='30' r='2' fill='white' opacity='0.04'/%3E%3Ccircle cx='100' cy='60' r='1.5' fill='white' opacity='0.03'/%3E%3Ccircle cx='170' cy='30' r='1' fill='white' opacity='0.04'/%3E%3Ccircle cx='50' cy='120' r='1.5' fill='white' opacity='0.03'/%3E%3Ccircle cx='150' cy='150' r='2' fill='white' opacity='0.04'/%3E%3Ccircle cx='80' cy='180' r='1' fill='white' opacity='0.03'/%3E%3Ccircle cx='20' cy='170' r='1.5' fill='white' opacity='0.03'/%3E%3C/svg%3E")`,qt=`url("data:image/svg+xml,%3Csvg width='200' height='200' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='30' cy='30' r='2' fill='black' opacity='0.04'/%3E%3Ccircle cx='100' cy='60' r='1.5' fill='black' opacity='0.03'/%3E%3Ccircle cx='170' cy='30' r='1' fill='black' opacity='0.04'/%3E%3Ccircle cx='50' cy='120' r='1.5' fill='black' opacity='0.03'/%3E%3Ccircle cx='150' cy='150' r='2' fill='black' opacity='0.04'/%3E%3Ccircle cx='80' cy='180' r='1' fill='black' opacity='0.03'/%3E%3Ccircle cx='20' cy='170' r='1.5' fill='black' opacity='0.03'/%3E%3C/svg%3E")`,Jt={barBg:"#4e8ad4",chatBg:"#eef2f6",sentBg:"#8774e1",timeText:"#00000080",inputBg:"#ffffff",fieldBg:"#eef2f6",dotPattern:qt},Yt={barBg:"#2f6ea5",chatBg:"#0f0f0f",sentBg:"#8774e1",timeText:"#ffffffcc",inputBg:"#1c1c1e",fieldBg:"#2a2a2e",dotPattern:Kt};function Xt(e){return e.mockupTheme==="light"?Jt:Yt}function Qt(e){return`
    <div class="flex items-center justify-between px-6 h-[44px] shrink-0" style="background:${e.barBg};color:#e9edef">
      ...
      <div class="flex items-center gap-1.5">
        ...
        <span class="text-[11px]">${Wt}</span>
      </div>
    </div>
  `}function Zt(e,n){return`
    <div class="flex items-center gap-2 px-3 py-2 shrink-0" style="background:${n.barBg}">
      <span class="shrink-0">${Ht}</span>
      <div class="w-9 h-9 rounded-full overflow-hidden shrink-0">
        ...
        <div class="relative max-w-[80%]">
          <div class="rounded-2xl px-3.5 py-2" style="background:${n.sentBg}">
            ...
            <div class="flex items-center justify-end gap-1 mt-0.5">
              ...
              <span class="inline-flex -mb-0.5">${Ut}</span>
            </div>
          </div>
  ...
  `}function nn(e){const n=Xt(e),t=e.mockupTheme==="light"?"#ffffff":"#121212";return`
    <div id="mockup-card" class="mx-auto" style="width:390px; height:844px;font-family:${e.fontFamily};">
      <div class="w-full h-full overflow-hidden rounded-[2.5rem] border-8 flex flex-col" style="border-color:${t};background:${t}">
        ${Qt(n)}
        ${Zt(e,n)}
  ...
  `}function rn(e){W("tg-contact-name",t=>{t.textContent=e.username}),W("tg-message",t=>{t.textContent=e.message}),W("tg-time",t=>{t.textContent=e.timestamp});const n=document.getElementById("tg-avatar");if(n)if(e.avatar){const t=document.createElement("img");t.id="tg-avatar",t.src=e.avatar,t.className="w-full h-full rounded-full object-cover",t.alt="",n.replaceWith(t)}else{const t=document.createElement("div");t.id="tg-avatar",t.className="w-full h-full rounded-full bg-[#527da3] flex items-center justify-center",t.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="#e9edef"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>',n.replaceWith(t)}}function W(e,n){const t=document.getElementById(e);t&&n(t)}const sn='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#e9edef" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>',on='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/></svg>',an='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#aebac1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',ln='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><rect x="1" y="8" width="2" height="3" rx="0.4" fill="currentColor"/><rect x="5" y="5" width="2" height="6" rx="0.4" fill="currentColor"/><rect x="9" y="2.5" width="2" height="8.5" rx="0.4" fill="currentColor"/><rect x="13" y="0.5" width="2" height="10.5" rx="0.4" fill="currentColor"/></svg>',cn='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><path d="M9 11.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm-3.3-3.3a4.5 4.5 0 0 1 6.6 0l-1.1 1.1a3 3 0 0 0-4.4 0L5.7 8.2zM2.9 5.1a8 8 0 0 1 12.2 0l-1.1 1.1a6.5 6.5 0 0 0-10 0L2.9 5.1z" fill="currentColor"/></svg>',dn='<svg width="24" height="12" viewBox="0 0 26 12" fill="none"><rect x="0.5" y="0.5" width="22" height="11" rx="2" stroke="currentColor" fill="none"/><rect x="2" y="2" width="19.5" height="8" rx="1.5" fill="currentColor"/><rect x="24" y="3.5" width="2" height="5" rx="0.75" fill="currentColor"/></svg>',pn='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/></svg>',un='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.44 11.05l-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48"/></svg>',gn='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/><line x1="8" y1="23" x2="16" y2="23"/></svg>',fn='<svg width="14" height="14" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#ffffffcc" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',hn={barBg:"#3b82f6",chatBg:"#f0f2f5",sentBg:"#3b82f6",sentText:"#ffffff",timeText:"#00000080",inputBg:"#f0f2f5",fieldBg:"#ffffff",fieldText:"#111b21",placeholder:"#8696a0"},xn={barBg:"#1e1f22",chatBg:"#101214",sentBg:"#3b82f6",sentText:"#ffffff",timeText:"#ffffffcc",inputBg:"#1e1f22",fieldBg:"#2b2d30",fieldText:"#e9edef",placeholder:"#8696a0"};function mn(e){return e.mockupTheme==="light"?hn:xn}function vn(e){const n=mn(e),t=e.mockupTheme==="light"?"#ffffff":"#121212";return`
    <div id="mockup-card" class="mx-auto" style="width:390px; height:844px;font-family:${e.fontFamily};">
      <div class="w-full h-full overflow-hidden rounded-[2.5rem] border-8 flex flex-col" style="border-color:${t};background:${t}">
        ${bn(n)}
        ${wn(e,n)}
          ...
          <div class="relative max-w-[80%]">
            <div class="rounded-2xl px-3.5 py-2" style="background:${n.sentBg}">
              ...
              <div class="flex items-center justify-end gap-1 mt-0.5">
                ...
                <span class="inline-flex -mb-0.5">${fn}</span>
              </div>
            </div>
          </div>
        </div>
  ...
  `}function $n(e){U("sg-contact-name",t=>{t.textContent=e.username}),U("sg-message",t=>{t.textContent=e.message}),U("sg-time",t=>{t.textContent=e.timestamp});const n=document.getElementById("sg-avatar");if(n)if(e.avatar){const t=document.createElement("img");t.id="sg-avatar",t.src=e.avatar,t.className="w-full h-full rounded-full object-cover",t.alt="",n.replaceWith(t)}else{const t=document.createElement("div");t.id="sg-avatar",t.className="w-full h-full rounded-full bg-[#2c2c2c] flex items-center justify-center",t.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="#8696a0"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>',n.replaceWith(t)}}function U(e,n){const t=document.getElementById(e);t&&n(t)}const Bn='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>',En='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>',zn='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><rect x="1" y="8" width="2" height="3" rx="0.4" fill="currentColor"/><rect x="5" y="5" width="2" height="6" rx="0.4" fill="currentColor"/><rect x="9" y="2.5" width="2" height="8.5" rx="0.4" fill="currentColor"/><rect x="13" y="0.5" width="2" height="10.5" rx="0.4" fill="currentColor"/></svg>',Cn='<svg width="16" height="12" viewBox="0 0 18 12" fill="none"><path d="M9 11.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm-3.3-3.3a4.5 4.5 0 0 1 6.6 0l-1.1 1.1a3 3 0 0 0-4.4 0L5.7 8.2zM2.9 5.1a8 8 0 0 1 12.2 0l-1.1 1.1a6.5 6.5 0 0 0-10 0L2.9 5.1z" fill="currentColor"/></svg>',Sn='<svg width="24" height="12" viewBox="0 0 26 12" fill="none"><rect x="0.5" y="0.5" width="22" height="11" rx="2" stroke="currentColor" fill="none"/><rect x="2" y="2" width="19.5" height="8" rx="1.5" fill="currentColor"/><rect x="24" y="3.5" width="2" height="5" rx="0.75" fill="currentColor"/></svg>',Mn={barBg:"#f8f8f8",chatBg:"#ffffff",sentBg:"#34c759",timeText:"#8e8e93",inputBg:"#f8f8f8",fieldBg:"#e5e5ea",fieldText:"#000000",statusColor:"#000000",navColor:"#007aff"},Ln={barBg:"#1c1c1e",chatBg:"#000000",sentBg:"#34c759",timeText:"#8e8e93",inputBg:"#1c1c1e",fieldBg:"#2c2c2e",fieldText:"#ffffff",statusColor:"#ffffff",navColor:"#ffffff"};function An(e){return e.mockupTheme==="light"?Mn:Ln}function Tn(e){const n=An(e),t=e.mockupTheme==="light"?"#e5e5ea":"#1c1c1e";return`
    <div id="mockup-card" class="mx-auto" style="width:390px; height:844px;font-family:${e.fontFamily};">
      <div class="w-full h-full overflow-hidden rounded-[2.5rem] border-8 flex flex-col" style="border-color:${t};background:${t}">
        ${In(n)}
        ${jn(e,n)}
  ...
  `}function jn(e,n){return`
    <div class="flex items-center gap-1 px-2 py-1.5 shrink-0" style="background:${n.barBg};color:${n.navColor}">
      <span class="shrink-0 px-1">${Bn}</span>
      ...
      <div class="flex items-center gap-2 shrink-0 px-1">
        <span style="color:${n.navColor}">${En}</span>
      </div>
    </div>
      ...
      <div class="flex items-center gap-1.5">
        ...
        <div class="relative flex" id="lang-switcher">
          <button id="lang-btn"
            ...
            <span class="w-4 h-3 shrink-0 rounded-[2px] overflow-hidden">${de(ce)}</span>
          ...
          <div id="lang-dropdown" class="hidden absolute right-0 top-full mt-1.5 z-50 min-w-[130px] rounded-xl border border-white/10 bg-[#1a1714]/95 backdrop-blur-2xl py-1 shadow-2xl shadow-black/50">
            ${["de","en","es"].map(n=>`
              <button data-lang="${n}"
                ...
                <span class="w-5 h-4 shrink-0 rounded-[2px] overflow-hidden">${de(n)}</span>
                ${Nn[n]}
              </button>
            `).join("")}
          </div>
  ...
  `}function Rn(e){const n=l.getSidebarOpen(),i=Z()==="de"?"/de":"";return n?`
    <aside id="sidebar" class="w-[340px] shrink-0 h-full overflow-y-auto p-4 flex flex-col gap-4 transition-all duration-300 bg-[#0d0a07] relative z-10">
      <div id="app-library" class="rounded-2xl border border-white/[6%] bg-[#1a1714] p-4 flex flex-col gap-3">
        ...
        <div id="app-library-body">
          ...
          <div class="flex flex-col gap-1.5">
            ${G.map(r=>{const o=r.theme===b;return`
      ...
      <div id="settings-panel" class="rounded-2xl border border-white/[6%] bg-[#1a1714] p-4 flex flex-col gap-4">
        <span class="text-xs font-semibold text-zinc-300 tracking-wide">${a("sidebar.settings")} · <span class="text-zinc-500 font-normal normal-case">${ke()}</span></span>
        ${Be(e)}
      </div>
  ...
  `:'<aside id="sidebar" class="w-0 shrink-0 overflow-hidden transition-all duration-300 bg-[#0d0a07] relative z-10"></aside>'}function $e(){const e=l.listTemplates();return`
  ...
  `}function Be(e){const n=["whatsapp","telegram","signal","imessage"].includes(b);let t="";return b==="discord"?t=`
      ...
      <div class="flex flex-col gap-2 mt-2">
        ...
        <div id="wa-message-list" class="flex flex-col gap-2">
          ${e.messages.map((i,r)=>Ee(i,r)).join("")}
        </div>
  ...
  `}const Fn=[{id:"read",title:"Read",svg:'<svg width="13" height="13" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#53bdeb" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 5.5L9.5 9L16 1" stroke="#53bdeb" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" opacity="0.7"/></svg>'},{id:"delivered",title:"Delivered",svg:'<svg width="13" height="13" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 5.5L9.5 9L16 1" stroke="#8696a0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" opacity="0.7"/></svg>'},{id:"sent",title:"Sent",svg:'<svg width="13" height="13" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L4.5 9L11 1" stroke="#8696a0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>'},{id:"unread",title:"Unread",svg:'<svg width="8" height="8" viewBox="0 0 8 8" fill="#53bdeb"><circle cx="4" cy="4" r="4"/></svg>'}];function Ee(e,n){const t=e.type==="sent",i=t?"bg-white text-zinc-900":"bg-white/[4%] text-zinc-500 hover:text-zinc-300",r=t?"bg-white/[4%] text-zinc-500 hover:text-zinc-300":"bg-white text-zinc-900",o=e.status||"read";return`
  ...
  `}function Wn(e){const n=l.get("_zoom")||0;return`
  ...
  `}function Un(){const e=document.getElementById("app");if(!e)return;const n=l.getState(),t=l.getSidebarOpen();e.innerHTML=`
    ${Vn()}
  ...
  `,qn(),T();const i=document.getElementById("sidebar");i&&(i.style.width=t?"340px":"0px");const r=l.get("_zoom")||0;Se(r)}function Kn(){const e=document.getElementById("btn-undo"),n=document.getElementById("btn-redo");e&&(e.disabled=!l.canUndo()),n&&(n.disabled=!l.canRedo())}function pe(e){const n=document.getElementById("settings-panel");n&&(n.innerHTML=`
    <span class="text-xs font-semibold text-zinc-300 tracking-wide">${a("sidebar.settings")} · <span class="text-zinc-500 font-normal normal-case">${ke()}</span></span>
    ${Be(e)}
  `,ze())}function qn(){x("btn-topbar-export","click",()=>J()),x("btn-export-chevron","click",Qn),x("btn-sidebar-toggle","click",ge),x("sidebar-overlay","click",ge),x("btn-undo","click",()=>l.undo()),x("btn-redo","click",()=>l.redo()),x("btn-mockup-theme","click",()=>{const t=l.get("mockupTheme")==="light"?"dark":"light";l.set("mockupTheme",t)}),x("lang-btn","click",t=>{t.stopPropagation(),document.getElementById("lang-dropdown").classList.toggle("hidden")}),document.addEventListener("click",()=>{const t=document.getElementById("lang-dropdown");t&&!t.classList.contains("hidden")&&t.classList.add("hidden")}),document.querySelectorAll("[data-lang]").forEach(t=>{t.addEventListener("click",()=>{const i=t.dataset.lang;window.location.href=i==="en"?"/":`/${i}/`})}),x("btn-start-tour","click",()=>xe()),x("btn-template-save","click",ni),x("zoom-slider","input",ti),x("btn-zoom-in","click",()=>Y(10)),x("btn-zoom-out","click",()=>Y(-10)),document.querySelectorAll("[data-gradient]").forEach(t=>{t.addEventListener("click",()=>l.set("bgGradient",t.dataset.gradient))}),document.querySelectorAll("[data-app]").forEach(t=>{t.addEventListener("click",()=>{const i=G.find(r=>r.id===t.dataset.app);i&&l.set("theme",i.theme)})}),document.querySelectorAll("[data-export-action]").forEach(t=>{t.addEventListener("click",i=>{const r=t.dataset.exportAction;ue(),r==="png"?J():r==="clipboard"?Zn():r==="share"&&ei()})}),document.querySelectorAll("[data-tmpl-action]").forEach(t=>{t.addEventListener("click",i=>{var s;const r=t.dataset.tmplAction,o=(s=t.closest("[data-tmpl-name]"))==null?void 0:s.dataset.tmplName;o&&(r==="load"?l.loadTemplate(o):r==="delete"&&(l.deleteTemplate(o),re()))})});const e=document.getElementById("app-library-toggle");e&&e.addEventListener("click",()=>{const t=document.getElementById("app-library-body"),i=document.getElementById("app-library-chevron");if(!t)return;const r=t.style.display==="none";t.style.display=r?"":"none",i&&(i.style.transform=r?"rotate(0deg)":"rotate(180deg)")}),document.addEventListener("click",t=>{const i=document.getElementById("export-dropdown-container");i&&!i.contains(t.target)&&ue()}),document.addEventListener("keydown",t=>{const i=t.metaKey||t.ctrlKey;i&&t.key==="z"&&!t.shiftKey&&(t.preventDefault(),l.undo()),i&&t.key==="z"&&t.shiftKey&&(t.preventDefault(),l.redo()),i&&t.key==="e"&&(t.preventDefault(),J())});const n=document.getElementById("canvas");n&&n.addEventListener("wheel",t=>{(t.ctrlKey||t.metaKey)&&(t.preventDefault(),Y(t.deltaY>0?-5:5))},{passive:!1}),ze()}function ze(){x("input-padding","input",e=>{l.set("padding",Number(e.target.value));const n=document.getElementById("padding-value");n&&(n.textContent=e.target.value)}),x("input-font","change",e=>l.set("fontFamily",e.target.value)),x("input-chatbg","change",async e=>{var t;const n=(t=e.target.files)==null?void 0:t[0];if(n&&n.type.startsWith("image/")&&!(n.size>5*1024*1024))try{const i=await new Promise((r,o)=>{const s=new FileReader;s.onload=()=>r(s.result),s.onerror=o,s.readAsDataURL(n)});l.set("chatBg",i)}catch{}}),x("input-message","input",e=>l.set("message",e.target.value)),x("input-avatar","change",async e=>{var t;const n=(t=e.target.files)==null?void 0:t[0];if(n&&n.type.startsWith("image/")&&!(n.size>5*1024*1024))try{const i=l.get("avatar"),r=await Ge(n);i&&i.startsWith("blob:")&&URL.revokeObjectURL(i),l.set("avatar",r)}catch{l.set("avatar",null)}}),["messenger","instagram","twitter","tiktok","social-post"].includes(b)?(x("input-author","input",e=>l.set("author",e.target.value)),x("input-handle","input",e=>l.set("handle",e.target.value))):b==="discord"?(x("input-username","input",e=>l.set("username",e.target.value)),x("input-rolecolor","input",e=>l.set("roleColor",e.target.value)),x("input-timestamp","input",e=>l.set("timestamp",e.target.value))):["whatsapp","telegram","signal","imessage"].includes(b)&&(x("input-username","input",e=>l.set("username",e.target.value)),b==="whatsapp"?Jn():x("input-timestamp","input",e=>l.set("timestamp",e.target.value)))}function Jn(){const e=document.getElementById("btn-add-message");e&&(e.onclick=()=>{const i=[...l.get("messages")];i.push({id:Date.now(),text:"",type:l.get("waMode")||"sent",time:""}),l.set("messages",i),A(l.getState())});const n=document.getElementById("wa-message-list");if(!n)return;n.addEventListener("input",i=>{const r=i.target,o=parseInt(r.dataset.msgIdx);if(!isNaN(o)){if(r.tagName==="TEXTAREA"){const s=[...l.get("messages")];s[o]&&(s[o]={...s[o],text:r.value}),l.set("messages",s)}else if(r.dataset.msgField==="time"){const s=[...l.get("messages")];s[o]&&(s[o]={...s[o],time:r.value}),l.set("messages",s)}}}),n.addEventListener("click",i=>{const r=i.target.closest("[data-msg-type], [data-msg-status], [data-msg-action]");if(!r)return;const o=parseInt(r.dataset.msgIdx);if(!isNaN(o)){if(r.dataset.msgType){const s=[...l.get("messages")];s[o]&&(s[o]={...s[o],type:r.dataset.msgType}),l.set("messages",s),A(l.getState())}else if(r.dataset.msgStatus){const s=[...l.get("messages")];s[o]&&(s[o]={...s[o],status:r.dataset.msgStatus}),l.set("messages",s),A(l.getState())}else if(r.dataset.msgAction==="delete"){const s=l.get("messages").filter((d,h)=>h!==o);l.set("messages",s),A(l.getState())}}});let t=null;n.addEventListener("dragstart",i=>{const r=i.target.closest("[draggable]");r&&(t=parseInt(r.dataset.msgIdx),r.style.opacity="0.4")}),n.addEventListener("dragend",i=>{const r=i.target.closest("[draggable]");r&&(r.style.opacity=""),t=null}),n.addEventListener("dragover",i=>{i.preventDefault();const r=i.target.closest("[draggable]");r&&(r.style.borderColor="rgba(255,255,255,0.3)")}),n.addEventListener("dragleave",i=>{const r=i.target.closest("[draggable]");r&&(r.style.borderColor="")}),n.addEventListener("drop",i=>{i.preventDefault();const r=i.target.closest("[draggable]");if(!r)return;r.style.borderColor="";const o=parseInt(r.dataset.msgIdx);if(t===null||t===o)return;const s=[...l.get("messages")],[d]=s.splice(t,1);s.splice(o,0,d),l.set("messages",s),A(l.getState())})}function A(e){const n=document.getElementById("wa-message-list");n&&(n.innerHTML=e.messages.map((t,i)=>Ee(t,i)).join(""))}function T(){const e=ye[b];if(!e)return;const n=l.getState(),t=document.getElementById("mockup");t&&(t.innerHTML=e.render(n)),Ce(n),requestAnimationFrame(R)}function Yn(e,n,t){if(!q){q=!0;try{const i=ye[b];if(!i)return;if(e==="theme"){b=n;const r=Me();r&&l.mutate({author:r.author||"",handle:r.handle||"",username:r.username||r.author||"",message:r.message||"",timestamp:r.time||"",roleColor:r.roleColor||"#5865F2",messages:r.messages||[{id:1,text:r.message||"",type:l.get("waMode")||"sent",time:r.time||"",status:"read"}]}),T(),pe(l.getState()),Xn(n),Re()&&requestAnimationFrame(()=>We());return}if(e==="bgGradient"&&Ce(t),e==="mockupTheme"){const r=document.getElementById("btn-mockup-theme");r&&(r.innerHTML=n==="light"?m.sun:m.moon),T();return}if(e==="fontFamily"||e==="chatBg"){T();return}if(e==="waMode")return;if(e==="_zoom"){Se(n);return}if(e==="_undo"||e==="_redo"){T(),pe(l.getState()),Kn();return}e==="avatar"&&Ne(b==="discord"?"discord-avatar":b==="whatsapp"?"wa-avatar":"mockup-avatar"),i.sync(t)}finally{q=!1}}}function Xn(e){document.querySelectorAll("[data-app]").forEach(n=>{const t=G.find(r=>r.id===n.dataset.app),i=t&&t.theme===e;n.className=`flex items-center gap-3 rounded-xl border p-2.5 transition-all text-left ${i?"border-white/15 bg-white/[8%]":"border-white/[4%] bg-white/[3%] hover:bg-white/[7%] hover:border-white/[8%]"}`})}function Ce(e){const n=document.getElementById("canvas");if(!n)return;const t=Gn[e.bgGradient]||["#0f172a","#1e1b4b"],i="radial-gradient(rgba(255,255,255,0.035) 1px, transparent 1px)",r=`linear-gradient(135deg, ${t[0]}, ${t[1]})`;n.style.background=i,n.style.backgroundSize="40px 40px",n.style.setProperty("--bg-grad",r)}function R(){if(Q)return;const e=document.getElementById("canvas"),n=document.getElementById("mockup-card");if(!e||!n)return;const t=e.getBoundingClientRect(),i=Math.min(t.width/390,t.height/844)*.9,o=1+(l.get("_zoom")||0)/100,s=i*o;n.style.transform=`scale(${s})`,n.style.transformOrigin="center center"}window.addEventListener("resize",R);async function J(){const e=document.getElementById("btn-topbar-export"),n=document.getElementById("btn-export-icon"),t=document.getElementById("btn-export-label");if(!e||e.disabled)return;Q=!0,e.disabled=!0,n&&(n.innerHTML=m.spinner),t&&(t.textContent=a("topbar.rendering"));const i=document.getElementById("mockup-card");if(!i){p();return}const r=i.style.transform,o=i.style.transformOrigin;i.style.transform="",i.style.transformOrigin="";const s=i.querySelectorAll('[style*="background-image"]'),d=[];s.forEach((g,u)=>{d[u]=g.style.backgroundImage,g.style.backgroundImage="none"});const h=i.querySelectorAll("img"),c=[];h.forEach((g,u)=>{c[u]=g.src,g.src.startsWith("blob:")&&(g.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7")}),await new Promise(g=>requestAnimationFrame(g));try{const{toPng:g}=await fe(async()=>{const{toPng:S}=await import("./index-CgJtiJsK.js");return{toPng:S}},[]),u=await g(i,{pixelRatio:2});i.style.transform=r,i.style.transformOrigin=o,s.forEach((S,O)=>{S.style.backgroundImage=d[O]}),h.forEach((S,O)=>{c[O]&&(S.src=c[O])});const v=new Date,C=`${v.getFullYear()}-${String(v.getMonth()+1).padStart(2,"0")}-${String(v.getDate()).padStart(2,"0")}_${String(v.getHours()).padStart(2,"0")}-${String(v.getMinutes()).padStart(2,"0")}-${String(v.getSeconds()).padStart(2,"0")}`,_=`koalasnap-${b}-${C}.png`,F=document.createElement("a");F.download=_,F.href=u,F.click(),n&&(n.innerHTML=m.check),t&&(t.textContent=a("topbar.exported")),e.classList.remove("bg-[#f97316]","hover:bg-[#ea580c]"),e.classList.add("bg-emerald-500","hover:bg-emerald-600"),setTimeout(p,2e3)}catch(g){i.style.transform=r,i.style.transformOrigin=o,s.forEach((u,v)=>{u.style.backgroundImage=d[v]}),h.forEach((u,v)=>{c[v]&&(u.src=c[v])}),console.error("Export failed:",g),n&&(n.innerHTML=m.download),t&&(t.textContent=a("topbar.exportFailed")),e.disabled=!1,setTimeout(()=>{t&&(t.textContent=a("topbar.export")),n&&(n.innerHTML=m.download)},2e3)}function p(){Q=!1,e.disabled=!1,e.classList.remove("bg-emerald-500","hover:bg-emerald-600"),e.classList.add("bg-[#f97316]","hover:bg-[#ea580c]"),n&&(n.innerHTML=m.download),t&&(t.textContent=a("topbar.export"))}}function Qn(){const e=document.getElementById("export-dropdown");if(!e)return;const n=!e.classList.contains("hidden");e.classList.toggle("hidden",n)}function ue(){const e=document.getElementById("export-dropdown");e&&e.classList.add("hidden")}async function Zn(){const e=document.getElementById("mockup-card");if(!e)return;const n=document.getElementById("btn-topbar-export"),t=document.getElementById("btn-export-icon"),i=document.getElementById("btn-export-label");n&&(n.disabled=!0),t&&(t.innerHTML=m.spinner),i&&(i.textContent=a("topbar.rendering"));try{const r=e.style.transform,o=e.style.transformOrigin;e.style.transform="",e.style.transformOrigin="";const s=e.querySelectorAll('[style*="background-image"]'),d=[];s.forEach((u,v)=>{d[v]=u.style.backgroundImage,u.style.backgroundImage="none"});const h=e.querySelectorAll("img"),c=[];h.forEach((u,v)=>{c[v]=u.src,u.src.startsWith("blob:")&&(u.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7")}),await new Promise(u=>requestAnimationFrame(u));const{toBlob:p}=await fe(async()=>{const{toBlob:u}=await import("./index-CgJtiJsK.js");return{toBlob:u}},[]),g=await p(e,{pixelRatio:2});e.style.transform=r,e.style.transformOrigin=o,s.forEach((u,v)=>{u.style.backgroundImage=d[v]}),h.forEach((u,v)=>{c[v]&&(u.src=c[v])}),g&&(await navigator.clipboard.write([new ClipboardItem({"image/png":g})]),E(a("topbar.copied")))}catch(r){console.error("Clipboard copy failed:",r),E(a("topbar.exportFailed"))}n&&(n.disabled=!1),t&&(t.innerHTML=m.download),i&&(i.textContent=a("topbar.export"))}function ei(){const e=l.getShareUrl();if(!e){E(a("topbar.exportFailed"));return}try{navigator.clipboard.writeText(e),E(a("topbar.linkCopied"))}catch{E(a("topbar.exportFailed"))}}function E(e){const n=document.getElementById("toast");n&&n.remove();const t=document.createElement("div");t.id="toast",t.className="fixed bottom-28 left-1/2 -translate-x-1/2 z-50 rounded-full bg-zinc-800/90 backdrop-blur-xl border border-white/10 px-5 py-2.5 text-sm text-zinc-200 shadow-2xl shadow-black/30 animate-fade-in",t.textContent=e,document.body.appendChild(t),setTimeout(()=>{t.style.opacity="0",t.style.transition="opacity 0.3s",setTimeout(()=>t.remove(),300)},2e3)}function ge(){const n=!l.getSidebarOpen();l.setSidebarOpen(n);const t=document.getElementById("sidebar");t&&(t.style.width=n?"340px":"0px");const i=document.getElementById("sidebar-overlay");i&&(n&&window.innerWidth<768?i.classList.remove("hidden"):i.classList.add("hidden")),requestAnimationFrame(R)}function Y(e){const n=l.get("_zoom")||0,t=Math.max(-50,Math.min(100,n+e));l.set("_zoom",t)}function ti(e){const n=parseInt(e.target.value);l.set("_zoom",n)}function Se(e){const n=document.getElementById("zoom-slider");n&&(n.value=e);const t=document.getElementById("zoom-label");t&&(t.textContent=e>0?`+${e}%`:`${e}%`),R()}function re(){const e=document.getElementById("templates-section");if(!e||!document.getElementById("sidebar"))return;const t=document.createElement("div");t.innerHTML=$e(),e.replaceWith(t.firstElementChild),document.querySelectorAll("[data-tmpl-action]").forEach(i=>{i.addEventListener("click",r=>{var d;const o=i.dataset.tmplAction,s=(d=i.closest("[data-tmpl-name]"))==null?void 0:d.dataset.tmplName;s&&(o==="load"?l.loadTemplate(s):o==="delete"&&(l.deleteTemplate(s),re()))})})}function ni(){const e=document.getElementById("input-template-name");if(!e||!e.value.trim())return;const n=e.value.trim();l.saveTemplate(n),e.value="",re(),E(a("templates.saved"))}function x(e,n,t){var i;(i=document.getElementById(e))==null||i.addEventListener(n,t)}function Me(){var o,s;const e=[{author:"Maya",handle:"@maya_99",username:"Maya",message:"Hey, are you coming online tonight?",time:"7:18 PM",roleColor:"#e81224",messages:[{text:"Hey, are you coming online tonight?",type:"sent",time:"7:18 PM"},{text:"Yeah, give me 5!",type:"received",time:"7:20 PM"},{text:"Sure, take your time 🐨",type:"sent",time:"7:21 PM"}]}],n=window.__LOCALE__,t=n!=null&&n.dummySets&&n.dummySets.length>0?n.dummySets:e,i=t[Math.floor(Math.random()*t.length)],r=i.messages&&i.messages.length>0?i.messages.map((d,h)=>({id:h+1,text:d.text,type:d.type,time:d.time,status:d.status||"read"})):[{id:1,text:i.message||"",type:l.get("waMode")||"sent",time:i.time||"",status:"read"}];return{author:i.author||"",handle:i.handle||"",username:i.username||i.author||"",message:i.message||((o=r[0])==null?void 0:o.text)||"",time:i.time||((s=r[0])==null?void 0:s.time)||"",roleColor:i.roleColor||"#5865F2",messages:r}}l.subscribe(Yn);try{const e=localStorage.getItem("koalasnap_state"),n=Z();let t=!e;if(e)try{const i=JSON.parse(e);(!i.locale||i.locale!==n)&&(t=!0)}catch{t=!0}if(t){const i=Me();i&&l.mutate({...i,locale:n})}}catch{}Un();"serviceWorker"in navigator&&navigator.serviceWorker.register("/sw.js").catch(()=>{});Ve()||setTimeout(()=>xe(),800);
